...
**AerospikeEnableMtls** | **bool** |  | [optional] 
...
**AerospikeSslConnectionMode** | **bool** |  | [optional] 
...
**PreserveExistingPasswordSettings** | **bool** | Internal marker for DS update flows: when true, keep the persisted password settings and merge explicit rule updates on top. | [optional] 
