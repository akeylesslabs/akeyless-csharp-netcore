...
**K8sTempRoleBindingDefinition** | **List&lt;int&gt;** | Yaml/Json definition of temporary role binding that will be created and deleted when TTL is due. Must have as subject name of Service Account specified in K8sServiceAccount field | [optional] 
**K8sTempRoleDefinition** | **List&lt;int&gt;** | Yaml/Json definition of temporary role that will be created and deleted when TTL is due | [optional] 
