...
**CreatePrivateOcsp** | **bool** | CreatePrivateOcsp enables exposing an OCSP endpoint on the Gateway and embedding its URL in the AIA extension of issued certificates. | [optional] 
**CreatePublicCrl** | **bool** |  | [optional] 
**CreatePublicOcsp** | **bool** | CreatePublicOcsp enables exposing a public OCSP endpoint on the Gateway and embedding its URL in the AIA extension of issued certificates. | [optional] 
