# akeyless.Model.RotatedSecretUpdateAerospike
...
------------ | ------------- | ------------- | -------------
**AddTag** | **List&lt;string&gt;** | List of the new tags that will be attached to this item. To specify multiple tags use argument multiple times: - -add-tag Tag1 - -add-tag Tag2 | [optional] 
...
**RmTag** | **List&lt;string&gt;** | List of the existent tags that will be removed from this item. To specify multiple tags use argument multiple times: - -rm-tag Tag1 - -rm-tag Tag2 | [optional] 
