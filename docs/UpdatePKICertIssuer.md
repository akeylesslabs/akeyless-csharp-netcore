...
**CreatePrivateOcsp** | **bool** | Set this to enable an OCSP endpoint in the Gateway and include its URL in AIA | [optional] 
**CreatePublicCrl** | **bool** | Set this to allow the cert issuer will expose a public CRL endpoint | [optional] 
**CreatePublicOcsp** | **bool** | Set this to enable a public OCSP endpoint and include its URL in AIA (served by UAM and includes account id) | [optional] 
