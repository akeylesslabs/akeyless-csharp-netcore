...
Our SDK compiled as .NET Standard 2.0 which makes it compatible with .NET Framework 4.7.2 or higher and .NET Core 2.0.
For additional information see [.NET implementation support](https://docs.microsoft.com/en-us/dotnet/standard/net-standard)
