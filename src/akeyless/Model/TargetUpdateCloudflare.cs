...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateCloudflare")]
    public partial class TargetUpdateCloudflare : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateCloudflare" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateCloudflare() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateCloudflare" /> class.
        /// </summary>
        ...
        public TargetUpdateCloudflare(string accountId = default(string), string apiToken = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateCloudflare and cannot be null");
            }
            this.Name = name;
