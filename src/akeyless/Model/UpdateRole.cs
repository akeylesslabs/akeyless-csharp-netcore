...
namespace akeyless.Model
{
    ...
    public partial class UpdateRole :  IEquatable<UpdateRole>, IValidatableObject
    {
        ...
        public UpdateRole(string analyticsAccess = default(string), string auditAccess = default(string), string name = default(string), string newComment = "default_comment", string newName = default(string), string token = default(string), string uidToken = default(string))
        {
