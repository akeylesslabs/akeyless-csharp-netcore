...
namespace akeyless.Model
{
    ...
    public partial class ListAuthMethods :  IEquatable<ListAuthMethods>, IValidatableObject
    {
        ...
        public ListAuthMethods(string paginationToken = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
