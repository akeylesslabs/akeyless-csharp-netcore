...
namespace akeyless.Model
{
    ...
    public partial class SignRsaSsaPss : IEquatable<SignRsaSsaPss>, IValidatableObject
    {
        /// <summary>
        ...
        public SignRsaSsaPss(string displayId = default(string), string hashFunction = default(string), long itemId = default(long), bool json = false, string keyName = default(string), string message = default(string), bool prehashed = default(bool), string token = default(string), string uidToken = default(string), int version = default(int))
        {
        ...
        {
            return this.Equals(input as SignRsaSsaPss);
        }

        /// <summary>
        /// Returns true if SignRsaSsaPss instances are equal
        /// </summary>
        /// <param name="input">Instance of SignRsaSsaPss to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignRsaSsaPss input)
        {
            if (input == null)
            {
                return false;
