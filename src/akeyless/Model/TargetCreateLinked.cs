...
namespace akeyless.Model
{
    ...
    /// TargetCreateLinked
    /// </summary>
    [DataContract(Name = "targetCreateLinked")]
    public partial class TargetCreateLinked : IEquatable<TargetCreateLinked>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateLinked" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateLinked() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateLinked" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TargetCreateLinked);
        }

        /// <summary>
        /// Returns true if TargetCreateLinked instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateLinked to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateLinked input)
        {
            if (input == null)
            {
                return false;
