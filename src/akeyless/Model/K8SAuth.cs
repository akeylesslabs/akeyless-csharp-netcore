...
namespace akeyless.Model
{
    ...
    public partial class K8SAuth : IEquatable<K8SAuth>, IValidatableObject
    {
        ...
        public K8SAuth(long amTokenExpiration = default(long), string authMethodAccessId = default(string), string authMethodPrvKeyPem = default(string), bool disableIssValidation = default(bool), string id = default(string), string k8sCaCert = default(string), string k8sHost = default(string), string k8sIssuer = default(string), List<string> k8sPubKeysPem = default(List<string>), string k8sTokenReviewerJwt = default(string), string name = default(string), string protectionKey = default(string), bool useLocalCaJwt = default(bool))
        {
