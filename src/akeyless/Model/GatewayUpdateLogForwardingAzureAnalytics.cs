...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateLogForwardingAzureAnalytics : IValidatableObject
    {
        /// <summary>
        ...
        public GatewayUpdateLogForwardingAzureAnalytics(string enable = @"true", string enableBatch = @"true", bool json = false, string outputFormat = @"text", string pullInterval = @"10", string token = default(string), string uidToken = default(string), string workspaceId = default(string), string workspaceKey = default(string))
        {
