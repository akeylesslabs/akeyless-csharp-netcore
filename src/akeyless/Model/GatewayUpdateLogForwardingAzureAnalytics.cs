...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateLogForwardingAzureAnalytics")]
    public partial class GatewayUpdateLogForwardingAzureAnalytics : IEquatable<GatewayUpdateLogForwardingAzureAnalytics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateLogForwardingAzureAnalytics" /> class.
        /// </summary>
        ...
        public GatewayUpdateLogForwardingAzureAnalytics(string enable = "true", bool json = false, string outputFormat = "text", string pullInterval = "10", string token = default(string), string uidToken = default(string), string workspaceId = default(string), string workspaceKey = default(string))
        {
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingAzureAnalytics);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingAzureAnalytics instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingAzureAnalytics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingAzureAnalytics input)
        {
            if (input == null)
            {
                return false;
