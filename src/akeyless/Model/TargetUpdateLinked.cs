...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateLinked : IValidatableObject
    {
        ...
        public TargetUpdateLinked(string addHosts = default(string), string deleteProtection = default(string), string description = default(string), string hosts = default(string), bool json = false, string keepPrevVersion = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string parentTargetName = default(string), string rmHosts = default(string), string rotateOnUnlock = default(string), string token = default(string), string type = default(string), string uidToken = default(string))
        {
