...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateLinked : IEquatable<TargetUpdateLinked>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateLinked);
        }

        /// <summary>
        /// Returns true if TargetUpdateLinked instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateLinked to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateLinked input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ParentTargetName == input.ParentTargetName ||
                    (this.ParentTargetName != null &&
                    this.ParentTargetName.Equals(input.ParentTargetName))
                ) && 
                (
                    this.RmHosts == input.RmHosts ||
                    (this.RmHosts != null &&
                    this.RmHosts.Equals(input.RmHosts))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ParentTargetName != null)
                {
                    hashCode = (hashCode * 59) + this.ParentTargetName.GetHashCode();
                }
                if (this.RmHosts != null)
                {
                    hashCode = (hashCode * 59) + this.RmHosts.GetHashCode();
                }
                if (this.Token != null)
                {
