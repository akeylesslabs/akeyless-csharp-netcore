...
namespace akeyless.Model
{
    ...
    /// TargetCreateGcp
    /// </summary>
    [DataContract(Name = "targetCreateGcp")]
    public partial class TargetCreateGcp : IEquatable<TargetCreateGcp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGcp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateGcp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGcp" /> class.
        /// </summary>
        ...
        public TargetCreateGcp(string description = default(string), string gcpKey = default(string), bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string token = default(string), string uidToken = default(string), bool useGwCloudIdentity = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateGcp and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as TargetCreateGcp);
        }

        /// <summary>
        /// Returns true if TargetCreateGcp instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateGcp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateGcp input)
        {
            if (input == null)
            {
                return false;
