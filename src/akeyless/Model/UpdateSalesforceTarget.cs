...
namespace akeyless.Model
{
    ...
    public partial class UpdateSalesforceTarget : IEquatable<UpdateSalesforceTarget>, IValidatableObject
    {
        ...
        public UpdateSalesforceTarget(string caCertData = default(string), string caCertName = default(string), string clientId = default(string), string clientSecret = default(string), string comment = default(string), string email = default(string), string keepPrevVersion = default(string), string key = default(string), string name = default(string), string newName = default(string), string password = default(string), string securityToken = default(string), string tenantUrl = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool))
        {
            ...
            if (clientSecret == null) {
                throw new ArgumentNullException("clientSecret is a required property for UpdateSalesforceTarget and cannot be null");
            }
            ...
            if (password == null) {
                throw new ArgumentNullException("password is a required property for UpdateSalesforceTarget and cannot be null");
            }
            this.Password = password;
            // to ensure "securityToken" is required (not null)
            if (securityToken == null) {
                throw new ArgumentNullException("securityToken is a required property for UpdateSalesforceTarget and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpdateSalesforceTarget);
        }

        /// <summary>
        /// Returns true if UpdateSalesforceTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSalesforceTarget to be compared</param>
        /// <returns>Boolean</returns>
