...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateSplunk : IValidatableObject
    {
        ...
        public TargetCreateSplunk(string audience = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string password = default(string), string rotateOnUnlock = default(string), string splunkToken = default(string), string token = default(string), string tokenOwner = default(string), string uidToken = default(string), string url = default(string), bool useTls = true, string username = default(string))
        {
