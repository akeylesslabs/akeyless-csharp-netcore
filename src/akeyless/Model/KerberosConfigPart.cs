...
namespace akeyless.Model
{
    ...
    public partial class KerberosConfigPart : IEquatable<KerberosConfigPart>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KerberosConfigPart);
        }

        /// <summary>
        /// Returns true if KerberosConfigPart instances are equal
        /// </summary>
        /// <param name="input">Instance of KerberosConfigPart to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KerberosConfigPart input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.KerberosAccessId == input.KerberosAccessId ||
                    (this.KerberosAccessId != null &&
                    this.KerberosAccessId.Equals(input.KerberosAccessId))
                ) && 
                (
                ...
                (
                    this.KerberosPrivateKey == input.KerberosPrivateKey ||
                    (this.KerberosPrivateKey != null &&
                    this.KerberosPrivateKey.Equals(input.KerberosPrivateKey))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.KerberosAccessId != null)
                {
                    hashCode = (hashCode * 59) + this.KerberosAccessId.GetHashCode();
                }
                ...
                if (this.KerberosPrivateKey != null)
                {
                    hashCode = (hashCode * 59) + this.KerberosPrivateKey.GetHashCode();
                }
