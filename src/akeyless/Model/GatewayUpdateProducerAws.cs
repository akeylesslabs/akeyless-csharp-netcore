...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerAws : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The AWS External ID associated with the AWS role (relevant only for assume_role mode)</value>
        [DataMember(Name = "aws-external-id", EmitDefaultValue = false)]
