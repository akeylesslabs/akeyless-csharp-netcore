...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateGrok")]
    public partial class TargetUpdateGrok : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateGrok" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateGrok() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateGrok" /> class.
        /// </summary>
        ...
        public TargetUpdateGrok(string apiKey = default(string), string deleteProtection = default(string), string description = @"default_comment", string grokUrl = @"https://api.x.ai/v1", bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newComment = @"default_comment", string newName = default(string), string rotateOnUnlock = default(string), string teamId = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateGrok and cannot be null");
            }
            this.Name = name;
            this.ApiKey = apiKey;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetUpdateGrok {\n");
