...
namespace akeyless.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerNativeK8S" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GatewayUpdateProducerNativeK8S() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerNativeK8S" /> class.
        /// </summary>
        ...
        public GatewayUpdateProducerNativeK8S(string k8sClusterCaCert = default(string), string k8sClusterEndpoint = default(string), string k8sClusterToken = default(string), string k8sNamespace = default(string), string k8sServiceAccount = default(string), string name = default(string), string newName = default(string), string password = default(string), string producerEncryptionKeyName = default(string), bool secureAccessAllowPortForwading = default(bool), string secureAccessBastionIssuer = default(string), string secureAccessClusterEndpoint = default(string), string secureAccessDashboardUrl = default(string), string secureAccessEnable = default(string), bool secureAccessWeb = default(bool), bool secureAccessWebBrowsing = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m", string username = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for GatewayUpdateProducerNativeK8S and cannot be null");
        ...
        {
            return this.Equals(input as GatewayUpdateProducerNativeK8S);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerNativeK8S instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerNativeK8S to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerNativeK8S input)
        {
            if (input == null)
                return false;
