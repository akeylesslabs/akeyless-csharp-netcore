...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateVenafi")]
    public partial class DynamicSecretCreateVenafi : IEquatable<DynamicSecretCreateVenafi>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateVenafi" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateVenafi() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateVenafi" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateVenafi);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateVenafi instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateVenafi to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateVenafi input)
        {
            if (input == null)
            {
                return false;
