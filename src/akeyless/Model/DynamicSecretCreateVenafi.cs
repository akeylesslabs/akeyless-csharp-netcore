...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateVenafi : IValidatableObject
    {
        ...
        public DynamicSecretCreateVenafi(long adminRotationIntervalDays = 0, bool allowSubdomains = default(bool), List<string> allowedDomains = default(List<string>), bool araEnabled = default(bool), string autoGeneratedFolder = default(string), string deleteProtection = default(string), string description = default(string), bool enableAdminRotation = false, bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string name = default(string), List<string> outputRule = default(List<string>), string producerEncryptionKeyName = default(string), bool rootFirstInChain = default(bool), bool signUsingAkeylessPki = default(bool), string signerKeyName = default(string), bool skipDryRun = default(bool), bool storePrivateKey = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = @"2160h", string venafiAccessToken = default(string), string venafiApiKey = default(string), string venafiBaseurl = default(string), string venafiClientId = @"akeyless", string venafiRefreshToken = default(string), bool venafiUseTpp = default(bool), string venafiZone = default(string))
        {
