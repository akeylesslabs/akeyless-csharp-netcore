...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateMssql : IEquatable<RotatedSecretUpdateMssql>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateMssql);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateMssql instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateMssql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateMssql input)
        {
            if (input == null)
            {
                return false;
