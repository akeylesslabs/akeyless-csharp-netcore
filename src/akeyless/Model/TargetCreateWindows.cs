...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateWindows : IEquatable<TargetCreateWindows>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateWindows);
        }

        /// <summary>
        /// Returns true if TargetCreateWindows instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateWindows to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateWindows input)
        {
            if (input == null)
            {
                return false;
