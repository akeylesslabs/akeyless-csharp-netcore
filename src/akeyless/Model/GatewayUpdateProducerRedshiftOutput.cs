...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerRedshiftOutput")]
    public partial class GatewayUpdateProducerRedshiftOutput : IEquatable<GatewayUpdateProducerRedshiftOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerRedshiftOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerRedshiftOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerRedshiftOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerRedshiftOutput input)
        {
            if (input == null)
                return false;
