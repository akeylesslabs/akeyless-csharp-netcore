...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretCreateHanadb")]
    public partial class RotatedSecretCreateHanadb : IEquatable<RotatedSecretCreateHanadb>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateHanadb" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretCreateHanadb() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateHanadb" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RotatedSecretCreateHanadb);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateHanadb instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateHanadb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateHanadb input)
        {
            if (input == null)
            {
                return false;
