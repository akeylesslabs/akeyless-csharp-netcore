...
namespace akeyless.Model
{
    ...
    public partial class ServerInventoryPayload : IEquatable<ServerInventoryPayload>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ServerInventoryPayload);
        }

        /// <summary>
        /// Returns true if ServerInventoryPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of ServerInventoryPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServerInventoryPayload input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MigrationTargetId == input.MigrationTargetId ||
                    this.MigrationTargetId.Equals(input.MigrationTargetId)
                ) && 
                (
                    this.ServerTargetsPathTemplate == input.ServerTargetsPathTemplate ||
                    (this.ServerTargetsPathTemplate != null &&
                ...
                (
                    ...
                    this.UsersIgnoreList.SequenceEqual(input.UsersIgnoreList)
                ) && 
                (
                    this.UsersRotatedSecretsPathTemplate == input.UsersRotatedSecretsPathTemplate ||
                    (this.UsersRotatedSecretsPathTemplate != null &&
                    this.UsersRotatedSecretsPathTemplate.Equals(input.UsersRotatedSecretsPathTemplate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MigrationTargetId.GetHashCode();
                ...
                {
                    hashCode = (hashCode * 59) + this.UsersIgnoreList.GetHashCode();
                }
                if (this.UsersRotatedSecretsPathTemplate != null)
                {
                    hashCode = (hashCode * 59) + this.UsersRotatedSecretsPathTemplate.GetHashCode();
                }
                return hashCode;
            }
        }
