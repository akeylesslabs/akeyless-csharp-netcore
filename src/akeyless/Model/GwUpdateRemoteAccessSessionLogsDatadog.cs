...
namespace akeyless.Model
{
    ...
    public partial class GwUpdateRemoteAccessSessionLogsDatadog : IEquatable<GwUpdateRemoteAccessSessionLogsDatadog>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GwUpdateRemoteAccessSessionLogsDatadog);
        }

        /// <summary>
        /// Returns true if GwUpdateRemoteAccessSessionLogsDatadog instances are equal
        /// </summary>
        /// <param name="input">Instance of GwUpdateRemoteAccessSessionLogsDatadog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GwUpdateRemoteAccessSessionLogsDatadog input)
        {
            if (input == null)
            {
                return false;
