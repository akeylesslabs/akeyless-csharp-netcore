...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateDB : IEquatable<TargetCreateDB>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateDB);
        }

        /// <summary>
        /// Returns true if TargetCreateDB instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateDB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateDB input)
        {
            if (input == null)
            {
                return false;
