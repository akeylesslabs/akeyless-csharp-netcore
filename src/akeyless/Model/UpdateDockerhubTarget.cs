...
namespace akeyless.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDockerhubTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateDockerhubTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDockerhubTarget" /> class.
        /// </summary>
        ...
        public UpdateDockerhubTarget(string comment = default(string), string dockerhubPassword = default(string), string dockerhubUsername = default(string), string keepPrevVersion = default(string), string key = default(string), string name = default(string), string newName = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for UpdateDockerhubTarget and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateDockerhubTarget);
        }

        /// <summary>
        /// Returns true if UpdateDockerhubTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDockerhubTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDockerhubTarget input)
        {
            if (input == null)
                return false;
