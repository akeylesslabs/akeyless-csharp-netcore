...
namespace akeyless.Model
{
    ...
    public partial class VerifyGPG : IEquatable<VerifyGPG>, IValidatableObject
    {
        ...
        public VerifyGPG(string displayId = default(string), long itemId = default(long), bool json = default(bool), string keyName = default(string), string passphrase = default(string), string signature = default(string), string token = default(string), string uidToken = default(string))
        {
