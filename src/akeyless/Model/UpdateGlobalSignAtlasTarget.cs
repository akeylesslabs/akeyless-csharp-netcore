...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateGlobalSignAtlasTarget")]
    public partial class UpdateGlobalSignAtlasTarget : IEquatable<UpdateGlobalSignAtlasTarget>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateGlobalSignAtlasTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateGlobalSignAtlasTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateGlobalSignAtlasTarget" /> class.
        /// </summary>
        ...
        public UpdateGlobalSignAtlasTarget(string apiKey = default(string), string apiSecret = default(string), string comment = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string mtlsCertDataBase64 = default(string), string mtlsKeyDataBase64 = default(string), string name = default(string), string newName = default(string), string timeout = "5m", string token = default(string), string uidToken = default(string), bool updateVersion = default(bool))
        {
            ...
            if (apiKey == null)
            {
                throw new ArgumentNullException("apiKey is a required property for UpdateGlobalSignAtlasTarget and cannot be null");
            }
            this.ApiKey = apiKey;
            // to ensure "apiSecret" is required (not null)
            if (apiSecret == null)
            {
                throw new ArgumentNullException("apiSecret is a required property for UpdateGlobalSignAtlasTarget and cannot be null");
            }
            this.ApiSecret = apiSecret;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateGlobalSignAtlasTarget and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateGlobalSignAtlasTarget);
        }

        /// <summary>
        /// Returns true if UpdateGlobalSignAtlasTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateGlobalSignAtlasTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateGlobalSignAtlasTarget input)
        {
            if (input == null)
            {
                return false;
