...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateLogForwardingStdout : IEquatable<GatewayUpdateLogForwardingStdout>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingStdout);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingStdout instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingStdout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingStdout input)
        {
            if (input == null)
            {
                return false;
