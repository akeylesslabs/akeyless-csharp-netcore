...
namespace akeyless.Model
{
    ...
    public partial class ListGroups : IEquatable<ListGroups>, IValidatableObject
    {
        ...
        public ListGroups(string filter = default(string), bool json = false, string paginationToken = default(string), string token = default(string), string uidToken = default(string))
        {
            this.Filter = filter;
            this.Json = json;
        ...
        {
            return this.Equals(input as ListGroups);
        }

        /// <summary>
        /// Returns true if ListGroups instances are equal
        /// </summary>
        /// <param name="input">Instance of ListGroups to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListGroups input)
        {
            if (input == null)
            {
                return false;
