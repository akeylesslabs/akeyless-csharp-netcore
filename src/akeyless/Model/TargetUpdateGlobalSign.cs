...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateGlobalSign : IEquatable<TargetUpdateGlobalSign>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateGlobalSign);
        }

        /// <summary>
        /// Returns true if TargetUpdateGlobalSign instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateGlobalSign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateGlobalSign input)
        {
            if (input == null)
            {
                return false;
