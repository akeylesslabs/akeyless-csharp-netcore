...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateRotatedSecretSC :  IEquatable<UpdateRotatedSecretSC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRotatedSecretSC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRotatedSecretSC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRotatedSecretSC" /> class.
        /// </summary>
        ...
        public UpdateRotatedSecretSC(List<string> addTag = default(List<string>), string autoRotate = default(string), string gatewayUrl = "http://localhost:8000", string key = default(string), string name = default(string), string newMetadata = "default_metadata", string newName = default(string), bool newVersion = false, List<string> rmTag = default(List<string>), string rotationInterval = default(string), int rotationHour = default(int), string rotatorCredsType = default(string), string sshPassword = default(string), string sshUsername = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for UpdateRotatedSecretSC and cannot be null");
            this.AddTag = addTag;
        ...
        {
            return this.Equals(input as UpdateRotatedSecretSC);
        }

        /// <summary>
        /// Returns true if UpdateRotatedSecretSC instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateRotatedSecretSC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateRotatedSecretSC input)
        {
            if (input == null)
                return false;
