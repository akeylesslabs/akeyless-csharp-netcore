...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreateDigiCert")]
    public partial class TargetCreateDigiCert : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateDigiCert" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateDigiCert() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateDigiCert" /> class.
        /// </summary>
        ...
        public TargetCreateDigiCert(string acmeChallenge = @"dns", string deleteProtection = default(string), string description = default(string), string digicertUrl = @"us-production", string dnsTargetCreds = default(string), string eabHmacKey = default(string), string eabKeyId = default(string), string email = default(string), string gcpProject = default(string), string hostedZone = default(string), bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string resourceGroup = default(string), string timeout = @"5m", string token = default(string), string uidToken = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for TargetCreateDigiCert and cannot be null");
            }
            this.Email = email;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateDigiCert and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>DigiCert ACME endpoint selector. Options: [us-production/eu-production/us-demo/eu-demo]</value>
        [DataMember(Name = "digicert-url", EmitDefaultValue = false)]
