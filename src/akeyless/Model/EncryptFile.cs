...
namespace akeyless.Model
{
    ...
    public partial class EncryptFile : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varIn">Path to the file to be encrypted. If not provided, the content will be taken from stdin (required).</param>
        ...
        public EncryptFile(string displayId = default(string), string varIn = default(string), long itemId = default(long), bool json = false, string keyName = default(string), string varOut = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "varIn" is required (not null)
            if (varIn == null)
            {
                throw new ArgumentNullException("varIn is a required property for EncryptFile and cannot be null");
            }
            this.In = varIn;
