...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetDelete")]
    public partial class TargetDelete : IEquatable<TargetDelete>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetDelete" /> class.
        /// </summary>
        ...
        public TargetDelete(bool forceDeletion = false, bool json = false, string name = default(string), int targetVersion = default(int), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetDelete and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as TargetDelete);
        }

        /// <summary>
        /// Returns true if TargetDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetDelete input)
        {
            if (input == null)
            {
                return false;
