...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodUpdateGcp")]
    public partial class AuthMethodUpdateGcp : IEquatable<AuthMethodUpdateGcp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateGcp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodUpdateGcp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateGcp" /> class.
        /// </summary>
        ...
        public AuthMethodUpdateGcp(long accessExpires = 0, string audience = "akeyless.io", List<string> auditLogsClaims = default(List<string>), List<string> boundIps = default(List<string>), List<string> boundLabels = default(List<string>), List<string> boundProjects = default(List<string>), List<string> boundRegions = default(List<string>), List<string> boundServiceAccounts = default(List<string>), List<string> boundZones = default(List<string>), string deleteProtection = default(string), string description = default(string), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), string newName = default(string), List<string> productType = default(List<string>), string serviceAccountCredsData = default(string), string token = default(string), string type = default(string), string uidToken = default(string))
        {
            // to ensure "audience" is required (not null)
            if (audience == null)
            {
                throw new ArgumentNullException("audience is a required property for AuthMethodUpdateGcp and cannot be null");
            }
            this.Audience = audience;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthMethodUpdateGcp and cannot be null");
            }
            this.Name = name;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for AuthMethodUpdateGcp and cannot be null");
            }
            this.Type = type;
        ...
        {
            return this.Equals(input as AuthMethodUpdateGcp);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateGcp instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateGcp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateGcp input)
        {
            if (input == null)
            {
                return false;
