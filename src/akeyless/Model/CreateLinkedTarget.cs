...
namespace akeyless.Model
{
    ...
    public partial class CreateLinkedTarget : IEquatable<CreateLinkedTarget>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateLinkedTarget);
        }

        /// <summary>
        /// Returns true if CreateLinkedTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateLinkedTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateLinkedTarget input)
        {
            if (input == null)
            {
                return false;
