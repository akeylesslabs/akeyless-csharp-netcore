...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretCreateWindows : IEquatable<RotatedSecretCreateWindows>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretCreateWindows);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateWindows instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateWindows to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateWindows input)
        {
            if (input == null)
            {
                return false;
