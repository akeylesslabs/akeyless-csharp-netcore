    ...
    public partial class DSProducerDetails : IEquatable<DSProducerDetails>, IValidatableObject
    {
        ...
        public bool Equals(DSProducerDetails input)
        {
            ...
            return 
                ...
                (
                    this.AwsSessionTags == input.AwsSessionTags ||
                    (this.AwsSessionTags != null &&
                    this.AwsSessionTags.Equals(input.AwsSessionTags))
                ) && 
                (
                ...
                (
                    this.AwsTransitiveTagKeys == input.AwsTransitiveTagKeys ||
                    (this.AwsTransitiveTagKeys != null &&
                    this.AwsTransitiveTagKeys.Equals(input.AwsTransitiveTagKeys))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AwsSessionTags != null)
                {
                    hashCode = (hashCode * 59) + this.AwsSessionTags.GetHashCode();
                }
                if (this.AwsSessionToken != null)
                {
                    hashCode = (hashCode * 59) + this.AwsSessionToken.GetHashCode();
                }
                if (this.AwsTransitiveTagKeys != null)
                {
                    hashCode = (hashCode * 59) + this.AwsTransitiveTagKeys.GetHashCode();
                }
