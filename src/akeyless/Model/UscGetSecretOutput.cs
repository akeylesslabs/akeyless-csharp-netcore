...
namespace akeyless.Model
{
    ...
    public partial class UscGetSecretOutput : IValidatableObject
    {
        /// <summary>
        ...
        public UscGetSecretOutput(bool binaryValue = default(bool), string id = default(string), Object metadata = default(Object), string name = default(string), string value = default(string))
        {
