...
namespace akeyless.Model
{
    ...
    public partial class DescribeItem :  IEquatable<DescribeItem>, IValidatableObject
    {
        ...
        public DescribeItem(string name = default(string), string password = default(string), bool showVersions = false, string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DescribeItem and cannot be null");
