...
namespace akeyless.Model
{
    ...
    public partial class GatewayCreateProducerMongo : IEquatable<GatewayCreateProducerMongo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayCreateProducerMongo);
        }

        /// <summary>
        /// Returns true if GatewayCreateProducerMongo instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayCreateProducerMongo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayCreateProducerMongo input)
        {
            if (input == null)
                return false;
