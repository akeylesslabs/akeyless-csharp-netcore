...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerRabbitMQ : IEquatable<GatewayUpdateProducerRabbitMQ>, IValidatableObject
    {
        ...
        protected GatewayUpdateProducerRabbitMQ() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerRabbitMQ" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerRabbitMQ);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerRabbitMQ instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerRabbitMQ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerRabbitMQ input)
        {
            if (input == null)
            {
                return false;
