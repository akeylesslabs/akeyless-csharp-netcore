...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateLogForwardingLogzIo")]
    public partial class GatewayUpdateLogForwardingLogzIo : IEquatable<GatewayUpdateLogForwardingLogzIo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateLogForwardingLogzIo" /> class.
        /// </summary>
        ...
        public GatewayUpdateLogForwardingLogzIo(string enable = "true", bool json = false, string logzIoToken = default(string), string outputFormat = "text", string protocol = default(string), string pullInterval = "10", string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingLogzIo);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingLogzIo instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingLogzIo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingLogzIo input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LogzIoToken == input.LogzIoToken ||
                    (this.LogzIoToken != null &&
                    this.LogzIoToken.Equals(input.LogzIoToken))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LogzIoToken.GetHashCode();
                }
