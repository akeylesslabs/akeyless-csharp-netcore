...
namespace akeyless.Model
{
    ...
    public partial class SignEcDsa : IEquatable<SignEcDsa>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SignEcDsa);
        }

        /// <summary>
        /// Returns true if SignEcDsa instances are equal
        /// </summary>
        /// <param name="input">Instance of SignEcDsa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignEcDsa input)
        {
            if (input == null)
            {
                return false;
