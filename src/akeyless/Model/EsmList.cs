...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "esmList")]
    public partial class EsmList : IEquatable<EsmList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EsmList" /> class.
        /// </summary>
        ...
        public EsmList(string esmName = default(string), bool json = false, string token = default(string), string uidToken = default(string))
        {
            // to ensure "esmName" is required (not null)
            if (esmName == null)
            {
                throw new ArgumentNullException("esmName is a required property for EsmList and cannot be null");
            }
        ...
        {
            return this.Equals(input as EsmList);
        }

        /// <summary>
        /// Returns true if EsmList instances are equal
        /// </summary>
        /// <param name="input">Instance of EsmList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EsmList input)
        {
            if (input == null)
            {
                return false;
