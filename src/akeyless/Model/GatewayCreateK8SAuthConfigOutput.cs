...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayCreateK8SAuthConfigOutput")]
    public partial class GatewayCreateK8SAuthConfigOutput : IEquatable<GatewayCreateK8SAuthConfigOutput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayCreateK8SAuthConfigOutput" /> class.
        /// </summary>
        /// <param name="clusterId">clusterId.</param>
        /// <param name="partsChange">partsChange.</param>
        /// <param name="totalHash">totalHash.</param>
        public GatewayCreateK8SAuthConfigOutput(string clusterId = default(string), ConfigChange partsChange = default(ConfigChange), string totalHash = default(string))
        {
        ...
        {
            return this.Equals(input as GatewayCreateK8SAuthConfigOutput);
        }

        /// <summary>
        /// Returns true if GatewayCreateK8SAuthConfigOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayCreateK8SAuthConfigOutput to be compared</param>
        /// <returns>Boolean</returns>
