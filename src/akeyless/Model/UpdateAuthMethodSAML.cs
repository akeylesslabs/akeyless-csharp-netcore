...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAuthMethodSAML")]
    public partial class UpdateAuthMethodSAML : IEquatable<UpdateAuthMethodSAML>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAuthMethodSAML" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAuthMethodSAML() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAuthMethodSAML" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateAuthMethodSAML);
        }

        /// <summary>
        /// Returns true if UpdateAuthMethodSAML instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAuthMethodSAML to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAuthMethodSAML input)
        {
            if (input == null)
            {
                return false;
