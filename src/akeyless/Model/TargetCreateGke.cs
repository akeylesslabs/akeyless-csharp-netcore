...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateGke : IEquatable<TargetCreateGke>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateGke);
        }

        /// <summary>
        /// Returns true if TargetCreateGke instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateGke to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateGke input)
        {
            if (input == null)
            {
                return false;
