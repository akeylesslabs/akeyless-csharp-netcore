...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateMySql : IEquatable<DynamicSecretCreateMySql>, IValidatableObject
    {
        /// <summary>
        ...
        public DynamicSecretCreateMySql(string dbServerCertificates = default(string), string dbServerName = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string mysqlDbname = default(string), string mysqlHost = "127.0.0.1", string mysqlPassword = default(string), string mysqlPort = "3306", string mysqlRevocationStatements = default(string), string mysqlScreationStatements = default(string), string mysqlUsername = default(string), string name = default(string), string passwordLength = default(string), string producerEncryptionKeyName = default(string), string secureAccessBastionIssuer = default(string), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), bool secureAccessWeb = false, bool ssl = false, string sslCertificate = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
        ...
        {
            return this.Equals(input as DynamicSecretCreateMySql);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateMySql instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateMySql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateMySql input)
        {
            if (input == null)
            {
                return false;
