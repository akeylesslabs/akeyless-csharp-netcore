...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateOracleDb")]
    public partial class DynamicSecretCreateOracleDb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateOracleDb" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateOracleDb() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateOracleDb" /> class.
        /// </summary>
        ...
        public DynamicSecretCreateOracleDb(bool araEnabled = default(bool), string customUsernameTemplate = default(string), string dbServerCertificates = default(string), string dbServerName = default(string), string deleteProtection = default(string), string description = default(string), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string name = default(string), string oracleHost = @"127.0.0.1", string oraclePassword = default(string), string oraclePort = @"1521", string oracleRevocationStatements = default(string), string oracleScreationStatements = default(string), string oracleServiceName = default(string), string oracleUsername = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), string producerEncryptionKeyName = default(string), string secureAccessBastionIssuer = default(string), string secureAccessCertificateIssuer = default(string), string secureAccessEnable = @"false", List<string> secureAccessHost = default(List<string>), bool secureAccessWeb = false, bool skipDryRun = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string), string userTtl = @"60m")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretCreateOracleDb and cannot be null");
            }
            this.Name = name;
