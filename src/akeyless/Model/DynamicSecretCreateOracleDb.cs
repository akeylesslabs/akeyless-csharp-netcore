...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateOracleDb : IEquatable<DynamicSecretCreateOracleDb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateOracleDb);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateOracleDb instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateOracleDb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateOracleDb input)
        {
            if (input == null)
            {
                return false;
