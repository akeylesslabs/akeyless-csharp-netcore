...
namespace akeyless.Model
{
    ...
    public partial class ListTargets : IEquatable<ListTargets>, IValidatableObject
    {
        ...
        public ListTargets(string paginationToken = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
