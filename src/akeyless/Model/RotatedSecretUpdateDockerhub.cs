...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretUpdateDockerhub")]
    public partial class RotatedSecretUpdateDockerhub : IEquatable<RotatedSecretUpdateDockerhub>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateDockerhub" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretUpdateDockerhub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateDockerhub" /> class.
        /// </summary>
        ...
        public RotatedSecretUpdateDockerhub(List<string> addTag = default(List<string>), string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = "default_metadata", bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string passwordLength = default(string), List<string> rmTag = default(List<string>), int rotationHour = default(int), string rotationInterval = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretUpdateDockerhub and cannot be null");
            }
            this.Name = name;
            this.AddTag = addTag;
        ...
        {
            return this.Equals(input as RotatedSecretUpdateDockerhub);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateDockerhub instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateDockerhub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateDockerhub input)
        {
            if (input == null)
            {
                return false;
