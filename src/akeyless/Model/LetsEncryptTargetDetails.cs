...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LetsEncryptTargetDetails")]
    public partial class LetsEncryptTargetDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LetsEncryptTargetDetails" /> class.
        /// </summary>
        /// <param name="accountKeyPem">ACME Account Private Key (PEM-encoded) Supports ECDSA (P-256, P-384, P-521), RSA (2048+), and Ed25519 Auto-generated as ECDSA P-256 on first certificate issuance if not provided Stored encrypted, required for certificate operations and revocation.</param>
        /// <param name="accountUrl">ACME Account URL (returned after registration with Let&#39;s Encrypt) Used to retrieve existing account instead of re-registering.</param>
        ...
        /// </summary>
        /// <value>ACME Account Private Key (PEM-encoded) Supports ECDSA (P-256, P-384, P-521), RSA (2048+), and Ed25519 Auto-generated as ECDSA P-256 on first certificate issuance if not provided Stored encrypted, required for certificate operations and revocation</value>
        ...
        /// </summary>
        /// <value>ACME Account URL (returned after registration with Let&#39;s Encrypt) Used to retrieve existing account instead of re-registering</value>
