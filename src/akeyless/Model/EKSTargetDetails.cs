...
namespace akeyless.Model
{
    ...
    public partial class EKSTargetDetails : IEquatable<EKSTargetDetails>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EKSTargetDetails);
        }

        /// <summary>
        /// Returns true if EKSTargetDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of EKSTargetDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EKSTargetDetails input)
        {
            if (input == null)
            {
                return false;
