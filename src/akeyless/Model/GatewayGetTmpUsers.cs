...
namespace akeyless.Model
{
    ...
    public partial class GatewayGetTmpUsers : IValidatableObject
    {
        /// <summary>
        ...
        public GatewayGetTmpUsers(bool araEnabled = default(bool), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), bool json = false, string name = default(string), List<string> outputRule = default(List<string>), bool skipDryRun = default(bool), string token = default(string), string uidToken = default(string))
        {
