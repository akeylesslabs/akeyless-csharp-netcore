...
namespace akeyless.Model
{
    ...
    public partial class GatewayGetTmpUsers : IValidatableObject
    {
        ...
        public GatewayGetTmpUsers(bool araEnabled = default(bool), List<string> inputRule = default(List<string>), bool json = false, string name = default(string), List<string> outputRule = default(List<string>), string skipDryRun = default(string), string token = default(string), string uidToken = default(string))
        {
