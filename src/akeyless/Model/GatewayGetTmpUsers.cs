...
namespace akeyless.Model
{
    ...
    public partial class GatewayGetTmpUsers :  IEquatable<GatewayGetTmpUsers>, IValidatableObject
    {
        ...
        public GatewayGetTmpUsers(string gatewayUrl = "http://localhost:8000", string name = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for GatewayGetTmpUsers and cannot be null");
