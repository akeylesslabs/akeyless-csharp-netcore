...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodUpdateCert : IEquatable<AuthMethodUpdateCert>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodUpdateCert);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateCert instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateCert to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateCert input)
        {
            if (input == null)
            {
                return false;
