...
namespace akeyless.Model
{
    ...
    public partial class CreateNativeK8STarget :  IEquatable<CreateNativeK8STarget>, IValidatableObject
    {
        ...
        public CreateNativeK8STarget(string comment = default(string), string k8sClusterCaCert = default(string), string k8sClusterEndpoint = default(string), string k8sClusterToken = default(string), string key = default(string), string name = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "k8sClusterCaCert" is required (not null)
            this.K8sClusterCaCert = k8sClusterCaCert ?? throw new ArgumentNullException("k8sClusterCaCert is a required property for CreateNativeK8STarget and cannot be null");
            // to ensure "k8sClusterEndpoint" is required (not null)
            this.K8sClusterEndpoint = k8sClusterEndpoint ?? throw new ArgumentNullException("k8sClusterEndpoint is a required property for CreateNativeK8STarget and cannot be null");
            // to ensure "k8sClusterToken" is required (not null)
            this.K8sClusterToken = k8sClusterToken ?? throw new ArgumentNullException("k8sClusterToken is a required property for CreateNativeK8STarget and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateNativeK8STarget and cannot be null");
