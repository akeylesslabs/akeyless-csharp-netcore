...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateLogForwardingElasticsearch")]
    public partial class GatewayUpdateLogForwardingElasticsearch : IEquatable<GatewayUpdateLogForwardingElasticsearch>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateLogForwardingElasticsearch" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingElasticsearch);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingElasticsearch instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingElasticsearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingElasticsearch input)
        {
            if (input == null)
            {
                return false;
