...
namespace akeyless.Model
{
    ...
    public partial class GatewayDeleteK8SAuthConfigOutput : IEquatable<GatewayDeleteK8SAuthConfigOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayDeleteK8SAuthConfigOutput);
        }

        /// <summary>
        /// Returns true if GatewayDeleteK8SAuthConfigOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayDeleteK8SAuthConfigOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayDeleteK8SAuthConfigOutput input)
        {
            if (input == null)
            {
                return false;
