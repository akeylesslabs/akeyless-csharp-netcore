...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateLdap : IEquatable<RotatedSecretUpdateLdap>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateLdap);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateLdap instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateLdap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateLdap input)
        {
            if (input == null)
            {
                return false;
