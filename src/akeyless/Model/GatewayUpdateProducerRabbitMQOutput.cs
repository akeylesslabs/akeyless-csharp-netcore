...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerRabbitMQOutput")]
    public partial class GatewayUpdateProducerRabbitMQOutput : IEquatable<GatewayUpdateProducerRabbitMQOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerRabbitMQOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerRabbitMQOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerRabbitMQOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerRabbitMQOutput input)
        {
            if (input == null)
            {
                return false;
