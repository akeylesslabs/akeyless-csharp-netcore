...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodUpdateAliCloud")]
    public partial class AuthMethodUpdateAliCloud : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateAliCloud" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodUpdateAliCloud() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateAliCloud" /> class.
        /// </summary>
        ...
        /// <param name="boundAccountId">A list of AliCloud account-IDs that the access is restricted to.</param>
        ...
        /// <param name="stsUrl">sts URL (default to &quot;https://sts.aliyuncs.com&quot;).</param>
        ...
        public AuthMethodUpdateAliCloud(long accessExpires = 0, List<string> allowedClientType = default(List<string>), List<string> auditLogsClaims = default(List<string>), List<string> boundAccountId = default(List<string>), List<string> boundArn = default(List<string>), List<string> boundIps = default(List<string>), List<string> boundResourceId = default(List<string>), List<string> boundRoleId = default(List<string>), List<string> boundRoleName = default(List<string>), List<string> boundUserId = default(List<string>), List<string> boundUserName = default(List<string>), string deleteProtection = default(string), string description = default(string), List<string> expirationEventIn = default(List<string>), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), string newName = default(string), List<string> productType = default(List<string>), string stsUrl = @"https://sts.aliyuncs.com", string token = default(string), string uidToken = default(string), string uniqueIdentifier = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthMethodUpdateAliCloud and cannot be null");
            }
            this.Name = name;
            ...
            this.StsUrl = stsUrl ?? @"https://sts.aliyuncs.com";
            this.Token = token;
        ...
        /// </summary>
        /// <value>A list of AliCloud account-IDs that the access is restricted to</value>
        [DataMember(Name = "bound-account-id", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthMethodUpdateAliCloud {\n");
