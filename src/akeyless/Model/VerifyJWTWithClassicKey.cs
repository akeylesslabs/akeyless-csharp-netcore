...
namespace akeyless.Model
{
    ...
    public partial class VerifyJWTWithClassicKey : IValidatableObject
    {
        /// <summary>
        ...
        public VerifyJWTWithClassicKey(string displayId = default(string), bool json = false, string jwt = default(string), string requiredClaims = default(string), string token = default(string), string uidToken = default(string), int varVersion = default(int))
        {
