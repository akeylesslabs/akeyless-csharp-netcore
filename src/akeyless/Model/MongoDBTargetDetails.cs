...
namespace akeyless.Model
{
    ...
    public partial class MongoDBTargetDetails : IEquatable<MongoDBTargetDetails>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MongoDBTargetDetails);
        }

        /// <summary>
        /// Returns true if MongoDBTargetDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of MongoDBTargetDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MongoDBTargetDetails input)
        {
            if (input == null)
            {
                return false;
