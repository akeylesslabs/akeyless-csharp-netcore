...
namespace akeyless.Model
{
    ...
    /// TargetUpdateGodaddy
    /// </summary>
    [DataContract(Name = "targetUpdateGodaddy")]
    public partial class TargetUpdateGodaddy : IEquatable<TargetUpdateGodaddy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateGodaddy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateGodaddy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateGodaddy" /> class.
        /// </summary>
        ...
        public TargetUpdateGodaddy(string apiKey = default(string), string description = default(string), string imapFqdn = default(string), string imapPassword = default(string), string imapPort = "993", string imapUsername = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string secret = default(string), string timeout = "5m", string token = default(string), string uidToken = default(string))
        {
            // to ensure "apiKey" is required (not null)
            if (apiKey == null)
            {
                throw new ArgumentNullException("apiKey is a required property for TargetUpdateGodaddy and cannot be null");
            }
            this.ApiKey = apiKey;
            // to ensure "imapFqdn" is required (not null)
            if (imapFqdn == null)
            {
                throw new ArgumentNullException("imapFqdn is a required property for TargetUpdateGodaddy and cannot be null");
            }
            this.ImapFqdn = imapFqdn;
            // to ensure "imapPassword" is required (not null)
            if (imapPassword == null)
            {
                throw new ArgumentNullException("imapPassword is a required property for TargetUpdateGodaddy and cannot be null");
            }
            this.ImapPassword = imapPassword;
            // to ensure "imapUsername" is required (not null)
            if (imapUsername == null)
            {
                throw new ArgumentNullException("imapUsername is a required property for TargetUpdateGodaddy and cannot be null");
            }
            this.ImapUsername = imapUsername;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateGodaddy and cannot be null");
            }
            this.Name = name;
            // to ensure "secret" is required (not null)
            if (secret == null)
            {
                throw new ArgumentNullException("secret is a required property for TargetUpdateGodaddy and cannot be null");
            }
            this.Secret = secret;
        ...
        {
            return this.Equals(input as TargetUpdateGodaddy);
        }

        /// <summary>
        /// Returns true if TargetUpdateGodaddy instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateGodaddy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateGodaddy input)
        {
            if (input == null)
            {
                return false;
