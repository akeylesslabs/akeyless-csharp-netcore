...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateWeb")]
    public partial class TargetUpdateWeb : IEquatable<TargetUpdateWeb>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateWeb" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateWeb() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateWeb" /> class.
        /// </summary>
        ...
        public TargetUpdateWeb(string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string token = default(string), string uidToken = default(string), string url = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateWeb and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as TargetUpdateWeb);
        }

        /// <summary>
        /// Returns true if TargetUpdateWeb instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateWeb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateWeb input)
        {
            if (input == null)
            {
                return false;
