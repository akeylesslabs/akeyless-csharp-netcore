...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateDockerhub : IEquatable<TargetCreateDockerhub>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateDockerhub);
        }

        /// <summary>
        /// Returns true if TargetCreateDockerhub instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateDockerhub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateDockerhub input)
        {
            if (input == null)
            {
                return false;
