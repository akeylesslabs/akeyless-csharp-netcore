...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateDockerhub : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateDockerhub" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateDockerhub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateDockerhub" /> class.
        /// </summary>
        ...
        public TargetCreateDockerhub(string deleteProtection = default(string), string description = default(string), string dockerhubPassword = default(string), string dockerhubUsername = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateDockerhub and cannot be null");
            }
            this.Name = name;
