...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerCertificateAutomationOutput")]
    public partial class GatewayUpdateProducerCertificateAutomationOutput : IEquatable<GatewayUpdateProducerCertificateAutomationOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerCertificateAutomationOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerCertificateAutomationOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerCertificateAutomationOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerCertificateAutomationOutput input)
        {
            if (input == null)
            {
                return false;
