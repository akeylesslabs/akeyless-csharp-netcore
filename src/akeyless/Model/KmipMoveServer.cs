...
namespace akeyless.Model
{
    ...
    public partial class KmipMoveServer : IEquatable<KmipMoveServer>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as KmipMoveServer);
        }

        /// <summary>
        /// Returns true if KmipMoveServer instances are equal
        /// </summary>
        /// <param name="input">Instance of KmipMoveServer to be compared</param>
        /// <returns>Boolean</returns>
