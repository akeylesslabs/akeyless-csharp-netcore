...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerCustom :  IEquatable<GatewayUpdateProducerCustom>, IValidatableObject
    {
        ...
        public GatewayUpdateProducerCustom(string createSyncUrl = default(string), string name = default(string), string newName = default(string), string password = default(string), string payload = default(string), string producerEncryptionKeyName = default(string), string revokeSyncUrl = default(string), string rotateSyncUrl = default(string), List<string> tags = default(List<string>), long timeoutSec = 60, string token = default(string), string uidToken = default(string), string userTtl = "60m", string username = default(string))
        {
            ...
            this.CreateSyncUrl = createSyncUrl ?? throw new ArgumentNullException("createSyncUrl is a required property for GatewayUpdateProducerCustom and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for GatewayUpdateProducerCustom and cannot be null");
            // to ensure "revokeSyncUrl" is required (not null)
            this.RevokeSyncUrl = revokeSyncUrl ?? throw new ArgumentNullException("revokeSyncUrl is a required property for GatewayUpdateProducerCustom and cannot be null");
