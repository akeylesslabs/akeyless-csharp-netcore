...
namespace akeyless.Model
{
    ...
    public partial class GatewayCreateProducerEks :  IEquatable<GatewayCreateProducerEks>, IValidatableObject
    {
        ...
        public GatewayCreateProducerEks(string eksAccessKeyId = default(string), string eksAssumeRole = default(string), string eksClusterCert = default(string), string eksClusterEndpoint = default(string), string eksClusterName = default(string), string eksRegion = "us-east-2", string eksSecretAccessKey = default(string), string gatewayUrl = "http://localhost:8000", string name = default(string), string producerEncryptionKeyName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            ...
            this.EksClusterCert = eksClusterCert ?? throw new ArgumentNullException("eksClusterCert is a required property for GatewayCreateProducerEks and cannot be null");
