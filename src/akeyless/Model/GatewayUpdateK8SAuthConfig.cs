...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateK8SAuthConfig : IValidatableObject
    {
        /// <summary>
        ...
        [DataMember(Name = "new-name", IsRequired = true, EmitDefaultValue = true)]
