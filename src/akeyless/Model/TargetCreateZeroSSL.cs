...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateZeroSSL : IValidatableObject
    {
        /// <summary>
        ...
        public TargetCreateZeroSSL(string apiKey = default(string), string deleteProtection = default(string), string description = default(string), string imapFqdn = default(string), string imapPassword = default(string), string imapPort = @"993", string imapTargetEmail = default(string), string imapUsername = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string rotateOnUnlock = default(string), string timeout = @"5m", string token = default(string), string uidToken = default(string))
        {
