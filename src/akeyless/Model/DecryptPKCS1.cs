...
namespace akeyless.Model
{
    ...
    /// DecryptPKCS1
    /// </summary>
    [DataContract(Name = "decryptPKCS1")]
    public partial class DecryptPKCS1 : IValidatableObject
    {
        /// <summary>
        ...
        public DecryptPKCS1(string ciphertext = default(string), string displayId = default(string), long itemId = default(long), bool json = false, string keyName = default(string), string outputFormat = default(string), string token = default(string), string uidToken = default(string), int varVersion = default(int))
        {
