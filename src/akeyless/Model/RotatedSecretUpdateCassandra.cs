...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateCassandra : IEquatable<RotatedSecretUpdateCassandra>, IValidatableObject
    {
        ...
        public RotatedSecretUpdateCassandra(List<string> addTag = default(List<string>), string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = "default_metadata", bool json = false, string keepPrevVersion = default(string), string key = default(string), string name = default(string), string newName = default(string), string passwordLength = default(string), List<string> rmTag = default(List<string>), string rotatedPassword = default(string), string rotatedUsername = default(string), int rotationHour = default(int), string rotationInterval = default(string), string token = default(string), string uidToken = default(string))
        {
