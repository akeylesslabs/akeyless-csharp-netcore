...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateCassandra : IEquatable<RotatedSecretUpdateCassandra>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateCassandra);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateCassandra instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateCassandra to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateCassandra input)
        {
            if (input == null)
            {
                return false;
