...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretUpdateMongodb")]
    public partial class RotatedSecretUpdateMongodb : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateMongodb" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretUpdateMongodb() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateMongodb" /> class.
        /// </summary>
        ...
        public RotatedSecretUpdateMongodb(List<string> addTag = default(List<string>), string authenticationCredentials = @"use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = @"default_metadata", Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockDuringSraSession = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string passwordLength = default(string), List<string> rmTag = default(List<string>), string rotateAfterDisconnect = default(string), string rotatedPassword = default(string), string rotatedUsername = default(string), List<string> rotationEventIn = default(List<string>), int rotationHour = default(int), string rotationInterval = default(string), string secureAccessBastionIssuer = default(string), string secureAccessCertificateIssuer = default(string), string secureAccessDbName = default(string), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), bool secureAccessWeb = false, string token = default(string), string uidToken = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretUpdateMongodb and cannot be null");
            }
            this.Name = name;
            this.AddTag = addTag;
