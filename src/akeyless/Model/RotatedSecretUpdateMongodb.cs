...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateMongodb : IEquatable<RotatedSecretUpdateMongodb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateMongodb);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateMongodb instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateMongodb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateMongodb input)
        {
            if (input == null)
            {
                return false;
