...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretGetValue : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varVersion">Secret version.</param>
        public RotatedSecretGetValue(string host = default(string), string ignoreCache = @"false", bool json = false, string name = default(string), string token = default(string), string uidToken = default(string), int varVersion = default(int))
        {
