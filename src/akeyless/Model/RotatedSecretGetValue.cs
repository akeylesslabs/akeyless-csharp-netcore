...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretGetValue")]
    public partial class RotatedSecretGetValue : IEquatable<RotatedSecretGetValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretGetValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretGetValue() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretGetValue" /> class.
        /// </summary>
        ...
        public RotatedSecretGetValue(string host = default(string), string ignoreCache = "false", bool json = false, string name = default(string), string token = default(string), string uidToken = default(string), int version = default(int))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretGetValue and cannot be null");
            }
            this.Name = name;
            this.Host = host;
        ...
        {
            return this.Equals(input as RotatedSecretGetValue);
        }

        /// <summary>
        /// Returns true if RotatedSecretGetValue instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretGetValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretGetValue input)
        {
            if (input == null)
            {
                return false;
