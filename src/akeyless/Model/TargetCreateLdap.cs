...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateLdap : IValidatableObject
    {
        ...
        public TargetCreateLdap(string bindDn = default(string), string bindDnPassword = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string ldapCaCert = default(string), string ldapUrl = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string rotateOnUnlock = default(string), string serverType = @"OpenLDAP", string token = default(string), string tokenExpiration = default(string), string uidToken = default(string))
        {
