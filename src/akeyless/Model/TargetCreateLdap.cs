...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateLdap : IEquatable<TargetCreateLdap>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateLdap);
        }

        /// <summary>
        /// Returns true if TargetCreateLdap instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateLdap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateLdap input)
        {
            if (input == null)
            {
                return false;
