...
namespace akeyless.Model
{
    ...
    /// TargetCreateEks
    /// </summary>
    [DataContract(Name = "targetCreateEks")]
    public partial class TargetCreateEks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateEks" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateEks() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateEks" /> class.
        /// </summary>
        ...
        public TargetCreateEks(string deleteProtection = default(string), string description = default(string), string eksAccessKeyId = default(string), string eksClusterCaCert = default(string), string eksClusterEndpoint = default(string), string eksClusterName = default(string), string eksRegion = @"us-east-2", string eksSecretAccessKey = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), bool useGwCloudIdentity = default(bool))
        {
            // to ensure "eksAccessKeyId" is required (not null)
            if (eksAccessKeyId == null)
            {
                throw new ArgumentNullException("eksAccessKeyId is a required property for TargetCreateEks and cannot be null");
            }
            this.EksAccessKeyId = eksAccessKeyId;
            // to ensure "eksClusterCaCert" is required (not null)
            if (eksClusterCaCert == null)
            {
                throw new ArgumentNullException("eksClusterCaCert is a required property for TargetCreateEks and cannot be null");
            }
            this.EksClusterCaCert = eksClusterCaCert;
            // to ensure "eksClusterEndpoint" is required (not null)
            if (eksClusterEndpoint == null)
            {
                throw new ArgumentNullException("eksClusterEndpoint is a required property for TargetCreateEks and cannot be null");
            }
            this.EksClusterEndpoint = eksClusterEndpoint;
            // to ensure "eksClusterName" is required (not null)
            if (eksClusterName == null)
            {
                throw new ArgumentNullException("eksClusterName is a required property for TargetCreateEks and cannot be null");
            }
            this.EksClusterName = eksClusterName;
            // to ensure "eksSecretAccessKey" is required (not null)
            if (eksSecretAccessKey == null)
            {
                throw new ArgumentNullException("eksSecretAccessKey is a required property for TargetCreateEks and cannot be null");
            }
            this.EksSecretAccessKey = eksSecretAccessKey;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateEks and cannot be null");
            }
            this.Name = name;
