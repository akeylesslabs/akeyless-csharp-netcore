...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateEks : IEquatable<TargetCreateEks>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateEks);
        }

        /// <summary>
        /// Returns true if TargetCreateEks instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateEks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateEks input)
        {
            if (input == null)
            {
                return false;
