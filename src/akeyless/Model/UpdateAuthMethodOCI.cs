...
namespace akeyless.Model
{
    ...
    public partial class UpdateAuthMethodOCI : IEquatable<UpdateAuthMethodOCI>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateAuthMethodOCI(long accessExpires = 0, List<string> boundIps = default(List<string>), string description = default(string), bool forceSubClaims = default(bool), List<string> groupOcid = default(List<string>), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), string newName = default(string), string tenantOcid = default(string), string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateAuthMethodOCI);
        }

        /// <summary>
        /// Returns true if UpdateAuthMethodOCI instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAuthMethodOCI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAuthMethodOCI input)
        {
            if (input == null)
            {
                return false;
