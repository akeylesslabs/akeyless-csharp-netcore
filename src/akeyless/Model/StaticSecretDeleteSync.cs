...
namespace akeyless.Model
{
    ...
    public partial class StaticSecretDeleteSync : IValidatableObject
    {
        ...
        public StaticSecretDeleteSync(bool json = false, string name = default(string), string token = default(string), string uidToken = default(string), string uscName = default(string))
        {
