...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "staticSecretDeleteSync")]
    public partial class StaticSecretDeleteSync : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaticSecretDeleteSync" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StaticSecretDeleteSync() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StaticSecretDeleteSync" /> class.
        /// </summary>
        ...
        public StaticSecretDeleteSync(bool deleteFromUsc = false, string environments = default(string), bool json = false, string name = default(string), string remoteSecretName = default(string), string repositories = default(string), string token = default(string), string uidToken = default(string), string uscName = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for StaticSecretDeleteSync and cannot be null");
            }
            this.Name = name;
