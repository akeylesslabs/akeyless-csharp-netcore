...
namespace akeyless.Model
{
    ...
    /// CreatePKICertIssuer
    /// </summary>
    [DataContract(Name = "CreatePKICertIssuer")]
    public partial class CreatePKICertIssuer : IEquatable<CreatePKICertIssuer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePKICertIssuer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreatePKICertIssuer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePKICertIssuer" /> class.
        /// </summary>
        ...
        public CreatePKICertIssuer(bool allowAnyName = default(bool), bool allowCopyExtFromCsr = default(bool), bool allowSubdomains = default(bool), string allowedDomains = default(string), string allowedExtraExtensions = default(string), string allowedUriSans = default(string), string caTarget = default(string), bool clientFlag = default(bool), bool codeSigningFlag = default(bool), string country = default(string), bool createPrivateCrl = default(bool), bool createPublicCrl = default(bool), string deleteProtection = default(string), string description = default(string), string destinationPath = default(string), List<string> expirationEventIn = default(List<string>), string gwClusterUrl = default(string), bool isCa = default(bool), bool json = false, string keyUsage = "DigitalSignature,KeyAgreement,KeyEncipherment", string locality = default(string), string metadata = default(string), string name = default(string), bool notEnforceHostnames = default(bool), bool notRequireCn = default(bool), string organizationalUnits = default(string), string organizations = default(string), string postalCode = default(string), bool protectCertificates = default(bool), string province = default(string), bool serverFlag = default(bool), string signerKeyName = "dummy_signer_key", string streetAddress = default(string), List<string> tag = default(List<string>), string token = default(string), string ttl = default(string), string uidToken = default(string))
        {
            ...
            if (ttl == null)
            {
                throw new ArgumentNullException("ttl is a required property for CreatePKICertIssuer and cannot be null");
            }
            this.Ttl = ttl;
        ...
        /// </summary>
        /// <value>The name of an existing CA target to attach this PKI Certificate Issuer to, required in Public CA mode</value>
        [DataMember(Name = "ca-target", EmitDefaultValue = false)]
        public string CaTarget { get; set; }
        ...
        {
            return this.Equals(input as CreatePKICertIssuer);
        }

        /// <summary>
        /// Returns true if CreatePKICertIssuer instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePKICertIssuer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePKICertIssuer input)
        {
            ...
            return 
                ...
                (
                    ...
                    (this.CaTarget != null &&
                    this.CaTarget.Equals(input.CaTarget))
                ) && 
                (
                ...
                (
                    this.CreatePrivateCrl == input.CreatePrivateCrl ||
                    this.CreatePrivateCrl.Equals(input.CreatePrivateCrl)
                ) && 
                (
                    this.CreatePublicCrl == input.CreatePublicCrl ||
