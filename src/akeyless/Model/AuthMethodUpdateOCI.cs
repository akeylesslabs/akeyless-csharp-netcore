...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodUpdateOCI")]
    public partial class AuthMethodUpdateOCI : IEquatable<AuthMethodUpdateOCI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateOCI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodUpdateOCI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateOCI" /> class.
        /// </summary>
        ...
        public AuthMethodUpdateOCI(long accessExpires = 0, List<string> auditLogsClaims = default(List<string>), List<string> boundIps = default(List<string>), string deleteProtection = default(string), string description = default(string), bool forceSubClaims = default(bool), List<string> groupOcid = default(List<string>), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), string newName = default(string), List<string> productType = default(List<string>), string tenantOcid = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "groupOcid" is required (not null)
            if (groupOcid == null)
            {
                throw new ArgumentNullException("groupOcid is a required property for AuthMethodUpdateOCI and cannot be null");
            }
            this.GroupOcid = groupOcid;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthMethodUpdateOCI and cannot be null");
            }
            this.Name = name;
            // to ensure "tenantOcid" is required (not null)
            if (tenantOcid == null)
            {
                throw new ArgumentNullException("tenantOcid is a required property for AuthMethodUpdateOCI and cannot be null");
            }
        ...
        {
            return this.Equals(input as AuthMethodUpdateOCI);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateOCI instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateOCI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateOCI input)
        {
            if (input == null)
            {
                return false;
