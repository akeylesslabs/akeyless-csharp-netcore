...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateHashiVault : IEquatable<TargetUpdateHashiVault>, IValidatableObject
    {
        /// <summary>
        ...
        public TargetUpdateHashiVault(string description = default(string), string hashiUrl = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), List<string> _namespace = default(List<string>), string newName = default(string), string token = default(string), string uidToken = default(string), string vaultToken = default(string))
        {
        ...
        {
            return this.Equals(input as TargetUpdateHashiVault);
        }

        /// <summary>
        /// Returns true if TargetUpdateHashiVault instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateHashiVault to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateHashiVault input)
        {
            if (input == null)
            {
                return false;
