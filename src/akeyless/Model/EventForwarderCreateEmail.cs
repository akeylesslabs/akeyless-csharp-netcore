...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "eventForwarderCreateEmail")]
    public partial class EventForwarderCreateEmail : IEquatable<EventForwarderCreateEmail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventForwarderCreateEmail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventForwarderCreateEmail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventForwarderCreateEmail" /> class.
        /// </summary>
        ...
        public EventForwarderCreateEmail(List<string> authMethodsEventSourceLocations = default(List<string>), string description = default(string), string emailTo = default(string), List<string> eventTypes = default(List<string>), string every = default(string), List<string> gatewaysEventSourceLocations = default(List<string>), List<string> itemsEventSourceLocations = default(List<string>), bool json = false, string key = default(string), string name = default(string), string overrideUrl = default(string), string runnerType = default(string), List<string> targetsEventSourceLocations = default(List<string>), string token = default(string), string uidToken = default(string))
        {
            ...
            {
                throw new ArgumentNullException("gatewaysEventSourceLocations is a required property for EventForwarderCreateEmail and cannot be null");
            }
            this.GatewaysEventSourceLocations = gatewaysEventSourceLocations;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for EventForwarderCreateEmail and cannot be null");
            }
            this.Name = name;
            // to ensure "runnerType" is required (not null)
            if (runnerType == null)
            {
                throw new ArgumentNullException("runnerType is a required property for EventForwarderCreateEmail and cannot be null");
            }
        ...
        {
            return this.Equals(input as EventForwarderCreateEmail);
        }

        /// <summary>
        /// Returns true if EventForwarderCreateEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of EventForwarderCreateEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventForwarderCreateEmail input)
        {
            if (input == null)
            {
                return false;
