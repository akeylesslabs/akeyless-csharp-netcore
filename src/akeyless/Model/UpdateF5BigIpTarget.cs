...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateF5BigIpTarget")]
    public partial class UpdateF5BigIpTarget : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateF5BigIpTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateF5BigIpTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateF5BigIpTarget" /> class.
        /// </summary>
        ...
        /// <param name="url">F5 BIG-IP target URL.</param>
        /// <param name="username">F5 username with permission to manage certificate.</param>
        public UpdateF5BigIpTarget(string comment = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string password = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool), string url = default(string), string username = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateF5BigIpTarget and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateF5BigIpTarget {\n");
