...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodCreateCert : IEquatable<AuthMethodCreateCert>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodCreateCert);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateCert instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateCert to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateCert input)
        {
            if (input == null)
            {
                return false;
