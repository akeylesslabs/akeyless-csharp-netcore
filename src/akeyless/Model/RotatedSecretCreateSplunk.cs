...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretCreateSplunk")]
    public partial class RotatedSecretCreateSplunk : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateSplunk" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretCreateSplunk() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateSplunk" /> class.
        /// </summary>
        /// <param name="audience">Token audience for Splunk token creation (required for rotator-type&#x3D;token).</param>
        ...
        /// <param name="rotatorType">The rotator type. options: [target/password/token/hec-token] (required).</param>
        /// <param name="splunkToken">Current Splunk authentication token to store (relevant only for rotator-type&#x3D;token). If not provided, a new token will be created in Splunk..</param>
        /// <param name="tags">Add tags attached to this object.</param>
        /// <param name="targetName">The target name to associate (required).</param>
        /// <param name="token">Authentication token (see &#x60;/auth&#x60; and &#x60;/configure&#x60;).</param>
        /// <param name="tokenOwner">Splunk token owner username (relevant only for rotator-type&#x3D;token).</param>
        /// <param name="uidToken">The universal identity token, Required only for universal_identity authentication.</param>
        public RotatedSecretCreateSplunk(string audience = default(string), string authenticationCredentials = @"use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = default(string), string expirationDate = default(string), string hecToken = default(string), string hecTokenName = default(string), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string passwordLength = default(string), string rotatedPassword = default(string), string rotatedUsername = default(string), List<string> rotationEventIn = default(List<string>), int rotationHour = default(int), string rotationInterval = default(string), string rotatorType = default(string), string splunkToken = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string tokenOwner = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretCreateSplunk and cannot be null");
            }
            this.Name = name;
            // to ensure "rotatorType" is required (not null)
            if (rotatorType == null)
            {
                throw new ArgumentNullException("rotatorType is a required property for RotatedSecretCreateSplunk and cannot be null");
            }
            this.RotatorType = rotatorType;
            // to ensure "targetName" is required (not null)
            if (targetName == null)
            {
                throw new ArgumentNullException("targetName is a required property for RotatedSecretCreateSplunk and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Token audience for Splunk token creation (required for rotator-type&#x3D;token)</value>
        ...
        /// </summary>
        /// <value>Current Splunk HEC token value to store (relevant only for rotator-type&#x3D;hec-token). If not provided, a new HEC input will be created in Splunk.</value>
        ...
        /// </summary>
        /// <value>Splunk HEC input name to manage  (required for rotator-type&#x3D;hec-token)</value>
        [DataMember(Name = "hec-token-name", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The rotator type. options: [target/password/token/hec-token]</value>
        ...
        /// </summary>
        /// <value>Current Splunk authentication token to store (relevant only for rotator-type&#x3D;token). If not provided, a new token will be created in Splunk.</value>
        ...
        /// </summary>
        /// <value>Splunk token owner username (relevant only for rotator-type&#x3D;token)</value>
