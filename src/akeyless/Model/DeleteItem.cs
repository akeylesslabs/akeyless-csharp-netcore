...
namespace akeyless.Model
{
    ...
    public partial class DeleteItem : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varVersion">The specific version you want to delete - 0&#x3D;last version, -1&#x3D;entire item with all versions (default) (default to -1).</param>
        public DeleteItem(string accessibility = @"regular", bool deleteImmediately = false, long deleteInDays = 7, bool json = false, string name = default(string), string token = default(string), string uidToken = default(string), int varVersion = -1)
        {
