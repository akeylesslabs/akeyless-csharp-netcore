...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodCreateLdap")]
    public partial class AuthMethodCreateLdap : IEquatable<AuthMethodCreateLdap>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateLdap" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodCreateLdap() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateLdap" /> class.
        /// </summary>
        ...
        /// <param name="genKey">Automatically generate key-pair for LDAP configuration. If set to false, a public key needs to be provided [true/false] (default to &quot;true&quot;).</param>
        ...
        public AuthMethodCreateLdap(long accessExpires = 0, List<string> auditLogsClaims = default(List<string>), List<string> boundIps = default(List<string>), string deleteProtection = default(string), string description = default(string), bool forceSubClaims = default(bool), string genKey = "true", List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), List<string> productType = default(List<string>), string publicKeyData = default(string), string token = default(string), string uidToken = default(string), string uniqueIdentifier = "users")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthMethodCreateLdap and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as AuthMethodCreateLdap);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateLdap instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateLdap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateLdap input)
        {
            if (input == null)
            {
                return false;
