...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodList : IEquatable<AuthMethodList>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodList);
        }

        /// <summary>
        /// Returns true if AuthMethodList instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodList input)
        {
            if (input == null)
            {
                return false;
