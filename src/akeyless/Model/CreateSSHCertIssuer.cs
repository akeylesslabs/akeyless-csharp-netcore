...
namespace akeyless.Model
{
    ...
    public partial class CreateSSHCertIssuer : IValidatableObject
    {
        /// <summary>
        ...
        public CreateSSHCertIssuer(string providerType = default(string), string allowedUsers = @"-", string deleteProtection = default(string), string description = default(string), Dictionary<string, string> extensions = default(Dictionary<string, string>), string externalUsername = @"false", string fixedUserClaimKeyname = default(string), string hostProvider = default(string), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string metadata = default(string), string name = default(string), string principals = default(string), string secureAccessApi = default(string), string secureAccessBastionApi = default(string), string secureAccessBastionSsh = default(string), string secureAccessEnable = default(string), bool secureAccessEnforceHostsRestriction = default(bool), string secureAccessGateway = default(string), List<string> secureAccessHost = default(List<string>), string secureAccessSsh = default(string), string secureAccessSshCredsUser = default(string), bool secureAccessUseInternalBastion = default(bool), bool secureAccessUseInternalSshAccess = default(bool), string signerKeyName = default(string), List<string> tag = default(List<string>), List<string> target = default(List<string>), string token = default(string), long ttl = default(long), string uidToken = default(string))
        {
