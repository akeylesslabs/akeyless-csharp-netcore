...
namespace akeyless.Model
{
    ...
    public partial class CreateSSHCertIssuer : IEquatable<CreateSSHCertIssuer>, IValidatableObject
    {
        ...
        public CreateSSHCertIssuer(string providerType = default(string), string allowedUsers = default(string), string deleteProtection = default(string), string description = default(string), Dictionary<string, string> extensions = default(Dictionary<string, string>), string hostProvider = default(string), bool json = false, string metadata = default(string), string name = default(string), string principals = default(string), string secureAccessBastionApi = default(string), string secureAccessBastionSsh = default(string), string secureAccessEnable = default(string), bool secureAccessEnforceHostsRestriction = default(bool), List<string> secureAccessHost = default(List<string>), string secureAccessSshCredsUser = default(string), bool secureAccessUseInternalBastion = default(bool), string signerKeyName = default(string), List<string> tag = default(List<string>), List<string> target = default(List<string>), string token = default(string), long ttl = default(long), string uidToken = default(string))
        {
