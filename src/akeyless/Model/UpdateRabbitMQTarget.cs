...
namespace akeyless.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRabbitMQTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateRabbitMQTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRabbitMQTarget" /> class.
        /// </summary>
        ...
        public UpdateRabbitMQTarget(string comment = default(string), string description = default(string), bool json = default(bool), string keepPrevVersion = default(string), string key = default(string), string name = default(string), string newName = default(string), string rabbitmqServerPassword = default(string), string rabbitmqServerUri = default(string), string rabbitmqServerUser = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateRabbitMQTarget and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateRabbitMQTarget);
        }

        /// <summary>
        /// Returns true if UpdateRabbitMQTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateRabbitMQTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateRabbitMQTarget input)
        {
            if (input == null)
            {
                return false;
