...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreateKeycloak")]
    public partial class TargetCreateKeycloak : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateKeycloak" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateKeycloak() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateKeycloak" /> class.
        /// </summary>
        ...
        public TargetCreateKeycloak(string clientId = default(string), string clientSecret = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string realm = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), string url = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateKeycloak and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetCreateKeycloak {\n");
