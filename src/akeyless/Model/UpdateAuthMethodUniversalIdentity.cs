...
namespace akeyless.Model
{
    ...
    public partial class UpdateAuthMethodUniversalIdentity : IEquatable<UpdateAuthMethodUniversalIdentity>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateAuthMethodUniversalIdentity(long accessExpires = 0, List<string> boundIps = default(List<string>), bool denyInheritance = default(bool), bool denyRotate = default(bool), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), bool json = default(bool), long jwtTtl = default(long), string name = default(string), string newName = default(string), string token = default(string), int ttl = 60, string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateAuthMethodUniversalIdentity);
        }

        /// <summary>
        /// Returns true if UpdateAuthMethodUniversalIdentity instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAuthMethodUniversalIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAuthMethodUniversalIdentity input)
        {
            if (input == null)
                return false;
