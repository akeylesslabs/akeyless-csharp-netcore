...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateGoogleWorkspace : IValidatableObject
    {
        /// <summary>
        ...
        public DynamicSecretUpdateGoogleWorkspace(string accessMode = default(string), string adminEmail = default(string), bool araEnabled = default(bool), string deleteProtection = default(string), string description = default(string), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), string fixedUserClaimKeyname = @"ext_email", string gcpKey = default(string), string groupEmail = default(string), string groupRole = default(string), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string name = default(string), string newName = default(string), List<string> outputRule = default(List<string>), string producerEncryptionKeyName = default(string), string roleName = default(string), string roleScope = default(string), long secureAccessDelay = default(long), string secureAccessEnable = default(string), string secureAccessUrl = default(string), bool secureAccessWeb = true, bool secureAccessWebBrowsing = false, bool secureAccessWebProxy = false, bool skipDryRun = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = @"60m")
        {
