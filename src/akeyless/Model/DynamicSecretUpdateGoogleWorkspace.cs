...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateGoogleWorkspace : IEquatable<DynamicSecretUpdateGoogleWorkspace>, IValidatableObject
    {
        ...
        public DynamicSecretUpdateGoogleWorkspace(string accessMode = default(string), string adminName = default(string), string deleteProtection = default(string), string description = default(string), string gcpKey = default(string), string groupName = default(string), string groupRoleType = default(string), bool json = false, string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), string roleName = default(string), string roleScope = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            ...
            if (adminName == null)
            {
                throw new ArgumentNullException("adminName is a required property for DynamicSecretUpdateGoogleWorkspace and cannot be null");
            }
