...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayCreateProducerPostgreSQLOutput")]
    public partial class GatewayCreateProducerPostgreSQLOutput : IEquatable<GatewayCreateProducerPostgreSQLOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayCreateProducerPostgreSQLOutput);
        }

        /// <summary>
        /// Returns true if GatewayCreateProducerPostgreSQLOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayCreateProducerPostgreSQLOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayCreateProducerPostgreSQLOutput input)
        {
            if (input == null)
                return false;
