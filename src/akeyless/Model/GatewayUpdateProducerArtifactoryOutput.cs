...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerArtifactoryOutput")]
    public partial class GatewayUpdateProducerArtifactoryOutput : IEquatable<GatewayUpdateProducerArtifactoryOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerArtifactoryOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerArtifactoryOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerArtifactoryOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerArtifactoryOutput input)
        {
            if (input == null)
                return false;
