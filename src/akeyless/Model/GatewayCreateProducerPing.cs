...
namespace akeyless.Model
{
    ...
    public partial class GatewayCreateProducerPing : IEquatable<GatewayCreateProducerPing>, IValidatableObject
    {
        ...
        protected GatewayCreateProducerPing() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayCreateProducerPing" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GatewayCreateProducerPing);
        }

        /// <summary>
        /// Returns true if GatewayCreateProducerPing instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayCreateProducerPing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayCreateProducerPing input)
        {
            if (input == null)
            {
                return false;
