...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateHanadb : IEquatable<RotatedSecretUpdateHanadb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateHanadb);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateHanadb instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateHanadb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateHanadb input)
        {
            if (input == null)
            {
                return false;
