...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateGcp : IEquatable<DynamicSecretUpdateGcp>, IValidatableObject
    {
        /// <summary>
        ...
        public DynamicSecretUpdateGcp(string deleteProtection = default(string), string description = default(string), string gcpCredType = default(string), string gcpKey = default(string), string gcpKeyAlgo = default(string), string gcpSaEmail = default(string), string gcpTokenScopes = default(string), bool json = false, string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), string roleBinding = default(string), string serviceAccountType = "fixed", List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            ...
            {
                throw new ArgumentNullException("serviceAccountType is a required property for DynamicSecretUpdateGcp and cannot be null");
            }
        ...
        {
            return this.Equals(input as DynamicSecretUpdateGcp);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateGcp instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateGcp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateGcp input)
        {
            if (input == null)
            {
                return false;
