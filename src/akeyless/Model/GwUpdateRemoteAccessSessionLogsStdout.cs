...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gwUpdateRemoteAccessSessionLogsStdout")]
    public partial class GwUpdateRemoteAccessSessionLogsStdout : IEquatable<GwUpdateRemoteAccessSessionLogsStdout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GwUpdateRemoteAccessSessionLogsStdout" /> class.
        /// </summary>
        ...
        public GwUpdateRemoteAccessSessionLogsStdout(string enable = "true", bool json = false, string outputFormat = "text", string pullInterval = "10", string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as GwUpdateRemoteAccessSessionLogsStdout);
        }

        /// <summary>
        /// Returns true if GwUpdateRemoteAccessSessionLogsStdout instances are equal
        /// </summary>
        /// <param name="input">Instance of GwUpdateRemoteAccessSessionLogsStdout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GwUpdateRemoteAccessSessionLogsStdout input)
        {
            if (input == null)
            {
                return false;
