...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateAerospike")]
    public partial class DynamicSecretUpdateAerospike : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateAerospike" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateAerospike() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateAerospike" /> class.
        /// </summary>
        ...
        public DynamicSecretUpdateAerospike(List<string> aerospikeRoles = default(List<string>), bool araEnabled = default(bool), string customUsernameTemplate = default(string), string deleteProtection = default(string), string description = default(string), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string name = default(string), string newName = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), string skipDryRun = default(string), string targetName = default(string), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string), string userTtl = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretUpdateAerospike and cannot be null");
            }
            this.Name = name;
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DynamicSecretUpdateAerospike {\n");
