...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodCreateSAML")]
    public partial class AuthMethodCreateSAML : IEquatable<AuthMethodCreateSAML>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateSAML" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodCreateSAML() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateSAML" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AuthMethodCreateSAML);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateSAML instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateSAML to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateSAML input)
        {
            if (input == null)
            {
                return false;
