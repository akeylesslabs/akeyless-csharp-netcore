...
namespace akeyless.Model
{
    ...
    public partial class CreateAuthMethodOIDC : IEquatable<CreateAuthMethodOIDC>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateAuthMethodOIDC);
        }

        /// <summary>
        /// Returns true if CreateAuthMethodOIDC instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAuthMethodOIDC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAuthMethodOIDC input)
        {
            if (input == null)
                return false;
