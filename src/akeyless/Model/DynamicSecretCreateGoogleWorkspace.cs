...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateGoogleWorkspace : IEquatable<DynamicSecretCreateGoogleWorkspace>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateGoogleWorkspace);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateGoogleWorkspace instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateGoogleWorkspace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateGoogleWorkspace input)
        {
            if (input == null)
            {
                return false;
