...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateEks : IEquatable<DynamicSecretUpdateEks>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateEks);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateEks instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateEks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateEks input)
        {
            if (input == null)
            {
                return false;
