...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateSsh : IEquatable<TargetCreateSsh>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateSsh);
        }

        /// <summary>
        /// Returns true if TargetCreateSsh instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateSsh to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateSsh input)
        {
            if (input == null)
            {
                return false;
