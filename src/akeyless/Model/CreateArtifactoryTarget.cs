...
namespace akeyless.Model
{
    ...
    public partial class CreateArtifactoryTarget :  IEquatable<CreateArtifactoryTarget>, IValidatableObject
    {
        ...
        public CreateArtifactoryTarget(string artifactoryAdminName = default(string), string artifactoryAdminPwd = default(string), string baseUrl = default(string), string comment = default(string), string key = default(string), string name = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "artifactoryAdminName" is required (not null)
            this.ArtifactoryAdminName = artifactoryAdminName ?? throw new ArgumentNullException("artifactoryAdminName is a required property for CreateArtifactoryTarget and cannot be null");
            // to ensure "artifactoryAdminPwd" is required (not null)
            this.ArtifactoryAdminPwd = artifactoryAdminPwd ?? throw new ArgumentNullException("artifactoryAdminPwd is a required property for CreateArtifactoryTarget and cannot be null");
            // to ensure "baseUrl" is required (not null)
            this.BaseUrl = baseUrl ?? throw new ArgumentNullException("baseUrl is a required property for CreateArtifactoryTarget and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateArtifactoryTarget and cannot be null");
