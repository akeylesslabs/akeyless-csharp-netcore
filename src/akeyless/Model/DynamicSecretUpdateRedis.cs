...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateRedis")]
    public partial class DynamicSecretUpdateRedis : IEquatable<DynamicSecretUpdateRedis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateRedis" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateRedis() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateRedis" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateRedis);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateRedis instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateRedis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateRedis input)
        {
            if (input == null)
            {
                return false;
