...
namespace akeyless.Model
{
    ...
    public partial class UpdateGitlabTarget : IEquatable<UpdateGitlabTarget>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpdateGitlabTarget);
        }

        /// <summary>
        /// Returns true if UpdateGitlabTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateGitlabTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateGitlabTarget input)
        {
            if (input == null)
            {
                return false;
