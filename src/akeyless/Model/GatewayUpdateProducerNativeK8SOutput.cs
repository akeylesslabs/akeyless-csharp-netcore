...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerNativeK8SOutput")]
    public partial class GatewayUpdateProducerNativeK8SOutput : IEquatable<GatewayUpdateProducerNativeK8SOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerNativeK8SOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerNativeK8SOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerNativeK8SOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerNativeK8SOutput input)
        {
            if (input == null)
            {
                return false;
