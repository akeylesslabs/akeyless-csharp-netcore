...
namespace akeyless.Model
{
    ...
    /// TargetUpdateOkta
    /// </summary>
    [DataContract(Name = "targetUpdateOkta")]
    public partial class TargetUpdateOkta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateOkta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateOkta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateOkta" /> class.
        /// </summary>
        /// <param name="apiToken">Okta API token.</param>
        ...
        /// <param name="url">Okta URL.</param>
        public TargetUpdateOkta(string apiToken = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), string url = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateOkta and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetUpdateOkta {\n");
