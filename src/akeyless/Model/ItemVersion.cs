...
namespace akeyless.Model
{
    ...
    public partial class ItemVersion : IValidatableObject
    {
        ...
        public ItemVersion(DateTime accessDate = default(DateTime), string accessDateDisplay = default(string), string accessId = default(string), CertificateVersionInfo certificateVersionInfo = default(CertificateVersionInfo), DateTime creationDate = default(DateTime), string customerFragmentId = default(string), DateTime deletionDate = default(DateTime), string itemVersionState = default(string), DateTime modificationDate = default(DateTime), string protectionKeyName = default(string), string uniqueIdentifier = default(string), int varVersion = default(int), bool withCustomerFragment = default(bool))
        {
