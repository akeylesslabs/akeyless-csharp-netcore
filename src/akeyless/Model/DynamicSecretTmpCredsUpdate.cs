...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretTmpCredsUpdate")]
    public partial class DynamicSecretTmpCredsUpdate : IEquatable<DynamicSecretTmpCredsUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretTmpCredsUpdate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretTmpCredsUpdate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretTmpCredsUpdate" /> class.
        /// </summary>
        ...
        public DynamicSecretTmpCredsUpdate(string host = default(string), bool json = false, string name = default(string), long newTtlMin = default(long), string tmpCredsId = default(string), string token = default(string), string uidToken = default(string))
        {
            ...
            if (host == null)
            {
                throw new ArgumentNullException("host is a required property for DynamicSecretTmpCredsUpdate and cannot be null");
            }
            this.Host = host;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretTmpCredsUpdate and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as DynamicSecretTmpCredsUpdate);
        }

        /// <summary>
        /// Returns true if DynamicSecretTmpCredsUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretTmpCredsUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretTmpCredsUpdate input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.NewTtlMin == input.NewTtlMin ||
