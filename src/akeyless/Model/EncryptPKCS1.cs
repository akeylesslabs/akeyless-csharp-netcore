...
namespace akeyless.Model
{
    ...
    public partial class EncryptPKCS1 : IEquatable<EncryptPKCS1>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as EncryptPKCS1);
        }

        /// <summary>
        /// Returns true if EncryptPKCS1 instances are equal
        /// </summary>
        /// <param name="input">Instance of EncryptPKCS1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EncryptPKCS1 input)
        {
            if (input == null)
                return false;
