...
namespace akeyless.Model
{
    ...
    public partial class AssocTargetItem :  IEquatable<AssocTargetItem>, IValidatableObject
    {
        ...
        public AssocTargetItem(string name = default(string), string password = default(string), string targetName = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
