...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayCreateProducerLdapOutput")]
    public partial class GatewayCreateProducerLdapOutput : IEquatable<GatewayCreateProducerLdapOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayCreateProducerLdapOutput);
        }

        /// <summary>
        /// Returns true if GatewayCreateProducerLdapOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayCreateProducerLdapOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayCreateProducerLdapOutput input)
        {
            if (input == null)
            {
                return false;
