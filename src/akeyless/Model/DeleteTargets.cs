...
namespace akeyless.Model
{
    ...
    /// DeleteTargets
    /// </summary>
    [DataContract(Name = "deleteTargets")]
    public partial class DeleteTargets : IEquatable<DeleteTargets>, IValidatableObject
    {
        ...
        public DeleteTargets(bool forceDeletion = false, bool json = false, string path = default(string), string token = default(string), string uidToken = default(string))
        {
