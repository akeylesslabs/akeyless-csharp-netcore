...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateZeroSSL : IEquatable<TargetUpdateZeroSSL>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateZeroSSL);
        }

        /// <summary>
        /// Returns true if TargetUpdateZeroSSL instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateZeroSSL to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateZeroSSL input)
        {
            if (input == null)
            {
                return false;
