...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateGke : IEquatable<TargetUpdateGke>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateGke);
        }

        /// <summary>
        /// Returns true if TargetUpdateGke instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateGke to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateGke input)
        {
            if (input == null)
            {
                return false;
