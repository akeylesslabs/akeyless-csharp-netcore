...
namespace akeyless.Model
{
    ...
    public partial class CreateAuthMethodUniversalIdentity : IEquatable<CreateAuthMethodUniversalIdentity>, IValidatableObject
    {
        ...
        protected CreateAuthMethodUniversalIdentity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAuthMethodUniversalIdentity" /> class.
        /// </summary>
        ...
        public CreateAuthMethodUniversalIdentity(long accessExpires = 0, List<string> boundIps = default(List<string>), bool denyInheritance = default(bool), bool denyRotate = default(bool), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), bool json = default(bool), long jwtTtl = default(long), string name = default(string), string token = default(string), int ttl = 60, string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CreateAuthMethodUniversalIdentity and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CreateAuthMethodUniversalIdentity);
        }

        /// <summary>
        /// Returns true if CreateAuthMethodUniversalIdentity instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAuthMethodUniversalIdentity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAuthMethodUniversalIdentity input)
        {
            if (input == null)
                return false;
