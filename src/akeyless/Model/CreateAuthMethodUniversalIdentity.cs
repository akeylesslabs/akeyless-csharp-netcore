...
namespace akeyless.Model
{
    ...
    public partial class CreateAuthMethodUniversalIdentity : IEquatable<CreateAuthMethodUniversalIdentity>, IValidatableObject
    {
        ...
        public CreateAuthMethodUniversalIdentity(long accessExpires = 0, List<string> boundIps = default(List<string>), bool denyInheritance = default(bool), bool denyRotate = default(bool), bool forceSubClaims = default(bool), long jwtTtl = default(long), string name = default(string), string token = default(string), int ttl = 60, string uidToken = default(string))
        {
