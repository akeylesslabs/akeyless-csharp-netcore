...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateHanaDb : IEquatable<DynamicSecretCreateHanaDb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateHanaDb);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateHanaDb instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateHanaDb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateHanaDb input)
        {
            if (input == null)
            {
                return false;
