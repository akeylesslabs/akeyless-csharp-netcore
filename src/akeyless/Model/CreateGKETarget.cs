...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateGKETarget :  IEquatable<CreateGKETarget>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateGKETarget(string comment = default(string), string gkeAccountKey = default(string), string gkeClusterCert = default(string), string gkeClusterEndpoint = default(string), string gkeClusterName = default(string), string gkeServiceAccountEmail = default(string), string key = default(string), string name = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            ...
            this.GkeClusterEndpoint = gkeClusterEndpoint ?? throw new ArgumentNullException("gkeClusterEndpoint is a required property for CreateGKETarget and cannot be null");
            // to ensure "gkeClusterName" is required (not null)
            this.GkeClusterName = gkeClusterName ?? throw new ArgumentNullException("gkeClusterName is a required property for CreateGKETarget and cannot be null");
            // to ensure "gkeServiceAccountEmail" is required (not null)
            this.GkeServiceAccountEmail = gkeServiceAccountEmail ?? throw new ArgumentNullException("gkeServiceAccountEmail is a required property for CreateGKETarget and cannot be null");
        ...
        {
            return this.Equals(input as CreateGKETarget);
        }

        /// <summary>
        /// Returns true if CreateGKETarget instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateGKETarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateGKETarget input)
        {
            if (input == null)
                return false;
