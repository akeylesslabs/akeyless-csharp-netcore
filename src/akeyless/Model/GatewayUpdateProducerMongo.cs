...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerMongo : IEquatable<GatewayUpdateProducerMongo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerMongo);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerMongo instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerMongo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerMongo input)
        {
            if (input == null)
                return false;
