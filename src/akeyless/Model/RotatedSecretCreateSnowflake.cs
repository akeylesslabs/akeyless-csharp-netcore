...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretCreateSnowflake")]
    public partial class RotatedSecretCreateSnowflake : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateSnowflake" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretCreateSnowflake() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateSnowflake" /> class.
        /// </summary>
        ...
        /// <param name="privateKey">RSA Private key (base64 encoded) to rotate (relevant only for rotator-type&#x3D;key).</param>
        /// <param name="privateKeyFileName">The path to the file containing the private key (relevant only for rotator-type&#x3D;key).</param>
        ...
        /// <param name="rotatedUsername">username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it&#39;s own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type&#x3D;password or rotator-type&#x3D;key).</param>
        ...
        /// <param name="rotationStatement">Snowflake rotation statement.</param>
        ...
        public RotatedSecretCreateSnowflake(bool araEnabled = default(bool), string authenticationCredentials = @"use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = default(string), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), string privateKey = default(string), string privateKeyFileName = default(string), string rotateOnUnlock = default(string), string rotatedPassword = default(string), string rotatedUsername = default(string), List<string> rotationEventIn = default(List<string>), int rotationHour = default(int), string rotationInterval = default(string), string rotationStatement = default(string), string rotatorType = default(string), string skipDryRun = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretCreateSnowflake and cannot be null");
            }
            this.Name = name;
            // to ensure "rotatorType" is required (not null)
            if (rotatorType == null)
            {
                throw new ArgumentNullException("rotatorType is a required property for RotatedSecretCreateSnowflake and cannot be null");
            }
            this.RotatorType = rotatorType;
            // to ensure "targetName" is required (not null)
            if (targetName == null)
            {
                throw new ArgumentNullException("targetName is a required property for RotatedSecretCreateSnowflake and cannot be null");
            }
        ...
        /// </summary>
        /// <value>RSA Private key (base64 encoded) to rotate (relevant only for rotator-type&#x3D;key)</value>
        ...
        /// </summary>
        /// <value>The path to the file containing the private key (relevant only for rotator-type&#x3D;key)</value>
        [DataMember(Name = "private-key-file-name", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>username to be rotated, if selected use-self-creds at rotator-creds-type, this username will try to rotate it&#39;s own password, if use-target-creds is selected, target credentials will be use to rotate the rotated-password (relevant only for rotator-type&#x3D;password or rotator-type&#x3D;key)</value>
        ...
        /// </summary>
        /// <value>Snowflake rotation statement</value>
        [DataMember(Name = "rotation-statement", EmitDefaultValue = false)]
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrivateKeyFileName: ").Append(PrivateKeyFileName).Append("\n");
