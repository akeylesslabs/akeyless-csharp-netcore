...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createZeroSSLTarget")]
    public partial class CreateZeroSSLTarget : IEquatable<CreateZeroSSLTarget>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateZeroSSLTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateZeroSSLTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateZeroSSLTarget" /> class.
        /// </summary>
        ...
        public CreateZeroSSLTarget(string apiKey = default(string), string comment = default(string), string description = default(string), string imapFqdn = default(string), string imapPassword = default(string), string imapPort = "993", string imapTargetEmail = default(string), string imapUsername = default(string), bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string timeout = "5m", string token = default(string), string uidToken = default(string))
        {
            // to ensure "apiKey" is required (not null)
            if (apiKey == null)
            {
                throw new ArgumentNullException("apiKey is a required property for CreateZeroSSLTarget and cannot be null");
            }
            this.ApiKey = apiKey;
            // to ensure "imapFqdn" is required (not null)
            if (imapFqdn == null)
            {
                throw new ArgumentNullException("imapFqdn is a required property for CreateZeroSSLTarget and cannot be null");
            }
            this.ImapFqdn = imapFqdn;
            // to ensure "imapPassword" is required (not null)
            if (imapPassword == null)
            {
                throw new ArgumentNullException("imapPassword is a required property for CreateZeroSSLTarget and cannot be null");
            }
            this.ImapPassword = imapPassword;
            // to ensure "imapUsername" is required (not null)
            if (imapUsername == null)
            {
                throw new ArgumentNullException("imapUsername is a required property for CreateZeroSSLTarget and cannot be null");
            }
            this.ImapUsername = imapUsername;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateZeroSSLTarget and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CreateZeroSSLTarget);
        }

        /// <summary>
        /// Returns true if CreateZeroSSLTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateZeroSSLTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateZeroSSLTarget input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ImapTargetEmail == input.ImapTargetEmail ||
                    (this.ImapTargetEmail != null &&
                    this.ImapTargetEmail.Equals(input.ImapTargetEmail))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ImapTargetEmail != null)
                {
                    hashCode = (hashCode * 59) + this.ImapTargetEmail.GetHashCode();
                }
