...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateAzure : IEquatable<TargetUpdateAzure>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateAzure);
        }

        /// <summary>
        /// Returns true if TargetUpdateAzure instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateAzure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateAzure input)
        {
            if (input == null)
            {
                return false;
