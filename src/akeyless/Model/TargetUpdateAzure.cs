...
namespace akeyless.Model
{
    ...
    /// TargetUpdateAzure
    /// </summary>
    [DataContract(Name = "targetUpdateAzure")]
    public partial class TargetUpdateAzure : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateAzure" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateAzure() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateAzure" /> class.
        /// </summary>
        ...
        public TargetUpdateAzure(string azureCloud = @"AzureCloud", string clientId = default(string), string clientSecret = default(string), string connectionType = @"credentials", string deleteProtection = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string resourceGroupName = default(string), string resourceName = default(string), string rotateOnUnlock = default(string), string subscriptionId = default(string), string tenantId = default(string), string token = default(string), string uidToken = default(string), bool useGwCloudIdentity = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateAzure and cannot be null");
            }
            this.Name = name;
