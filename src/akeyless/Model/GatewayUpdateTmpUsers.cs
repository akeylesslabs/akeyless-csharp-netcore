...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateTmpUsers :  IEquatable<GatewayUpdateTmpUsers>, IValidatableObject
    {
        ...
        protected GatewayUpdateTmpUsers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateTmpUsers" /> class.
        /// </summary>
        ...
        public GatewayUpdateTmpUsers(string gatewayUrl = default(string), string name = default(string), long newTtlMin = default(long), string tmpCredsId = default(string), string token = default(string), string uidToken = default(string))
        {
        ...
        [DataMember(Name="new-ttl-min", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as GatewayUpdateTmpUsers);
        }

        /// <summary>
        /// Returns true if GatewayUpdateTmpUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateTmpUsers to be compared</param>
        /// <returns>Boolean</returns>
