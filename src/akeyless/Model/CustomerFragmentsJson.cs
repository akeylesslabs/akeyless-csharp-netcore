...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomerFragmentsJson")]
    public partial class CustomerFragmentsJson : IEquatable<CustomerFragmentsJson>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerFragmentsJson" /> class.
        /// </summary>
        /// <param name="customerFragments">customerFragments.</param>
        public CustomerFragmentsJson(List<CustomerFragment> customerFragments = default(List<CustomerFragment>))
        {
        ...
        public List<CustomerFragment> CustomerFragments { get; set; }
        ...
        {
            return this.Equals(input as CustomerFragmentsJson);
        }

        /// <summary>
        /// Returns true if CustomerFragmentsJson instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomerFragmentsJson to be compared</param>
        /// <returns>Boolean</returns>
