...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateAnthropic")]
    public partial class TargetUpdateAnthropic : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateAnthropic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateAnthropic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateAnthropic" /> class.
        /// </summary>
        /// <param name="anthropicUrl">Base URL of the Anthropic API (default to &quot;https://api.anthropic.com&quot;).</param>
        /// <param name="apiKey">API key for Anthropic.</param>
        ...
        public TargetUpdateAnthropic(string anthropicUrl = @"https://api.anthropic.com", string apiKey = default(string), string deleteProtection = default(string), string description = @"default_comment", bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newComment = @"default_comment", string newName = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateAnthropic and cannot be null");
            }
            this.Name = name;
            // use default value if no "anthropicUrl" provided
            this.AnthropicUrl = anthropicUrl ?? @"https://api.anthropic.com";
            this.ApiKey = apiKey;
        ...
        /// </summary>
        /// <value>Base URL of the Anthropic API</value>
        [DataMember(Name = "anthropic-url", EmitDefaultValue = false)]
        public string AnthropicUrl { get; set; }

        /// <summary>
        /// API key for Anthropic
        /// </summary>
        /// <value>API key for Anthropic</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetUpdateAnthropic {\n");
