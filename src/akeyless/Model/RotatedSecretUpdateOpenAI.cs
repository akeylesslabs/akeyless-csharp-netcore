...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretUpdateOpenAI")]
    public partial class RotatedSecretUpdateOpenAI : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateOpenAI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretUpdateOpenAI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateOpenAI" /> class.
        /// </summary>
        /// <param name="addTag">List of the new tags that will be attached to this item.</param>
        /// <param name="apiKey">Admin API key value to update (relevant only for rotator-type&#x3D;api-key).</param>
        /// <param name="apiKeyId">Admin API key ID to update (relevant only for rotator-type&#x3D;api-key).</param>
        ...
        /// </summary>
        /// <value>Admin API key value to update (relevant only for rotator-type&#x3D;api-key)</value>
        ...
        /// </summary>
        /// <value>Admin API key ID to update (relevant only for rotator-type&#x3D;api-key)</value>
