...
namespace akeyless.Model
{
    ...
    public partial class GetTarget : IEquatable<GetTarget>, IValidatableObject
    {
        ...
        public GetTarget(bool json = default(bool), string name = default(string), bool showVersions = false, string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as GetTarget);
        }

        /// <summary>
        /// Returns true if GetTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of GetTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetTarget input)
        {
            if (input == null)
                return false;
