...
namespace akeyless.Model
{
    ...
    public partial class UpdateAssoc :  IEquatable<UpdateAssoc>, IValidatableObject
    {
        ...
        public UpdateAssoc(string assocId = default(string), string password = default(string), Dictionary<string, string> subClaims = default(Dictionary<string, string>), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "assocId" is required (not null)
            this.AssocId = assocId ?? throw new ArgumentNullException("assocId is a required property for UpdateAssoc and cannot be null");
