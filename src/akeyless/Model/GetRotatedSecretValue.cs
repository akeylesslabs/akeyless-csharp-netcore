...
namespace akeyless.Model
{
    ...
    public partial class GetRotatedSecretValue : IValidatableObject
    {
        /// <summary>
        ...
        public GetRotatedSecretValue(string host = default(string), string ignoreCache = @"false", bool json = false, string names = default(string), string token = default(string), string uidToken = default(string), int varVersion = default(int))
        {
