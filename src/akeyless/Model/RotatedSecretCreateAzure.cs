...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretCreateAzure : IEquatable<RotatedSecretCreateAzure>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="rotatorType">The rotator type. options: [target/api-key/azure-storage-account] (required).</param>
        ...
        public RotatedSecretCreateAzure(string apiId = default(string), string apiKey = default(string), string applicationId = default(string), string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string name = default(string), string passwordLength = default(string), int rotationHour = default(int), string rotationInterval = default(string), string rotatorType = default(string), string storageAccountKeyName = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string))
        {
        ...
        /// </summary>
        /// <value>The rotator type. options: [target/api-key/azure-storage-account]</value>
        ...
        {
            return this.Equals(input as RotatedSecretCreateAzure);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateAzure instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateAzure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateAzure input)
        {
            if (input == null)
            {
                return false;
