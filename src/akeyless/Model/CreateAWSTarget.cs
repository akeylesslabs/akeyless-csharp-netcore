...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createAWSTarget")]
    public partial class CreateAWSTarget : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="roleArn">AWS IAM role identifier that Gateway will assume in your AWS account, relevant only when using external ID.</param>
        ...
        public CreateAWSTarget(string accessKey = default(string), string accessKeyId = default(string), string comment = default(string), string description = default(string), bool generateExternalId = default(bool), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string region = @"us-east-2", string roleArn = default(string), string rotateOnUnlock = default(string), string sessionToken = default(string), string token = default(string), string uidToken = default(string), bool useGwCloudIdentity = default(bool))
        {
            // to ensure "accessKey" is required (not null)
            if (accessKey == null)
            {
                throw new ArgumentNullException("accessKey is a required property for CreateAWSTarget and cannot be null");
            }
            this.AccessKey = accessKey;
            // to ensure "accessKeyId" is required (not null)
            if (accessKeyId == null)
            {
                throw new ArgumentNullException("accessKeyId is a required property for CreateAWSTarget and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A unique auto-generated value used in your AWS account when configuring your AWS IAM role to securely delegate access to Akeyless. Relevant only when using GW cloud ID</value>
        [DataMember(Name = "generate-external-id", EmitDefaultValue = true)]
        public bool GenerateExternalId { get; set; }
        ...
        /// </summary>
        /// <value>AWS IAM role identifier that Gateway will assume in your AWS account, relevant only when using external ID</value>
