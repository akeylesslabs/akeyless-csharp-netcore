...
namespace akeyless.Model
{
    ...
    /// RawCreds
    /// </summary>
    [DataContract(Name = "rawCreds")]
    public partial class RawCreds : IEquatable<RawCreds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RawCreds" /> class.
        /// </summary>
        /// <param name="accessId">accessId.</param>
        /// <param name="accessKey">accessKey.</param>
        public RawCreds(string accessId = default(string), string accessKey = default(string))
        {
        ...
        {
            return this.Equals(input as RawCreds);
        }

        /// <summary>
        /// Returns true if RawCreds instances are equal
        /// </summary>
        /// <param name="input">Instance of RawCreds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RawCreds input)
        {
            if (input == null)
            {
                return false;
