...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreatePing")]
    public partial class DynamicSecretCreatePing : IEquatable<DynamicSecretCreatePing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreatePing" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreatePing() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreatePing" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreatePing);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreatePing instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreatePing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreatePing input)
        {
            if (input == null)
            {
                return false;
