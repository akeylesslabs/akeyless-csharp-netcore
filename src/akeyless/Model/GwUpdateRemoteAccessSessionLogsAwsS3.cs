...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gwUpdateRemoteAccessSessionLogsAwsS3")]
    public partial class GwUpdateRemoteAccessSessionLogsAwsS3 : IEquatable<GwUpdateRemoteAccessSessionLogsAwsS3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GwUpdateRemoteAccessSessionLogsAwsS3" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GwUpdateRemoteAccessSessionLogsAwsS3);
        }

        /// <summary>
        /// Returns true if GwUpdateRemoteAccessSessionLogsAwsS3 instances are equal
        /// </summary>
        /// <param name="input">Instance of GwUpdateRemoteAccessSessionLogsAwsS3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GwUpdateRemoteAccessSessionLogsAwsS3 input)
        {
            if (input == null)
            {
                return false;
