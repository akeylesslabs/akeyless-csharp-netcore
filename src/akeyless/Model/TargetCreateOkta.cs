...
namespace akeyless.Model
{
    ...
    /// TargetCreateOkta
    /// </summary>
    [DataContract(Name = "targetCreateOkta")]
    public partial class TargetCreateOkta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateOkta" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateOkta() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateOkta" /> class.
        /// </summary>
        ...
        public TargetCreateOkta(string apiToken = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), string url = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateOkta and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetCreateOkta {\n");
