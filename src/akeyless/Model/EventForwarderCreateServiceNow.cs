...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "eventForwarderCreateServiceNow")]
    public partial class EventForwarderCreateServiceNow : IEquatable<EventForwarderCreateServiceNow>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventForwarderCreateServiceNow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventForwarderCreateServiceNow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventForwarderCreateServiceNow" /> class.
        /// </summary>
        ...
        public EventForwarderCreateServiceNow(string adminName = default(string), string adminPwd = default(string), string appPrivateKeyBase64 = default(string), List<string> authMethodsEventSourceLocations = default(List<string>), string authType = "user-pass", string clientId = default(string), string clientSecret = default(string), string description = default(string), List<string> eventTypes = default(List<string>), string every = default(string), List<string> gatewaysEventSourceLocations = default(List<string>), string host = default(string), List<string> itemsEventSourceLocations = default(List<string>), bool json = false, string key = default(string), string name = default(string), string runnerType = default(string), List<string> targetsEventSourceLocations = default(List<string>), string token = default(string), string uidToken = default(string), string userEmail = default(string))
        {
            // to ensure "gatewaysEventSourceLocations" is required (not null)
            if (gatewaysEventSourceLocations == null)
            {
                throw new ArgumentNullException("gatewaysEventSourceLocations is a required property for EventForwarderCreateServiceNow and cannot be null");
            }
            this.GatewaysEventSourceLocations = gatewaysEventSourceLocations;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for EventForwarderCreateServiceNow and cannot be null");
            }
            this.Name = name;
            // to ensure "runnerType" is required (not null)
            if (runnerType == null)
            {
                throw new ArgumentNullException("runnerType is a required property for EventForwarderCreateServiceNow and cannot be null");
            }
        ...
        {
            return this.Equals(input as EventForwarderCreateServiceNow);
        }

        /// <summary>
        /// Returns true if EventForwarderCreateServiceNow instances are equal
        /// </summary>
        /// <param name="input">Instance of EventForwarderCreateServiceNow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventForwarderCreateServiceNow input)
        {
            if (input == null)
            {
                return false;
