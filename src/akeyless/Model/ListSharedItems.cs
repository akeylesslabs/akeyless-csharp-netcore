...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "listSharedItems")]
    public partial class ListSharedItems : IEquatable<ListSharedItems>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ListSharedItems);
        }

        /// <summary>
        /// Returns true if ListSharedItems instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSharedItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSharedItems input)
        {
            if (input == null)
            {
                return false;
