...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateVenafi")]
    public partial class DynamicSecretUpdateVenafi : IEquatable<DynamicSecretUpdateVenafi>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateVenafi" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateVenafi() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateVenafi" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateVenafi);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateVenafi instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateVenafi to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateVenafi input)
        {
            if (input == null)
            {
                return false;
