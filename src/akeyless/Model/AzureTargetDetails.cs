...
namespace akeyless.Model
{
    ...
    public partial class AzureTargetDetails : IValidatableObject
    {
        ...
        public AzureTargetDetails(string azureClientId = default(string), string azureClientSecret = default(string), string azureResourceGroupName = default(string), string azureResourceName = default(string), string azureSubscriptionId = default(string), string azureTenantId = default(string), string azureUsername = default(string), DateTime expirationDate = default(DateTime), bool useGwCloudIdentity = default(bool))
        {
