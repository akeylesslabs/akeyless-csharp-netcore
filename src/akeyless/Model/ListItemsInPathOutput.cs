...
namespace akeyless.Model
{
    ...
    public partial class ListItemsInPathOutput : IValidatableObject
    {
        /// <summary>
        ...
        public ListItemsInPathOutput(List<string> folders = default(List<string>), bool hasNext = default(bool), List<Item> items = default(List<Item>), string nextPage = default(string))
        {
