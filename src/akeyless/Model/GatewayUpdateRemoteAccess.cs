...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateRemoteAccess : IEquatable<GatewayUpdateRemoteAccess>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateRemoteAccess);
        }

        /// <summary>
        /// Returns true if GatewayUpdateRemoteAccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateRemoteAccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateRemoteAccess input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    this.AllowedUrls.Equals(input.AllowedUrls))
                ) && 
                (
                    this.HideSessionRecording == input.HideSessionRecording ||
                    (this.HideSessionRecording != null &&
                ...
                (
                    this.LegacySshAlgorithm == input.LegacySshAlgorithm ||
                    (this.LegacySshAlgorithm != null &&
                    this.LegacySshAlgorithm.Equals(input.LegacySshAlgorithm))
                ) && 
                (
                    this.RdpTargetConfiguration == input.RdpTargetConfiguration ||
                    (this.RdpTargetConfiguration != null &&
                    this.RdpTargetConfiguration.Equals(input.RdpTargetConfiguration))
                ) && 
                (
                    this.SshTargetConfiguration == input.SshTargetConfiguration ||
                    (this.SshTargetConfiguration != null &&
                    this.SshTargetConfiguration.Equals(input.SshTargetConfiguration))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HideSessionRecording != null)
                {
                ...
                if (this.LegacySshAlgorithm != null)
                {
                    hashCode = (hashCode * 59) + this.LegacySshAlgorithm.GetHashCode();
                }
                if (this.RdpTargetConfiguration != null)
                {
                    hashCode = (hashCode * 59) + this.RdpTargetConfiguration.GetHashCode();
                }
                if (this.SshTargetConfiguration != null)
                {
                    hashCode = (hashCode * 59) + this.SshTargetConfiguration.GetHashCode();
                }
                if (this.Token != null)
                {
