...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateK8s : IEquatable<TargetUpdateK8s>, IValidatableObject
    {
        /// <summary>
        ...
        public TargetUpdateK8s(string description = default(string), bool json = false, string k8sAuthType = "token", string k8sClientCertificate = default(string), string k8sClientKey = default(string), string k8sClusterCaCert = "dummy_val", string k8sClusterEndpoint = "dummy_val", string k8sClusterName = default(string), string k8sClusterToken = "dummy_val", string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string token = default(string), string uidToken = default(string), bool useGwServiceAccount = default(bool))
        {
            // to ensure "k8sClusterCaCert" is required (not null)
            if (k8sClusterCaCert == null)
            {
                throw new ArgumentNullException("k8sClusterCaCert is a required property for TargetUpdateK8s and cannot be null");
            }
            this.K8sClusterCaCert = k8sClusterCaCert;
            // to ensure "k8sClusterEndpoint" is required (not null)
            if (k8sClusterEndpoint == null)
            {
                throw new ArgumentNullException("k8sClusterEndpoint is a required property for TargetUpdateK8s and cannot be null");
            }
            this.K8sClusterEndpoint = k8sClusterEndpoint;
            // to ensure "k8sClusterToken" is required (not null)
            if (k8sClusterToken == null)
            {
                throw new ArgumentNullException("k8sClusterToken is a required property for TargetUpdateK8s and cannot be null");
            }
        ...
        {
            return this.Equals(input as TargetUpdateK8s);
        }

        /// <summary>
        /// Returns true if TargetUpdateK8s instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateK8s to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateK8s input)
        {
            if (input == null)
            {
                return false;
