...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateK8s : IValidatableObject
    {
        ...
        public TargetUpdateK8s(string deleteProtection = default(string), string description = default(string), bool json = false, string k8sAuthType = @"token", string k8sClientCertificate = default(string), string k8sClientKey = default(string), string k8sClusterCaCert = default(string), string k8sClusterEndpoint = default(string), string k8sClusterName = default(string), string k8sClusterToken = default(string), string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), bool useGwServiceAccount = default(bool))
        {
