...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodUpdateEmail : IEquatable<AuthMethodUpdateEmail>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodUpdateEmail);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateEmail input)
        {
            if (input == null)
            {
                return false;
