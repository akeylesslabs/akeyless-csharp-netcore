...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateGitlab : IEquatable<TargetUpdateGitlab>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateGitlab);
        }

        /// <summary>
        /// Returns true if TargetUpdateGitlab instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateGitlab to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateGitlab input)
        {
            if (input == null)
            {
                return false;
