...
namespace akeyless.Model
{
    ...
    /// KmipServerUpdate
    /// </summary>
    [DataContract(Name = "kmipServerUpdate")]
    public partial class KmipServerUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KmipServerUpdate" /> class.
        /// </summary>
        ...
        public KmipServerUpdate(List<string> expirationEventIn = default(List<string>), bool json = false, string token = default(string), string uidToken = default(string))
        {
