...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateDockerhub : IEquatable<TargetUpdateDockerhub>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateDockerhub);
        }

        /// <summary>
        /// Returns true if TargetUpdateDockerhub instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateDockerhub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateDockerhub input)
        {
            if (input == null)
            {
                return false;
