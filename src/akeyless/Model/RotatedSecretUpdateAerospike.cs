...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretUpdateAerospike")]
    public partial class RotatedSecretUpdateAerospike : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateAerospike" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretUpdateAerospike() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdateAerospike" /> class.
        /// </summary>
        /// <param name="addTag">List of the new tags that will be attached to this item. To specify multiple tags use argument multiple times: - -add-tag Tag1 - -add-tag Tag2.</param>
        ...
        /// <param name="rmTag">List of the existent tags that will be removed from this item. To specify multiple tags use argument multiple times: - -rm-tag Tag1 - -rm-tag Tag2.</param>
        ...
        public RotatedSecretUpdateAerospike(List<string> addTag = default(List<string>), bool araEnabled = default(bool), string authenticationCredentials = @"use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = @"default_metadata", bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), List<string> rmTag = default(List<string>), string rotateOnUnlock = default(string), string rotatedPassword = default(string), string rotatedUsername = default(string), List<string> rotationEventIn = default(List<string>), int rotationHour = default(int), string rotationInterval = default(string), bool skipDryRun = default(bool), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretUpdateAerospike and cannot be null");
            }
            this.Name = name;
            this.AddTag = addTag;
        ...
        /// </summary>
        /// <value>List of the new tags that will be attached to this item. To specify multiple tags use argument multiple times: - -add-tag Tag1 - -add-tag Tag2</value>
        ...
        /// </summary>
        /// <value>List of the existent tags that will be removed from this item. To specify multiple tags use argument multiple times: - -rm-tag Tag1 - -rm-tag Tag2</value>
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RotatedSecretUpdateAerospike {\n");
