...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodCreateOIDC")]
    public partial class AuthMethodCreateOIDC : IEquatable<AuthMethodCreateOIDC>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateOIDC" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodCreateOIDC() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateOIDC" /> class.
        /// </summary>
        ...
        public AuthMethodCreateOIDC(long accessExpires = 0, List<string> allowedRedirectUri = default(List<string>), string audience = default(string), List<string> auditLogsClaims = default(List<string>), List<string> boundIps = default(List<string>), string clientId = default(string), string clientSecret = default(string), string deleteProtection = default(string), string description = default(string), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), string issuer = default(string), bool json = false, long jwtTtl = 0, string name = default(string), List<string> productType = default(List<string>), List<string> requiredScopes = default(List<string>), string requiredScopesPrefix = default(string), List<string> subclaimsDelimiters = default(List<string>), string token = default(string), string uidToken = default(string), string uniqueIdentifier = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthMethodCreateOIDC and cannot be null");
            }
            this.Name = name;
            // to ensure "uniqueIdentifier" is required (not null)
            if (uniqueIdentifier == null)
            {
                throw new ArgumentNullException("uniqueIdentifier is a required property for AuthMethodCreateOIDC and cannot be null");
            }
        ...
        {
            return this.Equals(input as AuthMethodCreateOIDC);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateOIDC instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateOIDC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateOIDC input)
        {
            if (input == null)
            {
                return false;
