...
namespace akeyless.Model
{
    ...
    public partial class GcpTargetDetails : IValidatableObject
    {
        ...
        public GcpTargetDetails(string gcpServiceAccountEmail = default(string), string gcpServiceAccountKey = default(string), string gcpServiceAccountKeyBase64 = default(string), string gcpServiceAccountKeyId = default(string), string graceRotatedSecretKey = default(string), bool useGwCloudIdentity = default(bool))
        {
