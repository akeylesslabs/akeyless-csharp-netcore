...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateSnowflake : IEquatable<DynamicSecretUpdateSnowflake>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateSnowflake);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateSnowflake instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateSnowflake to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateSnowflake input)
        {
            if (input == null)
            {
                return false;
