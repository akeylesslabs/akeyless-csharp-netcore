...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateSnowflake")]
    public partial class DynamicSecretUpdateSnowflake : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateSnowflake" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateSnowflake() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateSnowflake" /> class.
        /// </summary>
        ...
        public DynamicSecretUpdateSnowflake(string account = default(string), string accountPassword = default(string), string accountUsername = default(string), bool araEnabled = default(bool), string authMode = @"password", string customUsernameTemplate = default(string), string dbName = default(string), string deleteProtection = default(string), string description = default(string), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string keyAlgo = default(string), string name = default(string), string newName = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), string privateKey = default(string), string privateKeyPassphrase = default(string), string role = default(string), bool skipDryRun = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string), string userTtl = @"24h", string warehouse = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretUpdateSnowflake and cannot be null");
            }
            this.Name = name;
