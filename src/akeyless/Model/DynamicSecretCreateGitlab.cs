...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateGitlab : IEquatable<DynamicSecretCreateGitlab>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateGitlab);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateGitlab instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateGitlab to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateGitlab input)
        {
            if (input == null)
            {
                return false;
