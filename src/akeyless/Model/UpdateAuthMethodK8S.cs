...
namespace akeyless.Model
{
    ...
    public partial class UpdateAuthMethodK8S : IEquatable<UpdateAuthMethodK8S>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UpdateAuthMethodK8S);
        }

        /// <summary>
        /// Returns true if UpdateAuthMethodK8S instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAuthMethodK8S to be compared</param>
        /// <returns>Boolean</returns>
