...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerDockerhub")]
    public partial class GatewayUpdateProducerDockerhub : IEquatable<GatewayUpdateProducerDockerhub>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerDockerhub" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GatewayUpdateProducerDockerhub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerDockerhub" /> class.
        /// </summary>
        ...
        public GatewayUpdateProducerDockerhub(string deleteProtection = default(string), string dockerhubPassword = default(string), string dockerhubTokenScopes = default(string), string dockerhubUsername = default(string), bool json = false, string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for GatewayUpdateProducerDockerhub and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as GatewayUpdateProducerDockerhub);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerDockerhub instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerDockerhub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerDockerhub input)
        {
            if (input == null)
            {
                return false;
