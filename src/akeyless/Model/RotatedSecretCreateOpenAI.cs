...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretCreateOpenAI")]
    public partial class RotatedSecretCreateOpenAI : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateOpenAI" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretCreateOpenAI() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateOpenAI" /> class.
        /// </summary>
        /// <param name="apiKey">Admin API key value to rotate (relevant only for rotator-type&#x3D;api-key).</param>
        /// <param name="apiKeyId">Admin API key ID to rotate (relevant only for rotator-type&#x3D;api-key).</param>
        ...
        public RotatedSecretCreateOpenAI(string apiKey = default(string), string apiKeyId = default(string), bool araEnabled = default(bool), string authenticationCredentials = @"use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = default(string), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), string rotateOnUnlock = default(string), List<string> rotationEventIn = default(List<string>), int rotationHour = default(int), string rotationInterval = default(string), string rotatorType = default(string), bool skipDryRun = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretCreateOpenAI and cannot be null");
            }
            this.Name = name;
            // to ensure "rotatorType" is required (not null)
            if (rotatorType == null)
            {
                throw new ArgumentNullException("rotatorType is a required property for RotatedSecretCreateOpenAI and cannot be null");
            }
            this.RotatorType = rotatorType;
            // to ensure "targetName" is required (not null)
            if (targetName == null)
            {
                throw new ArgumentNullException("targetName is a required property for RotatedSecretCreateOpenAI and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Admin API key value to rotate (relevant only for rotator-type&#x3D;api-key)</value>
        ...
        /// </summary>
        /// <value>Admin API key ID to rotate (relevant only for rotator-type&#x3D;api-key)</value>
