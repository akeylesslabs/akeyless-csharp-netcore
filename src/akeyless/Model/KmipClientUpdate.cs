...
namespace akeyless.Model
{
    ...
    /// KmipClientUpdate
    /// </summary>
    [DataContract(Name = "kmipClientUpdate")]
    public partial class KmipClientUpdate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KmipClientUpdate" /> class.
        /// </summary>
        ...
        public KmipClientUpdate(string clientId = default(string), List<string> expirationEventIn = default(List<string>), bool json = false, string name = default(string), string token = default(string), string uidToken = default(string))
        {
