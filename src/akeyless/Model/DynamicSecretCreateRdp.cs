...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateRdp : IEquatable<DynamicSecretCreateRdp>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateRdp);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateRdp instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateRdp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateRdp input)
        {
            if (input == null)
            {
                return false;
