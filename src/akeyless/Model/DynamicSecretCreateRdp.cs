...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateRdp : IValidatableObject
    {
        ...
        public DynamicSecretCreateRdp(long allowUserExtendSession = default(long), string deleteProtection = default(string), string description = default(string), string fixedUserClaimKeyname = @"ext_username", string fixedUserOnly = @"false", bool json = false, string name = default(string), string passwordLength = default(string), string producerEncryptionKeyName = default(string), string rdpAdminName = default(string), string rdpAdminPwd = default(string), string rdpHostName = default(string), string rdpHostPort = @"22", string rdpUserGroups = default(string), bool secureAccessAllowExternalUser = false, long secureAccessDelay = default(long), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), string secureAccessRdGatewayServer = default(string), string secureAccessRdpDomain = default(string), string secureAccessRdpUser = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = @"60m", long warnUserBeforeExpiration = default(long))
        {
