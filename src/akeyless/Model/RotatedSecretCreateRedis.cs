...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretCreateRedis")]
    public partial class RotatedSecretCreateRedis : IEquatable<RotatedSecretCreateRedis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateRedis" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretCreateRedis() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateRedis" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RotatedSecretCreateRedis);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateRedis instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateRedis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateRedis input)
        {
            if (input == null)
            {
                return false;
