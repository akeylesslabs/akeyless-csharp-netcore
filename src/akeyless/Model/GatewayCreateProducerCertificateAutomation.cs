...
namespace akeyless.Model
{
    ...
    public partial class GatewayCreateProducerCertificateAutomation : IEquatable<GatewayCreateProducerCertificateAutomation>, IValidatableObject
    {
        ...
        public GatewayCreateProducerCertificateAutomation(long adminRotationIntervalDays = 0, bool allowSubdomains = default(bool), List<string> allowedDomains = default(List<string>), string autoGeneratedFolder = default(string), string deleteProtection = default(string), bool enableAdminRotation = false, bool json = default(bool), string name = default(string), string producerEncryptionKeyName = default(string), bool rootFirstInChain = default(bool), bool signUsingAkeylessPki = default(bool), string signerKeyName = default(string), bool storePrivateKey = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = default(string), string venafiApiKey = default(string), string venafiBaseurl = default(string), string venafiPassword = default(string), bool venafiUseTpp = default(bool), string venafiUsername = default(string), string venafiZone = default(string))
        {
