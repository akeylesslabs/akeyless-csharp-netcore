...
namespace akeyless.Model
{
    ...
    public partial class UpdateSSHTarget : IEquatable<UpdateSSHTarget>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UpdateSSHTarget);
        }

        /// <summary>
        /// Returns true if UpdateSSHTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSSHTarget to be compared</param>
        /// <returns>Boolean</returns>
