...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretUpdatePostgresql")]
    public partial class RotatedSecretUpdatePostgresql : IEquatable<RotatedSecretUpdatePostgresql>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdatePostgresql" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretUpdatePostgresql() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretUpdatePostgresql" /> class.
        /// </summary>
        ...
        public RotatedSecretUpdatePostgresql(List<string> addTag = default(List<string>), string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = "default_metadata", bool json = false, string keepPrevVersion = default(string), string key = default(string), string name = default(string), string newName = default(string), string passwordLength = default(string), List<string> rmTag = default(List<string>), string rotateAfterDisconnect = "false", string rotatedPassword = default(string), string rotatedUsername = default(string), int rotationHour = default(int), string rotationInterval = default(string), string secureAccessBastionIssuer = default(string), string secureAccessDbName = default(string), string secureAccessDbSchema = default(string), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), bool secureAccessWeb = false, string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretUpdatePostgresql and cannot be null");
            }
            this.Name = name;
            this.AddTag = addTag;
        ...
        {
            return this.Equals(input as RotatedSecretUpdatePostgresql);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdatePostgresql instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdatePostgresql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdatePostgresql input)
        {
            if (input == null)
            {
                return false;
