...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateRabbitMq")]
    public partial class DynamicSecretCreateRabbitMq : IEquatable<DynamicSecretCreateRabbitMq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateRabbitMq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateRabbitMq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateRabbitMq" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateRabbitMq);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateRabbitMq instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateRabbitMq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateRabbitMq input)
        {
            if (input == null)
            {
                return false;
