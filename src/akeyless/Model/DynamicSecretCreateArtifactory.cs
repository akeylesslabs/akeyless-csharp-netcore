...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateArtifactory")]
    public partial class DynamicSecretCreateArtifactory : IEquatable<DynamicSecretCreateArtifactory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateArtifactory" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateArtifactory() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateArtifactory" /> class.
        /// </summary>
        ...
        public DynamicSecretCreateArtifactory(string artifactoryAdminName = default(string), string artifactoryAdminPwd = default(string), string artifactoryTokenAudience = default(string), string artifactoryTokenScope = default(string), string baseUrl = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string name = default(string), string producerEncryptionKeyName = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            ...
            {
                throw new ArgumentNullException("artifactoryTokenAudience is a required property for DynamicSecretCreateArtifactory and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("artifactoryTokenScope is a required property for DynamicSecretCreateArtifactory and cannot be null");
            }
            this.ArtifactoryTokenScope = artifactoryTokenScope;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretCreateArtifactory and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as DynamicSecretCreateArtifactory);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateArtifactory instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateArtifactory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateArtifactory input)
        {
            if (input == null)
            {
                return false;
