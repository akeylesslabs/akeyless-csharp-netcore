...
namespace akeyless.Model
{
    ...
    /// TargetUpdateGcp
    /// </summary>
    [DataContract(Name = "targetUpdateGcp")]
    public partial class TargetUpdateGcp : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateGcp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateGcp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateGcp" /> class.
        /// </summary>
        ...
        public TargetUpdateGcp(string deleteProtection = default(string), string description = default(string), string gcpKey = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), bool useGwCloudIdentity = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateGcp and cannot be null");
            }
            this.Name = name;
