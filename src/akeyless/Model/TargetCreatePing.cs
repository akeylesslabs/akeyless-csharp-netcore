...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreatePing")]
    public partial class TargetCreatePing : IEquatable<TargetCreatePing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreatePing" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreatePing() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreatePing" /> class.
        /// </summary>
        ...
        public TargetCreatePing(string administrativePort = "9999", string authorizationPort = "9031", string description = default(string), bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string password = default(string), string pingUrl = default(string), string privilegedUser = default(string), string token = default(string), string uidToken = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreatePing and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as TargetCreatePing);
        }

        /// <summary>
        /// Returns true if TargetCreatePing instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreatePing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreatePing input)
        {
            if (input == null)
            {
                return false;
