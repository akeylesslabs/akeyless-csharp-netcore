...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerGke : IEquatable<GatewayUpdateProducerGke>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerGke);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerGke instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerGke to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerGke input)
        {
            if (input == null)
            {
                return false;
