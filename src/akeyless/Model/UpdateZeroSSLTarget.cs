...
namespace akeyless.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateZeroSSLTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateZeroSSLTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateZeroSSLTarget" /> class.
        /// </summary>
        ...
        public UpdateZeroSSLTarget(string apiKey = default(string), string comment = default(string), string description = default(string), string imapFqdn = default(string), string imapPassword = default(string), string imapPort = "993", string imapTargetEmail = default(string), string imapUsername = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string timeout = "5m", string token = default(string), string uidToken = default(string), bool updateVersion = default(bool))
        {
            // to ensure "apiKey" is required (not null)
            if (apiKey == null)
            {
                throw new ArgumentNullException("apiKey is a required property for UpdateZeroSSLTarget and cannot be null");
            }
            this.ApiKey = apiKey;
            // to ensure "imapFqdn" is required (not null)
            if (imapFqdn == null)
            {
                throw new ArgumentNullException("imapFqdn is a required property for UpdateZeroSSLTarget and cannot be null");
            }
            this.ImapFqdn = imapFqdn;
            // to ensure "imapPassword" is required (not null)
            if (imapPassword == null)
            {
                throw new ArgumentNullException("imapPassword is a required property for UpdateZeroSSLTarget and cannot be null");
            }
            this.ImapPassword = imapPassword;
            // to ensure "imapUsername" is required (not null)
            if (imapUsername == null)
            {
                throw new ArgumentNullException("imapUsername is a required property for UpdateZeroSSLTarget and cannot be null");
            }
            this.ImapUsername = imapUsername;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateZeroSSLTarget and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateZeroSSLTarget);
        }

        /// <summary>
        /// Returns true if UpdateZeroSSLTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateZeroSSLTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateZeroSSLTarget input)
        {
            if (input == null)
            {
                return false;
