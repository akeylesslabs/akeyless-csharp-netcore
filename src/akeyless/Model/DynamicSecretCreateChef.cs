...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateChef")]
    public partial class DynamicSecretCreateChef : IEquatable<DynamicSecretCreateChef>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateChef" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateChef() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateChef" /> class.
        /// </summary>
        ...
        public DynamicSecretCreateChef(string chefOrgs = default(string), string chefServerKey = default(string), string chefServerUrl = default(string), string chefServerUsername = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string name = default(string), string passwordLength = default(string), string producerEncryptionKeyName = default(string), bool skipSsl = true, List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretCreateChef and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as DynamicSecretCreateChef);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateChef instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateChef to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateChef input)
        {
            if (input == null)
            {
                return false;
