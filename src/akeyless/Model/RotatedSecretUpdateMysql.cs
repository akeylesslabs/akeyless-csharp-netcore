...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateMysql : IEquatable<RotatedSecretUpdateMysql>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateMysql);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateMysql instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateMysql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateMysql input)
        {
            if (input == null)
            {
                return false;
