...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateRedshift : IEquatable<RotatedSecretUpdateRedshift>, IValidatableObject
    {
        /// <summary>
        ...
        public RotatedSecretUpdateRedshift(List<string> addTag = default(List<string>), string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = "default_metadata", bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string passwordLength = default(string), List<string> rmTag = default(List<string>), string rotateAfterDisconnect = "false", string rotatedPassword = default(string), string rotatedUsername = default(string), int rotationHour = default(int), string rotationInterval = default(string), string secureAccessDbName = default(string), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as RotatedSecretUpdateRedshift);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateRedshift instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateRedshift to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateRedshift input)
        {
            if (input == null)
            {
                return false;
