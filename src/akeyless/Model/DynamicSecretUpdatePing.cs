...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdatePing : IEquatable<DynamicSecretUpdatePing>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdatePing);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdatePing instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdatePing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdatePing input)
        {
            if (input == null)
            {
                return false;
