...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateLogForwardingSplunk")]
    public partial class GatewayUpdateLogForwardingSplunk : IEquatable<GatewayUpdateLogForwardingSplunk>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateLogForwardingSplunk" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingSplunk);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingSplunk instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingSplunk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingSplunk input)
        {
            if (input == null)
            {
                return false;
