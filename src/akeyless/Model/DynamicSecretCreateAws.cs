...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateAws : IEquatable<DynamicSecretCreateAws>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateAws);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateAws instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateAws to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateAws input)
        {
            if (input == null)
            {
                return false;
