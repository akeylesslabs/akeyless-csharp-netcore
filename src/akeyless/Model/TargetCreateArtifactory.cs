...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreateArtifactory")]
    public partial class TargetCreateArtifactory : IEquatable<TargetCreateArtifactory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateArtifactory" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateArtifactory() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateArtifactory" /> class.
        /// </summary>
        ...
        public TargetCreateArtifactory(string artifactoryAdminName = default(string), string artifactoryAdminPwd = default(string), string baseUrl = default(string), string description = default(string), bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string token = default(string), string uidToken = default(string))
        {
            ...
            {
                throw new ArgumentNullException("artifactoryAdminPwd is a required property for TargetCreateArtifactory and cannot be null");
            }
            this.ArtifactoryAdminPwd = artifactoryAdminPwd;
            // to ensure "baseUrl" is required (not null)
            if (baseUrl == null)
            {
                throw new ArgumentNullException("baseUrl is a required property for TargetCreateArtifactory and cannot be null");
            }
            this.BaseUrl = baseUrl;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateArtifactory and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as TargetCreateArtifactory);
        }

        /// <summary>
        /// Returns true if TargetCreateArtifactory instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateArtifactory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateArtifactory input)
        {
            if (input == null)
            {
                return false;
