...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateOracleDb : IEquatable<DynamicSecretUpdateOracleDb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateOracleDb);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateOracleDb instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateOracleDb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateOracleDb input)
        {
            if (input == null)
            {
                return false;
