...
namespace akeyless.Model
{
    ...
    public partial class UpdateAuthMethodAWSIAM :  IEquatable<UpdateAuthMethodAWSIAM>, IValidatableObject
    {
        ...
        public UpdateAuthMethodAWSIAM(long accessExpires = 0, List<string> boundArn = default(List<string>), List<string> boundAwsAccountId = default(List<string>), List<string> boundIps = default(List<string>), List<string> boundResourceId = default(List<string>), List<string> boundRoleId = default(List<string>), List<string> boundRoleName = default(List<string>), List<string> boundUserId = default(List<string>), List<string> boundUserName = default(List<string>), bool forceSubClaims = default(bool), string name = default(string), string newName = default(string), string password = default(string), string stsUrl = "https://sts.amazonaws.com", string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "boundAwsAccountId" is required (not null)
            this.BoundAwsAccountId = boundAwsAccountId ?? throw new ArgumentNullException("boundAwsAccountId is a required property for UpdateAuthMethodAWSIAM and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for UpdateAuthMethodAWSIAM and cannot be null");
        ...
        [DataMember(Name="bound-aws-account-id", EmitDefaultValue=false)]
