...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateArtifactory : IEquatable<TargetUpdateArtifactory>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateArtifactory);
        }

        /// <summary>
        /// Returns true if TargetUpdateArtifactory instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateArtifactory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateArtifactory input)
        {
            if (input == null)
            {
                return false;
