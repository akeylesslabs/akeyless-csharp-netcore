...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerRedis : IEquatable<GatewayUpdateProducerRedis>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GatewayUpdateProducerRedis);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerRedis instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerRedis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerRedis input)
        {
            if (input == null)
            {
                return false;
