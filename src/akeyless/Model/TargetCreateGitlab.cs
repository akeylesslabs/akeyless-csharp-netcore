...
namespace akeyless.Model
{
    ...
    /// TargetCreateGitlab
    /// </summary>
    [DataContract(Name = "targetCreateGitlab")]
    public partial class TargetCreateGitlab : IEquatable<TargetCreateGitlab>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGitlab" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateGitlab() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGitlab" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TargetCreateGitlab);
        }

        /// <summary>
        /// Returns true if TargetCreateGitlab instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateGitlab to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateGitlab input)
        {
            if (input == null)
            {
                return false;
