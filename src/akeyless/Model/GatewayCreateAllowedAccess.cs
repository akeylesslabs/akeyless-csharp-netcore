...
namespace akeyless.Model
{
    ...
    public partial class GatewayCreateAllowedAccess : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Permissions  Comma-seperated list of permissions for this allowed access. Available permissions: [defaults,targets,classic_keys,automatic_migration,ldap_auth,kerberos_auth,dynamic_secret,k8s_auth,log_forwarding,zero_knowledge_encryption,rotated_secret,caching,event_forwarding,admin,kmip,general,sra_config,hsm,acme,sdr,rotate_secret_value]</value>
