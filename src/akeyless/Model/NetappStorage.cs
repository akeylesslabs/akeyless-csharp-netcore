...
namespace akeyless.Model
{
    ...
    /// NetappStorage
    /// </summary>
    [DataContract(Name = "NetappStorage")]
    public partial class NetappStorage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetappStorage" /> class.
        /// </summary>
        ...
        public NetappStorage(string accessKeyId = default(string), string accessKeySecret = default(string), string authType = default(string), string bucket = default(string), string endpointUrl = default(string), string prefix = default(string), string region = default(string))
        {
