...
namespace akeyless.Model
{
    ...
    public partial class GetDynamicSecretValue : IValidatableObject
    {
        ...
        public GetDynamicSecretValue(List<string> args = default(List<string>), string dbname = default(string), string host = default(string), bool json = false, string name = default(string), string target = default(string), long timeout = 15, string token = default(string), string uidToken = default(string))
        {
