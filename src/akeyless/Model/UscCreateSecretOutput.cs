...
namespace akeyless.Model
{
    ...
    public partial class UscCreateSecretOutput : IValidatableObject
    {
        /// <summary>
        ...
        public UscCreateSecretOutput(string partialFailure = default(string), string secretId = default(string), string selectedEnvironments = default(string), string selectedRepositories = default(string), string versionId = default(string))
        {
