...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DigiCertTargetDetails")]
    public partial class DigiCertTargetDetails : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DigiCertTargetDetails" /> class.
        /// </summary>
        /// <param name="accountKeyPem">ACME Account Private Key (PEM-encoded). Supports ECDSA (P-256, P-384, P-521), RSA (2048+), and Ed25519. Auto-generated as ECDSA P-256 during first certificate issuance bootstrap. Stored encrypted, required for certificate operations and revocation..</param>
        /// <param name="accountUrl">ACME Account URL (returned after registration with DigiCert ACME). Used to retrieve existing account instead of re-registering..</param>
        ...
        /// </summary>
        /// <value>ACME Account Private Key (PEM-encoded). Supports ECDSA (P-256, P-384, P-521), RSA (2048+), and Ed25519. Auto-generated as ECDSA P-256 during first certificate issuance bootstrap. Stored encrypted, required for certificate operations and revocation.</value>
        ...
        /// </summary>
        /// <value>ACME Account URL (returned after registration with DigiCert ACME). Used to retrieve existing account instead of re-registering.</value>
        ...
        /// <summary>
        /// Gets or Sets DigicertDirectoryType
        /// </summary>
        [DataMember(Name = "digicert_directory_type", EmitDefaultValue = false)]
        public string DigicertDirectoryType { get; set; }
        ...
        /// </summary>
        /// <value>External Account Binding HMAC key. Required until ACME account is bootstrapped on first issuance.</value>
        ...
        /// </summary>
        /// <value>External Account Binding key identifier. Required until ACME account is bootstrapped on first issuance.</value>
