...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodUpdateSAML")]
    public partial class AuthMethodUpdateSAML : IEquatable<AuthMethodUpdateSAML>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateSAML" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodUpdateSAML() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateSAML" /> class.
        /// </summary>
        ...
        public AuthMethodUpdateSAML(long accessExpires = 0, List<string> allowedRedirectUri = default(List<string>), List<string> auditLogsClaims = default(List<string>), List<string> boundIps = default(List<string>), string deleteProtection = default(string), string description = default(string), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), string idpMetadataUrl = default(string), string idpMetadataXmlData = default(string), bool json = false, long jwtTtl = 0, string name = default(string), string newName = default(string), List<string> productType = default(List<string>), List<string> subclaimsDelimiters = default(List<string>), string token = default(string), string uidToken = default(string), string uniqueIdentifier = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthMethodUpdateSAML and cannot be null");
            }
            this.Name = name;
            // to ensure "uniqueIdentifier" is required (not null)
            if (uniqueIdentifier == null)
            {
                throw new ArgumentNullException("uniqueIdentifier is a required property for AuthMethodUpdateSAML and cannot be null");
            }
        ...
        {
            return this.Equals(input as AuthMethodUpdateSAML);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateSAML instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateSAML to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateSAML input)
        {
            if (input == null)
            {
                return false;
