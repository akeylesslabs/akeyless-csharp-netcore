...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createAuthMethodAWSIAM")]
    public partial class CreateAuthMethodAWSIAM : IEquatable<CreateAuthMethodAWSIAM>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAuthMethodAWSIAM" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAuthMethodAWSIAM() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAuthMethodAWSIAM" /> class.
        /// </summary>
        ...
        public CreateAuthMethodAWSIAM(long accessExpires = 0, List<string> auditLogsClaims = default(List<string>), List<string> boundArn = default(List<string>), List<string> boundAwsAccountId = default(List<string>), List<string> boundIps = default(List<string>), List<string> boundResourceId = default(List<string>), List<string> boundRoleId = default(List<string>), List<string> boundRoleName = default(List<string>), List<string> boundUserId = default(List<string>), List<string> boundUserName = default(List<string>), string description = default(string), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), List<string> productType = default(List<string>), string stsUrl = "https://sts.amazonaws.com", string token = default(string), string uidToken = default(string))
        {
            // to ensure "boundAwsAccountId" is required (not null)
            if (boundAwsAccountId == null)
            {
                throw new ArgumentNullException("boundAwsAccountId is a required property for CreateAuthMethodAWSIAM and cannot be null");
            }
            this.BoundAwsAccountId = boundAwsAccountId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateAuthMethodAWSIAM and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CreateAuthMethodAWSIAM);
        }

        /// <summary>
        /// Returns true if CreateAuthMethodAWSIAM instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAuthMethodAWSIAM to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAuthMethodAWSIAM input)
        {
            if (input == null)
            {
                return false;
