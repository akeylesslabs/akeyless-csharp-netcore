...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreateK8s")]
    public partial class TargetCreateK8s : IEquatable<TargetCreateK8s>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateK8s" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateK8s() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateK8s" /> class.
        /// </summary>
        ...
        public TargetCreateK8s(string description = default(string), bool json = false, string k8sAuthType = "token", string k8sClientCertificate = default(string), string k8sClientKey = default(string), string k8sClusterCaCert = "dummy_val", string k8sClusterEndpoint = "dummy_val", string k8sClusterName = default(string), string k8sClusterToken = "dummy_val", string key = default(string), string maxVersions = default(string), string name = default(string), string token = default(string), string uidToken = default(string), bool useGwServiceAccount = default(bool))
        {
            ...
            {
                throw new ArgumentNullException("k8sClusterCaCert is a required property for TargetCreateK8s and cannot be null");
            }
            this.K8sClusterCaCert = k8sClusterCaCert;
            // to ensure "k8sClusterEndpoint" is required (not null)
            if (k8sClusterEndpoint == null)
            {
                throw new ArgumentNullException("k8sClusterEndpoint is a required property for TargetCreateK8s and cannot be null");
            }
            this.K8sClusterEndpoint = k8sClusterEndpoint;
            // to ensure "k8sClusterToken" is required (not null)
            if (k8sClusterToken == null)
            {
                throw new ArgumentNullException("k8sClusterToken is a required property for TargetCreateK8s and cannot be null");
            }
            this.K8sClusterToken = k8sClusterToken;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateK8s and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as TargetCreateK8s);
        }

        /// <summary>
        /// Returns true if TargetCreateK8s instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateK8s to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateK8s input)
        {
            if (input == null)
            {
                return false;
