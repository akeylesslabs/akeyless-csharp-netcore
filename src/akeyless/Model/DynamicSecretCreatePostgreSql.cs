...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreatePostgreSql : IEquatable<DynamicSecretCreatePostgreSql>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreatePostgreSql);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreatePostgreSql instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreatePostgreSql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreatePostgreSql input)
        {
            if (input == null)
            {
                return false;
