...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodCreateOCI : IEquatable<AuthMethodCreateOCI>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodCreateOCI);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateOCI instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateOCI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateOCI input)
        {
            if (input == null)
            {
                return false;
