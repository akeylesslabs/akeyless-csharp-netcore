...
namespace akeyless.Model
{
    ...
    public partial class EsmGet : IEquatable<EsmGet>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EsmGet);
        }

        /// <summary>
        /// Returns true if EsmGet instances are equal
        /// </summary>
        /// <param name="input">Instance of EsmGet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EsmGet input)
        {
            if (input == null)
            {
                return false;
