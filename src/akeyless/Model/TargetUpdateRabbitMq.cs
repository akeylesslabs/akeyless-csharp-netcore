...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateRabbitMq : IEquatable<TargetUpdateRabbitMq>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateRabbitMq);
        }

        /// <summary>
        /// Returns true if TargetUpdateRabbitMq instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateRabbitMq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateRabbitMq input)
        {
            if (input == null)
            {
                return false;
