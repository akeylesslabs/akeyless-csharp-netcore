...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateRabbitMq")]
    public partial class TargetUpdateRabbitMq : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateRabbitMq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateRabbitMq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateRabbitMq" /> class.
        /// </summary>
        ...
        public TargetUpdateRabbitMq(string deleteProtection = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string rabbitmqServerPassword = default(string), string rabbitmqServerUri = default(string), string rabbitmqServerUser = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateRabbitMq and cannot be null");
            }
            this.Name = name;
