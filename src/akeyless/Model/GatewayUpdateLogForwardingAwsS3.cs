...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateLogForwardingAwsS3 : IEquatable<GatewayUpdateLogForwardingAwsS3>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingAwsS3);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingAwsS3 instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingAwsS3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingAwsS3 input)
        {
            if (input == null)
            {
                return false;
