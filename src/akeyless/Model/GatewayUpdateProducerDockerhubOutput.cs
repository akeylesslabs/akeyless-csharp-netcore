...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerDockerhubOutput")]
    public partial class GatewayUpdateProducerDockerhubOutput : IEquatable<GatewayUpdateProducerDockerhubOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerDockerhubOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerDockerhubOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerDockerhubOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerDockerhubOutput input)
        {
            if (input == null)
            {
                return false;
