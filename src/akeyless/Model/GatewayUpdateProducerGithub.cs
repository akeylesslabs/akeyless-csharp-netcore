...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerGithub : IEquatable<GatewayUpdateProducerGithub>, IValidatableObject
    {
        ...
        protected GatewayUpdateProducerGithub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerGithub" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerGithub);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerGithub instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerGithub to be compared</param>
        /// <returns>Boolean</returns>
