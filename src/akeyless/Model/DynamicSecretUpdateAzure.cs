...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateAzure")]
    public partial class DynamicSecretUpdateAzure : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateAzure" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateAzure() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateAzure" /> class.
        /// </summary>
        ...
        public DynamicSecretUpdateAzure(string appObjId = default(string), bool araEnabled = default(bool), string azureAdministrativeUnit = default(string), string azureClientId = default(string), string azureClientSecret = default(string), string azureTenantId = default(string), string customUsernameTemplate = default(string), string deleteProtection = default(string), string description = default(string), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), string fixedUserClaimKeyname = @"false", bool fixedUserOnly = false, List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string name = default(string), string newName = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), string producerEncryptionKeyName = default(string), string secureAccessEnable = default(string), string secureAccessUrl = default(string), bool secureAccessWeb = true, bool secureAccessWebBrowsing = false, bool secureAccessWebProxy = false, bool skipDryRun = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string), string userGroupObjId = default(string), bool userPortalAccess = false, string userPrincipalName = default(string), bool userProgrammaticAccess = false, string userRoleTemplateId = default(string), string userTtl = @"60m")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretUpdateAzure and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>Azure AD administrative unit (relevant only when azure-user-portal-access&#x3D;true)</value>
        [DataMember(Name = "azure-administrative-unit", EmitDefaultValue = false)]
