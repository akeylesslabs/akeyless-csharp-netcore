...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateAzure : IEquatable<DynamicSecretUpdateAzure>, IValidatableObject
    {
        /// <summary>
        ...
        public DynamicSecretUpdateAzure(string appObjId = default(string), string azureClientId = default(string), string azureClientSecret = default(string), string azureTenantId = default(string), string deleteProtection = default(string), string description = default(string), string fixedUserClaimKeyname = "false", bool fixedUserOnly = false, bool json = false, string name = default(string), string newName = default(string), string passwordLength = default(string), string producerEncryptionKeyName = default(string), string secureAccessEnable = default(string), bool secureAccessWeb = true, bool secureAccessWebBrowsing = false, bool secureAccessWebProxy = false, List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userGroupObjId = default(string), bool userPortalAccess = false, string userPrincipalName = default(string), bool userProgrammaticAccess = false, string userRoleTemplateId = default(string), string userTtl = "60m")
        {
        ...
        {
            return this.Equals(input as DynamicSecretUpdateAzure);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateAzure instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateAzure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateAzure input)
        {
            if (input == null)
            {
                return false;
