...
namespace akeyless.Model
{
    ...
    public partial class VerifyPKICertWithClassicKey : IEquatable<VerifyPKICertWithClassicKey>, IValidatableObject
    {
        ...
        protected VerifyPKICertWithClassicKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VerifyPKICertWithClassicKey" /> class.
        /// </summary>
        ...
        public VerifyPKICertWithClassicKey(string displayId = default(string), bool json = false, string pkiCert = default(string), string token = default(string), string uidToken = default(string), int version = default(int))
        {
        ...
        {
            return this.Equals(input as VerifyPKICertWithClassicKey);
        }

        /// <summary>
        /// Returns true if VerifyPKICertWithClassicKey instances are equal
        /// </summary>
        /// <param name="input">Instance of VerifyPKICertWithClassicKey to be compared</param>
        /// <returns>Boolean</returns>
