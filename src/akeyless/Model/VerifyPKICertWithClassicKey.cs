...
namespace akeyless.Model
{
    ...
    public partial class VerifyPKICertWithClassicKey : IValidatableObject
    {
        /// <summary>
        ...
        public VerifyPKICertWithClassicKey(string displayId = default(string), bool json = false, string pkiCert = default(string), string token = default(string), string uidToken = default(string), int varVersion = default(int))
        {
