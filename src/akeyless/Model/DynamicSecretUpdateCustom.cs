...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateCustom : IValidatableObject
    {
        /// <summary>
        ...
        public DynamicSecretUpdateCustom(long adminRotationIntervalDays = default(long), bool araEnabled = default(bool), string createSyncUrl = default(string), string deleteProtection = default(string), string description = default(string), bool enableAdminRotation = false, bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string name = default(string), string newName = default(string), List<string> outputRule = default(List<string>), string payload = default(string), string producerEncryptionKeyName = default(string), string revokeSyncUrl = default(string), string rotateSyncUrl = default(string), bool skipDryRun = default(bool), List<string> tags = default(List<string>), long timeoutSec = 60, string token = default(string), string uidToken = default(string), string userTtl = @"60m")
        {
