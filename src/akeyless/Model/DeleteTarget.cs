...
namespace akeyless.Model
{
    ...
    public partial class DeleteTarget :  IEquatable<DeleteTarget>, IValidatableObject
    {
        ...
        public DeleteTarget(bool enforceDeletion = false, string name = default(string), int targetVersion = default(int), string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as DeleteTarget);
        }

        /// <summary>
        /// Returns true if DeleteTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteTarget to be compared</param>
        /// <returns>Boolean</returns>
