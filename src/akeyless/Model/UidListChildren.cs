...
namespace akeyless.Model
{
    ...
    public partial class UidListChildren : IEquatable<UidListChildren>, IValidatableObject
    {
        ...
        public UidListChildren(string authMethodName = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
