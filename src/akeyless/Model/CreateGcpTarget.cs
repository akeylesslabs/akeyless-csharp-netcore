...
namespace akeyless.Model
{
    ...
    public partial class CreateGcpTarget : IEquatable<CreateGcpTarget>, IValidatableObject
    {
        ...
        public CreateGcpTarget(string comment = default(string), string description = default(string), string gcpKey = default(string), bool json = false, string key = default(string), string name = default(string), string token = default(string), string uidToken = default(string), bool useGwCloudIdentity = default(bool))
        {
