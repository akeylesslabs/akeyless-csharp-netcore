...
namespace akeyless.Model
{
    ...
    public partial class DescribeSubClaims : IValidatableObject
    {
        /// <summary>
        ...
        public DescribeSubClaims(bool json = false, string token = default(string), string uidToken = default(string))
        {
            this.Json = json;
            this.Token = token;
