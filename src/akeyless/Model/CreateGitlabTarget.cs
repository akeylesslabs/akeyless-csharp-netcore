...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createGitlabTarget")]
    public partial class CreateGitlabTarget : IEquatable<CreateGitlabTarget>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGitlabTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateGitlabTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGitlabTarget" /> class.
        /// </summary>
        ...
        public CreateGitlabTarget(string comment = default(string), string description = default(string), string gitlabAccessToken = default(string), string gitlabCertificate = default(string), string gitlabUrl = "https://gitlab.com/", bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateGitlabTarget and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as CreateGitlabTarget);
        }

        /// <summary>
        /// Returns true if CreateGitlabTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateGitlabTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateGitlabTarget input)
        {
            if (input == null)
            {
                return false;
