...
namespace akeyless.Model
{
    ...
    /// SecretSyncOutput
    /// </summary>
    [DataContract(Name = "SecretSyncOutput")]
    public partial class SecretSyncOutput : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecretSyncOutput" /> class.
        /// </summary>
        /// <param name="remoteSecretName">remoteSecretName.</param>
        /// <param name="secretName">secretName.</param>
        /// <param name="uscName">uscName.</param>
        public SecretSyncOutput(string remoteSecretName = default(string), string secretName = default(string), string uscName = default(string))
        {
