...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateWindows : IEquatable<RotatedSecretUpdateWindows>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateWindows);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateWindows instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateWindows to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateWindows input)
        {
            if (input == null)
            {
                return false;
