...
namespace akeyless.Model
{
    ...
    public partial class GwUpdateRemoteAccessSessionLogsLogzIo : IEquatable<GwUpdateRemoteAccessSessionLogsLogzIo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GwUpdateRemoteAccessSessionLogsLogzIo);
        }

        /// <summary>
        /// Returns true if GwUpdateRemoteAccessSessionLogsLogzIo instances are equal
        /// </summary>
        /// <param name="input">Instance of GwUpdateRemoteAccessSessionLogsLogzIo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GwUpdateRemoteAccessSessionLogsLogzIo input)
        {
            if (input == null)
            {
                return false;
