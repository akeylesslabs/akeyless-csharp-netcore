...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateRedshift")]
    public partial class DynamicSecretCreateRedshift : IEquatable<DynamicSecretCreateRedshift>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateRedshift" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateRedshift() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateRedshift" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateRedshift);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateRedshift instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateRedshift to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateRedshift input)
        {
            if (input == null)
            {
                return false;
