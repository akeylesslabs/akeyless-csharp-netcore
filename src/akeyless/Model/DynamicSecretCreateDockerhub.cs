...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateDockerhub : IEquatable<DynamicSecretCreateDockerhub>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateDockerhub);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateDockerhub instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateDockerhub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateDockerhub input)
        {
            if (input == null)
            {
                return false;
