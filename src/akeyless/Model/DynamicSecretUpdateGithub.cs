...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateGithub")]
    public partial class DynamicSecretUpdateGithub : IEquatable<DynamicSecretUpdateGithub>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateGithub" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateGithub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateGithub" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateGithub);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateGithub instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateGithub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateGithub input)
        {
            if (input == null)
            {
                return false;
