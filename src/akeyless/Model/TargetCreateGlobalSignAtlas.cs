...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateGlobalSignAtlas : IValidatableObject
    {
        /// <summary>
        ...
        public TargetCreateGlobalSignAtlas(string apiKey = default(string), string apiSecret = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string mtlsCertDataBase64 = default(string), string mtlsKeyDataBase64 = default(string), string name = default(string), string rotateOnUnlock = default(string), string timeout = @"5m", string token = default(string), string uidToken = default(string))
        {
