...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreateGlobalSignAtlas")]
    public partial class TargetCreateGlobalSignAtlas : IEquatable<TargetCreateGlobalSignAtlas>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGlobalSignAtlas" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateGlobalSignAtlas() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGlobalSignAtlas" /> class.
        /// </summary>
        ...
        public TargetCreateGlobalSignAtlas(string apiKey = default(string), string apiSecret = default(string), string description = default(string), bool json = false, string key = default(string), string maxVersions = default(string), string mtlsCertDataBase64 = default(string), string mtlsKeyDataBase64 = default(string), string name = default(string), string timeout = "5m", string token = default(string), string uidToken = default(string))
        {
            ...
            if (apiKey == null)
            {
                throw new ArgumentNullException("apiKey is a required property for TargetCreateGlobalSignAtlas and cannot be null");
            }
            this.ApiKey = apiKey;
            // to ensure "apiSecret" is required (not null)
            if (apiSecret == null)
            {
                throw new ArgumentNullException("apiSecret is a required property for TargetCreateGlobalSignAtlas and cannot be null");
            }
        ...
        {
            return this.Equals(input as TargetCreateGlobalSignAtlas);
        }

        /// <summary>
        /// Returns true if TargetCreateGlobalSignAtlas instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateGlobalSignAtlas to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateGlobalSignAtlas input)
        {
            if (input == null)
            {
                return false;
