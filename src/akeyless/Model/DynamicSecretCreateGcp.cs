...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateGcp : IEquatable<DynamicSecretCreateGcp>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateGcp);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateGcp instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateGcp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateGcp input)
        {
            if (input == null)
            {
                return false;
