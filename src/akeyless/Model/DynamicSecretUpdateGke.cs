...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateGke")]
    public partial class DynamicSecretUpdateGke : IEquatable<DynamicSecretUpdateGke>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateGke" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateGke() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateGke" /> class.
        /// </summary>
        ...
        public DynamicSecretUpdateGke(string deleteProtection = default(string), string description = default(string), string gkeAccountKey = default(string), string gkeClusterCert = default(string), string gkeClusterEndpoint = default(string), string gkeClusterName = default(string), string gkeServiceAccountEmail = default(string), bool json = false, string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), bool secureAccessAllowPortForwading = default(bool), string secureAccessBastionIssuer = default(string), string secureAccessClusterEndpoint = default(string), string secureAccessEnable = default(string), bool secureAccessWeb = false, List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretUpdateGke and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as DynamicSecretUpdateGke);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateGke instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateGke to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateGke input)
        {
            if (input == null)
            {
                return false;
