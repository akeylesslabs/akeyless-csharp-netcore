...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretCreateMssql : IEquatable<RotatedSecretCreateMssql>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretCreateMssql);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateMssql instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateMssql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateMssql input)
        {
            if (input == null)
            {
                return false;
