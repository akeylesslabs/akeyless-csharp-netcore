...
namespace akeyless.Model
{
    ...
    public partial class SetRoleRule : IValidatableObject
    {
        ...
        /// <param name="ruleType">item-rule, target-rule, role-rule, auth-method-rule, search-rule, reports-rule, gw-reports-rule, sra-reports-rule, sra-rule, ara-rule (default to &quot;item-rule&quot;).</param>
        ...
        /// </summary>
        /// <value>item-rule, target-rule, role-rule, auth-method-rule, search-rule, reports-rule, gw-reports-rule, sra-reports-rule, sra-rule, ara-rule</value>
