...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateRabbitMq")]
    public partial class DynamicSecretUpdateRabbitMq : IEquatable<DynamicSecretUpdateRabbitMq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateRabbitMq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateRabbitMq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateRabbitMq" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateRabbitMq);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateRabbitMq instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateRabbitMq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateRabbitMq input)
        {
            if (input == null)
            {
                return false;
