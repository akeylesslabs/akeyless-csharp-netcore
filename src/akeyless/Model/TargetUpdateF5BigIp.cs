...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateF5BigIp")]
    public partial class TargetUpdateF5BigIp : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateF5BigIp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateF5BigIp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateF5BigIp" /> class.
        /// </summary>
        ...
        public TargetUpdateF5BigIp(string deleteProtection = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string password = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), string url = default(string), string username = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateF5BigIp and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetUpdateF5BigIp {\n");
