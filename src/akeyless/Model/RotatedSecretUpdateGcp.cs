...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateGcp : IEquatable<RotatedSecretUpdateGcp>, IValidatableObject
    {
        /// <summary>
        ...
        public RotatedSecretUpdateGcp(List<string> addTag = default(List<string>), string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = "default_metadata", string gcpKey = default(string), string gcpServiceAccountEmail = default(string), string gcpServiceAccountKeyId = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string passwordLength = default(string), List<string> rmTag = default(List<string>), int rotationHour = default(int), string rotationInterval = default(string), string rotatorType = default(string), string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as RotatedSecretUpdateGcp);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateGcp instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateGcp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateGcp input)
        {
            if (input == null)
            {
                return false;
