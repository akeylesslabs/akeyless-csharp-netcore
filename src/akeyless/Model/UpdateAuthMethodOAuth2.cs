...
namespace akeyless.Model
{
    ...
    public partial class UpdateAuthMethodOAuth2 : IEquatable<UpdateAuthMethodOAuth2>, IValidatableObject
    {
        ...
        public UpdateAuthMethodOAuth2(long accessExpires = 0, string audience = default(string), List<string> boundClientIds = default(List<string>), List<string> boundIps = default(List<string>), bool forceSubClaims = default(bool), string issuer = default(string), string jwksUri = default(string), long jwtTtl = 0, string name = default(string), string newName = default(string), string token = default(string), string uidToken = default(string), string uniqueIdentifier = default(string))
        {
