...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerMSSQLOutput")]
    public partial class GatewayUpdateProducerMSSQLOutput : IEquatable<GatewayUpdateProducerMSSQLOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerMSSQLOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerMSSQLOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerMSSQLOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerMSSQLOutput input)
        {
            if (input == null)
                return false;
