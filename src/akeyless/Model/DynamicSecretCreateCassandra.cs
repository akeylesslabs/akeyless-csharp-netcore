...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateCassandra : IEquatable<DynamicSecretCreateCassandra>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateCassandra);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateCassandra instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateCassandra to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateCassandra input)
        {
            if (input == null)
            {
                return false;
