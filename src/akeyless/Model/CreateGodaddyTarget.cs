...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createGodaddyTarget")]
    public partial class CreateGodaddyTarget : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGodaddyTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateGodaddyTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGodaddyTarget" /> class.
        /// </summary>
        ...
        public CreateGodaddyTarget(string apiKey = default(string), string customerId = default(string), string description = default(string), string imapFqdn = default(string), string imapPassword = default(string), string imapPort = @"993", string imapUsername = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string rotateOnUnlock = default(string), string secret = default(string), string timeout = @"5m", string token = default(string), string uidToken = default(string))
        {
            ...
            if (apiKey == null)
            {
                throw new ArgumentNullException("apiKey is a required property for CreateGodaddyTarget and cannot be null");
            }
            this.ApiKey = apiKey;
            // to ensure "imapFqdn" is required (not null)
            if (imapFqdn == null)
            {
                throw new ArgumentNullException("imapFqdn is a required property for CreateGodaddyTarget and cannot be null");
            }
            this.ImapFqdn = imapFqdn;
            // to ensure "imapPassword" is required (not null)
            if (imapPassword == null)
            {
                throw new ArgumentNullException("imapPassword is a required property for CreateGodaddyTarget and cannot be null");
            }
            this.ImapPassword = imapPassword;
            // to ensure "imapUsername" is required (not null)
            if (imapUsername == null)
            {
                throw new ArgumentNullException("imapUsername is a required property for CreateGodaddyTarget and cannot be null");
            }
            this.ImapUsername = imapUsername;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateGodaddyTarget and cannot be null");
            }
            this.Name = name;
