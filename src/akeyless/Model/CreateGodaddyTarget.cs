...
namespace akeyless.Model
{
    ...
    public partial class CreateGodaddyTarget : IEquatable<CreateGodaddyTarget>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateGodaddyTarget);
        }

        /// <summary>
        /// Returns true if CreateGodaddyTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateGodaddyTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateGodaddyTarget input)
        {
            if (input == null)
            {
                return false;
