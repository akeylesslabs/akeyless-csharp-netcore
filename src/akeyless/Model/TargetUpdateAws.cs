...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateAws : IEquatable<TargetUpdateAws>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateAws);
        }

        /// <summary>
        /// Returns true if TargetUpdateAws instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateAws to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateAws input)
        {
            if (input == null)
            {
                return false;
