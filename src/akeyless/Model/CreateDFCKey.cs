...
namespace akeyless.Model
{
    ...
    public partial class CreateDFCKey :  IEquatable<CreateDFCKey>, IValidatableObject
    {
        ...
        public CreateDFCKey(string alg = default(string), string customerFrgId = default(string), string metadata = default(string), string name = default(string), string password = default(string), long splitLevel = 2, List<string> tag = default(List<string>), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "alg" is required (not null)
            this.Alg = alg ?? throw new ArgumentNullException("alg is a required property for CreateDFCKey and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateDFCKey and cannot be null");
        ...
        /// </summary>
        /// <value>DFCKey type; options: [AES128GCM, AES256GCM, AES128SIV, AES256SIV, RSA1024, RSA2048, RSA3072, RSA4096]</value>
        ...
        /// </summary>
        /// <value>Metadata about the DFC key</value>
