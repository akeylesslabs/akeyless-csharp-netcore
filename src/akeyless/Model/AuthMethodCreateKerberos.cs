...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodCreateKerberos : IEquatable<AuthMethodCreateKerberos>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodCreateKerberos);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateKerberos instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateKerberos to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateKerberos input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.KeytabFileData == input.KeytabFileData ||
                    (this.KeytabFileData != null &&
                    this.KeytabFileData.Equals(input.KeytabFileData))
                ) && 
                (
                    this.KeytabFilePath == input.KeytabFilePath ||
                    (this.KeytabFilePath != null &&
                    this.KeytabFilePath.Equals(input.KeytabFilePath))
                ) && 
                (
                ...
                (
                    this.Krb5ConfPath == input.Krb5ConfPath ||
                    (this.Krb5ConfPath != null &&
                    this.Krb5ConfPath.Equals(input.Krb5ConfPath))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KeytabFileData != null)
                {
                    hashCode = (hashCode * 59) + this.KeytabFileData.GetHashCode();
                }
                if (this.KeytabFilePath != null)
                {
                    hashCode = (hashCode * 59) + this.KeytabFilePath.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.Krb5ConfPath.GetHashCode();
                }
