...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerEks : IEquatable<GatewayUpdateProducerEks>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GatewayUpdateProducerEks);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerEks instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerEks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerEks input)
        {
            if (input == null)
                return false;
