...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerAzure : IEquatable<GatewayUpdateProducerAzure>, IValidatableObject
    {
        /// <summary>
        ...
        public GatewayUpdateProducerAzure(string appObjId = default(string), string azureClientId = default(string), string azureClientSecret = default(string), string azureTenantId = default(string), string deleteProtection = default(string), string fixedUserClaimKeyname = "false", bool fixedUserOnly = false, bool json = default(bool), string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), string secureAccessEnable = default(string), bool secureAccessWeb = default(bool), bool secureAccessWebBrowsing = default(bool), bool secureAccessWebProxy = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userGroupObjId = default(string), bool userPortalAccess = false, string userPrincipalName = default(string), bool userProgrammaticAccess = false, string userRoleTemplateId = default(string), string userTtl = "60m")
        {
        ...
        {
            return this.Equals(input as GatewayUpdateProducerAzure);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerAzure instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerAzure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerAzure input)
        {
            if (input == null)
            {
                return false;
