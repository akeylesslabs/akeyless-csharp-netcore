...
namespace akeyless.Model
{
    ...
    public partial class CreateAuthMethodEmail : IEquatable<CreateAuthMethodEmail>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateAuthMethodEmail);
        }

        /// <summary>
        /// Returns true if CreateAuthMethodEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAuthMethodEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAuthMethodEmail input)
        {
            if (input == null)
            {
                return false;
