...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateRdpTarget :  IEquatable<CreateRdpTarget>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRdpTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateRdpTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRdpTarget" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateRdpTarget);
        }

        /// <summary>
        /// Returns true if CreateRdpTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateRdpTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateRdpTarget input)
        {
            if (input == null)
                return false;
