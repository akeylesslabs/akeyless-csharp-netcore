...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateSnowflake")]
    public partial class DynamicSecretCreateSnowflake : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateSnowflake" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateSnowflake() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateSnowflake" /> class.
        /// </summary>
        ...
        /// <param name="keyAlgo">keyAlgo.</param>
        ...
        public DynamicSecretCreateSnowflake(string account = default(string), string accountPassword = default(string), string accountUsername = default(string), bool araEnabled = default(bool), string authMode = @"password", string customUsernameTemplate = default(string), string dbName = default(string), string deleteProtection = default(string), string description = default(string), bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string keyAlgo = default(string), string name = default(string), List<string> outputRule = default(List<string>), string passwordLength = default(string), string privateKey = default(string), string privateKeyPassphrase = default(string), string role = default(string), string skipDryRun = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string useCapitalLetters = default(string), string useLowerLetters = default(string), string useNumbers = default(string), string useSpecialCharacters = default(string), string userTtl = @"24h", string warehouse = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretCreateSnowflake and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>The authentication mode for the temporary user [password/key]</value>
        [DataMember(Name = "auth-mode", EmitDefaultValue = false)]
        ...
        /// <summary>
        /// Gets or Sets KeyAlgo
        /// </summary>
        [DataMember(Name = "key-algo", EmitDefaultValue = false)]
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  KeyAlgo: ").Append(KeyAlgo).Append("\n");
