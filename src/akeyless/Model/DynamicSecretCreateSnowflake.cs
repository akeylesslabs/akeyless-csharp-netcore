...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateSnowflake : IEquatable<DynamicSecretCreateSnowflake>, IValidatableObject
    {
        /// <summary>
        ...
        public DynamicSecretCreateSnowflake(string account = default(string), string accountPassword = default(string), string accountUsername = default(string), string dbName = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string name = default(string), string passwordLength = default(string), string privateKey = default(string), string privateKeyPassphrase = default(string), string role = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "24h", string warehouse = default(string))
        {
        ...
        {
            return this.Equals(input as DynamicSecretCreateSnowflake);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateSnowflake instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateSnowflake to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateSnowflake input)
        {
            if (input == null)
            {
                return false;
