...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateChef : IEquatable<DynamicSecretUpdateChef>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateChef);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateChef instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateChef to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateChef input)
        {
            if (input == null)
            {
                return false;
