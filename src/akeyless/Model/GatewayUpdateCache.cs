...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateCache : IEquatable<GatewayUpdateCache>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateCache);
        }

        /// <summary>
        /// Returns true if GatewayUpdateCache instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateCache to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateCache input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EnableProactive == input.EnableProactive ||
                    (this.EnableProactive != null &&
                    this.EnableProactive.Equals(input.EnableProactive))
                ) && 
                (
                ...
                (
                    this.MinimumFetchInterval == input.MinimumFetchInterval ||
                    (this.MinimumFetchInterval != null &&
                    this.MinimumFetchInterval.Equals(input.MinimumFetchInterval))
                ) && 
                (
                    this.StaleTimeout == input.StaleTimeout ||
                    (this.StaleTimeout != null &&
                    this.StaleTimeout.Equals(input.StaleTimeout))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EnableProactive != null)
                {
                    hashCode = (hashCode * 59) + this.EnableProactive.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Json.GetHashCode();
                if (this.MinimumFetchInterval != null)
                {
                    hashCode = (hashCode * 59) + this.MinimumFetchInterval.GetHashCode();
                }
                if (this.StaleTimeout != null)
                {
                    hashCode = (hashCode * 59) + this.StaleTimeout.GetHashCode();
                }
                if (this.Token != null)
                {
