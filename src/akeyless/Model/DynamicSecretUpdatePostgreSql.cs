...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdatePostgreSql")]
    public partial class DynamicSecretUpdatePostgreSql : IEquatable<DynamicSecretUpdatePostgreSql>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdatePostgreSql" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdatePostgreSql() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdatePostgreSql" /> class.
        /// </summary>
        ...
        public DynamicSecretUpdatePostgreSql(string creationStatements = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string name = default(string), string newName = default(string), string passwordLength = default(string), string postgresqlDbName = default(string), string postgresqlHost = "127.0.0.1", string postgresqlPassword = default(string), string postgresqlPort = "5432", string postgresqlUsername = default(string), string producerEncryptionKey = default(string), string revocationStatement = default(string), string secureAccessBastionIssuer = default(string), string secureAccessDbSchema = default(string), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), bool secureAccessWeb = false, bool ssl = false, List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretUpdatePostgreSql and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as DynamicSecretUpdatePostgreSql);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdatePostgreSql instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdatePostgreSql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdatePostgreSql input)
        {
            if (input == null)
            {
                return false;
