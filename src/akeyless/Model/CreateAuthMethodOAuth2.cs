...
namespace akeyless.Model
{
    ...
    public partial class CreateAuthMethodOAuth2 : IEquatable<CreateAuthMethodOAuth2>, IValidatableObject
    {
        ...
        public CreateAuthMethodOAuth2(long accessExpires = 0, string audience = default(string), List<string> boundClientIds = default(List<string>), List<string> boundIps = default(List<string>), bool forceSubClaims = default(bool), string issuer = default(string), string jwksUri = default(string), long jwtTtl = default(long), string name = default(string), string token = default(string), string uidToken = default(string), string uniqueIdentifier = default(string))
        {
