...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdatePing")]
    public partial class TargetUpdatePing : IEquatable<TargetUpdatePing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdatePing" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdatePing() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdatePing" /> class.
        /// </summary>
        ...
        public TargetUpdatePing(string administrativePort = "9999", string authorizationPort = "9031", string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string password = default(string), string pingUrl = default(string), string privilegedUser = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdatePing and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as TargetUpdatePing);
        }

        /// <summary>
        /// Returns true if TargetUpdatePing instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdatePing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdatePing input)
        {
            if (input == null)
            {
                return false;
