...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdatePing : IValidatableObject
    {
        /// <summary>
        ...
        public TargetUpdatePing(string administrativePort = @"9999", string authorizationPort = @"9031", string deleteProtection = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string password = default(string), string pingUrl = default(string), string privilegedUser = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
