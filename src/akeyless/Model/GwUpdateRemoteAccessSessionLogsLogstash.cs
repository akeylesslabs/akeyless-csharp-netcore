...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gwUpdateRemoteAccessSessionLogsLogstash")]
    public partial class GwUpdateRemoteAccessSessionLogsLogstash : IEquatable<GwUpdateRemoteAccessSessionLogsLogstash>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GwUpdateRemoteAccessSessionLogsLogstash" /> class.
        /// </summary>
        /// <param name="dns">Logstash dns.</param>
        ...
        /// <param name="protocol">Logstash protocol [tcp/udp].</param>
        /// <param name="pullInterval">Pull interval in seconds (default to &quot;10&quot;).</param>
        /// <param name="tlsCertificate">Logstash tls certificate (default to &quot;use-existing&quot;).</param>
        /// <param name="token">Authentication token (see &#x60;/auth&#x60; and &#x60;/configure&#x60;).</param>
        /// <param name="uidToken">The universal identity token, Required only for universal_identity authentication.</param>
        public GwUpdateRemoteAccessSessionLogsLogstash(string dns = default(string), string enable = "true", bool enableTls = default(bool), bool json = false, string outputFormat = "text", string protocol = default(string), string pullInterval = "10", string tlsCertificate = "use-existing", string token = default(string), string uidToken = default(string))
        {
            this.Dns = dns;
        ...
        /// </summary>
        /// <value>Logstash protocol [tcp/udp]</value>
        ...
        /// </summary>
        /// <value>Logstash tls certificate</value>
        ...
        {
            return this.Equals(input as GwUpdateRemoteAccessSessionLogsLogstash);
        }

        /// <summary>
        /// Returns true if GwUpdateRemoteAccessSessionLogsLogstash instances are equal
        /// </summary>
        /// <param name="input">Instance of GwUpdateRemoteAccessSessionLogsLogstash to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GwUpdateRemoteAccessSessionLogsLogstash input)
        {
            if (input == null)
            {
                return false;
