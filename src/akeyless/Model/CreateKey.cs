...
namespace akeyless.Model
{
    ...
    public partial class CreateKey :  IEquatable<CreateKey>, IValidatableObject
    {
        ...
        public CreateKey(string alg = default(string), string customerFrgId = default(string), string metadata = default(string), string name = default(string), long splitLevel = 2, List<string> tag = default(List<string>), string token = default(string), string uidToken = default(string))
        {
            // to ensure "alg" is required (not null)
            this.Alg = alg ?? throw new ArgumentNullException("alg is a required property for CreateKey and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateKey and cannot be null");
        ...
        /// </summary>
        /// <value>Metadata about the key</value>
