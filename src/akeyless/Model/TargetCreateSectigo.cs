...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateSectigo : IEquatable<TargetCreateSectigo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateSectigo);
        }

        /// <summary>
        /// Returns true if TargetCreateSectigo instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateSectigo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateSectigo input)
        {
            if (input == null)
            {
                return false;
