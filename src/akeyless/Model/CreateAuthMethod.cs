...
namespace akeyless.Model
{
    ...
    public partial class CreateAuthMethod :  IEquatable<CreateAuthMethod>, IValidatableObject
    {
        ...
        public CreateAuthMethod(long accessExpires = 0, List<string> boundIps = default(List<string>), string name = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateAuthMethod and cannot be null");
