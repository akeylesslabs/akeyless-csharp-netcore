...
namespace akeyless.Model
{
    ...
    public partial class CreateAuthMethod : IEquatable<CreateAuthMethod>, IValidatableObject
    {
        ...
        public CreateAuthMethod(long accessExpires = 0, List<string> boundIps = default(List<string>), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), string token = default(string), string uidToken = default(string))
        {
