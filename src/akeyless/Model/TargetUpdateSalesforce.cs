...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateSalesforce")]
    public partial class TargetUpdateSalesforce : IEquatable<TargetUpdateSalesforce>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateSalesforce" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateSalesforce() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateSalesforce" /> class.
        /// </summary>
        ...
        public TargetUpdateSalesforce(string appPrivateKeyData = default(string), string authFlow = default(string), string caCertData = default(string), string caCertName = default(string), string clientId = default(string), string clientSecret = default(string), string description = default(string), string email = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string password = default(string), string securityToken = default(string), string tenantUrl = default(string), string token = default(string), string uidToken = default(string))
        {
            ...
            if (authFlow == null)
            {
                throw new ArgumentNullException("authFlow is a required property for TargetUpdateSalesforce and cannot be null");
            }
            this.AuthFlow = authFlow;
            // to ensure "clientId" is required (not null)
            if (clientId == null)
            {
                throw new ArgumentNullException("clientId is a required property for TargetUpdateSalesforce and cannot be null");
            }
            this.ClientId = clientId;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for TargetUpdateSalesforce and cannot be null");
            }
            this.Email = email;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateSalesforce and cannot be null");
            }
            this.Name = name;
            // to ensure "tenantUrl" is required (not null)
            if (tenantUrl == null)
            {
                throw new ArgumentNullException("tenantUrl is a required property for TargetUpdateSalesforce and cannot be null");
            }
        ...
        {
            return this.Equals(input as TargetUpdateSalesforce);
        }

        /// <summary>
        /// Returns true if TargetUpdateSalesforce instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateSalesforce to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateSalesforce input)
        {
            if (input == null)
            {
                return false;
