...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateGithub : IEquatable<TargetUpdateGithub>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateGithub);
        }

        /// <summary>
        /// Returns true if TargetUpdateGithub instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateGithub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateGithub input)
        {
            if (input == null)
            {
                return false;
