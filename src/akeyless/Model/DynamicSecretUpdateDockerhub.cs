...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateDockerhub")]
    public partial class DynamicSecretUpdateDockerhub : IEquatable<DynamicSecretUpdateDockerhub>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateDockerhub" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateDockerhub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateDockerhub" /> class.
        /// </summary>
        ...
        public DynamicSecretUpdateDockerhub(string deleteProtection = default(string), string description = default(string), string dockerhubPassword = default(string), string dockerhubTokenScopes = default(string), string dockerhubUsername = default(string), bool json = false, string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretUpdateDockerhub and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as DynamicSecretUpdateDockerhub);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateDockerhub instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateDockerhub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateDockerhub input)
        {
            if (input == null)
            {
                return false;
