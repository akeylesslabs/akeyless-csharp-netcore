...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAuthMethodCert")]
    public partial class UpdateAuthMethodCert : IEquatable<UpdateAuthMethodCert>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAuthMethodCert" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAuthMethodCert() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAuthMethodCert" /> class.
        /// </summary>
        ...
        public UpdateAuthMethodCert(long accessExpires = 0, List<string> boundCommonNames = default(List<string>), List<string> boundDnsSans = default(List<string>), List<string> boundEmailSans = default(List<string>), List<string> boundExtensions = default(List<string>), List<string> boundIps = default(List<string>), List<string> boundOrganizationalUnits = default(List<string>), List<string> boundUriSans = default(List<string>), string certificateData = default(string), bool forceSubClaims = default(bool), long jwtTtl = 0, string name = default(string), string newName = default(string), List<string> revokedCertIds = default(List<string>), string token = default(string), string uidToken = default(string), string uniqueIdentifier = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for UpdateAuthMethodCert and cannot be null");
            }
            this.Name = name;
            // to ensure "uniqueIdentifier" is required (not null)
            if (uniqueIdentifier == null) {
                throw new ArgumentNullException("uniqueIdentifier is a required property for UpdateAuthMethodCert and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpdateAuthMethodCert);
        }

        /// <summary>
        /// Returns true if UpdateAuthMethodCert instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAuthMethodCert to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAuthMethodCert input)
        {
            if (input == null)
                return false;
