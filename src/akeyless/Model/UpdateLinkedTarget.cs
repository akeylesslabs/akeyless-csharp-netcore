...
namespace akeyless.Model
{
    ...
    public partial class UpdateLinkedTarget : IEquatable<UpdateLinkedTarget>, IValidatableObject
    {
        ...
        public UpdateLinkedTarget(string addHosts = default(string), string description = default(string), string hosts = default(string), bool json = false, string keepPrevVersion = default(string), string name = default(string), string newName = default(string), string parentTargetName = default(string), string rmHosts = default(string), string token = default(string), string type = default(string), string uidToken = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateLinkedTarget and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateLinkedTarget);
        }

        /// <summary>
        /// Returns true if UpdateLinkedTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateLinkedTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateLinkedTarget input)
        {
            if (input == null)
            {
                return false;
