...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateGithub")]
    public partial class DynamicSecretCreateGithub : IEquatable<DynamicSecretCreateGithub>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateGithub" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateGithub() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateGithub" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateGithub);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateGithub instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateGithub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateGithub input)
        {
            if (input == null)
            {
                return false;
