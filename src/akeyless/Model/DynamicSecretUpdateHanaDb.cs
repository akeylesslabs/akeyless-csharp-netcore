...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateHanaDb : IEquatable<DynamicSecretUpdateHanaDb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateHanaDb);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateHanaDb instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateHanaDb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateHanaDb input)
        {
            if (input == null)
            {
                return false;
