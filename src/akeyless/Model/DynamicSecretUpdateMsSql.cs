...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateMsSql : IEquatable<DynamicSecretUpdateMsSql>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateMsSql);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateMsSql instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateMsSql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateMsSql input)
        {
            if (input == null)
            {
                return false;
