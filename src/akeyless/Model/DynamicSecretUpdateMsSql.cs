...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateMsSql : IValidatableObject
    {
        ...
        public DynamicSecretUpdateMsSql(string deleteProtection = default(string), string description = default(string), bool json = false, string mssqlCreateStatements = default(string), string mssqlDbname = default(string), string mssqlHost = @"127.0.0.1", string mssqlPassword = default(string), string mssqlPort = @"1433", string mssqlRevocationStatements = default(string), string mssqlUsername = default(string), string name = default(string), string newName = default(string), string passwordLength = default(string), string producerEncryptionKeyName = default(string), string secureAccessBastionIssuer = default(string), string secureAccessCertificateIssuer = default(string), string secureAccessDbSchema = default(string), long secureAccessDelay = default(long), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), bool secureAccessWeb = false, List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = @"60m")
        {
