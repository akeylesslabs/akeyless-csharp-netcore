...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateK8s : IEquatable<DynamicSecretCreateK8s>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateK8s);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateK8s instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateK8s to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateK8s input)
        {
            if (input == null)
            {
                return false;
