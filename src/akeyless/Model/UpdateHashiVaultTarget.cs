...
namespace akeyless.Model
{
    ...
    public partial class UpdateHashiVaultTarget : IValidatableObject
    {
        /// <summary>
        ...
        public UpdateHashiVaultTarget(string description = default(string), string hashiUrl = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), List<string> varNamespace = default(List<string>), string newName = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool), string vaultToken = default(string))
        {
