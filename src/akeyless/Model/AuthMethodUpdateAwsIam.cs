...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodUpdateAwsIam : IEquatable<AuthMethodUpdateAwsIam>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodUpdateAwsIam);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateAwsIam instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateAwsIam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateAwsIam input)
        {
            if (input == null)
            {
                return false;
