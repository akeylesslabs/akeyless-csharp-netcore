...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodUpdateKerberos : IEquatable<AuthMethodUpdateKerberos>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodUpdateKerberos);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateKerberos instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateKerberos to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateKerberos input)
        {
            if (input == null)
            {
                return false;
