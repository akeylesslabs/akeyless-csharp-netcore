...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateDB : IEquatable<TargetUpdateDB>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateDB);
        }

        /// <summary>
        /// Returns true if TargetUpdateDB instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateDB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateDB input)
        {
            if (input == null)
            {
                return false;
