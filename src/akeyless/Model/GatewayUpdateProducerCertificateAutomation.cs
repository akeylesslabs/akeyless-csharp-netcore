...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerCertificateAutomation")]
    public partial class GatewayUpdateProducerCertificateAutomation : IEquatable<GatewayUpdateProducerCertificateAutomation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerCertificateAutomation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GatewayUpdateProducerCertificateAutomation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateProducerCertificateAutomation" /> class.
        /// </summary>
        ...
        public GatewayUpdateProducerCertificateAutomation(long adminRotationIntervalDays = 0, bool allowSubdomains = default(bool), List<string> allowedDomains = default(List<string>), string autoGeneratedFolder = default(string), string deleteProtection = default(string), bool enableAdminRotation = false, bool json = false, string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), bool rootFirstInChain = default(bool), bool signUsingAkeylessPki = default(bool), string signerKeyName = default(string), bool storePrivateKey = default(bool), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "2160h", string venafiAccessToken = default(string), string venafiApiKey = default(string), string venafiBaseurl = default(string), string venafiClientId = "akeyless", string venafiRefreshToken = default(string), bool venafiUseTpp = default(bool), string venafiZone = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for GatewayUpdateProducerCertificateAutomation and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as GatewayUpdateProducerCertificateAutomation);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerCertificateAutomation instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerCertificateAutomation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerCertificateAutomation input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.VenafiAccessToken == input.VenafiAccessToken ||
                    (this.VenafiAccessToken != null &&
                    this.VenafiAccessToken.Equals(input.VenafiAccessToken))
                ) && 
                (
                ...
                (
                    this.VenafiClientId == input.VenafiClientId ||
                    (this.VenafiClientId != null &&
                    this.VenafiClientId.Equals(input.VenafiClientId))
                ) && 
                (
                    this.VenafiRefreshToken == input.VenafiRefreshToken ||
                    (this.VenafiRefreshToken != null &&
                    this.VenafiRefreshToken.Equals(input.VenafiRefreshToken))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VenafiAccessToken != null)
                {
                    hashCode = (hashCode * 59) + this.VenafiAccessToken.GetHashCode();
                }
                ...
                if (this.VenafiClientId != null)
                {
                    hashCode = (hashCode * 59) + this.VenafiClientId.GetHashCode();
                }
                if (this.VenafiRefreshToken != null)
                {
                    hashCode = (hashCode * 59) + this.VenafiRefreshToken.GetHashCode();
                }
