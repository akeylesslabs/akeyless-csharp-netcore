...
namespace akeyless.Model
{
    ...
    public partial class GatewayCreateK8SAuthConfig : IEquatable<GatewayCreateK8SAuthConfig>, IValidatableObject
    {
        ...
        public GatewayCreateK8SAuthConfig(string accessId = default(string), string clusterApiType = "native_k8s", string configEncryptionKeyName = default(string), string k8sCaCert = default(string), string k8sHost = default(string), string k8sIssuer = default(string), string name = default(string), string rancherApiKey = default(string), string rancherClusterId = default(string), string signingKey = default(string), string token = default(string), long tokenExp = 300, string tokenReviewerJwt = default(string), string uidToken = default(string))
        {
