...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodCreateGcp")]
    public partial class AuthMethodCreateGcp : IEquatable<AuthMethodCreateGcp>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateGcp" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodCreateGcp() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodCreateGcp" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AuthMethodCreateGcp);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateGcp instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateGcp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateGcp input)
        {
            if (input == null)
            {
                return false;
