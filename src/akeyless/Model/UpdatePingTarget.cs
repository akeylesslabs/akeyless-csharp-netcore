...
namespace akeyless.Model
{
    ...
    public partial class UpdatePingTarget : IEquatable<UpdatePingTarget>, IValidatableObject
    {
        ...
        public UpdatePingTarget(string administrativePort = "9999", string authorizationPort = "9031", string comment = default(string), string description = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string name = default(string), string newName = default(string), string password = default(string), string pingUrl = default(string), string privilegedUser = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool))
        {
