...
namespace akeyless.Model
{
    ...
    public partial class UpdatePingTarget : IEquatable<UpdatePingTarget>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdatePingTarget(string administrativePort = "9999", string authorizationPort = "9031", string comment = default(string), bool json = default(bool), string keepPrevVersion = default(string), string key = default(string), string name = default(string), string newName = default(string), string password = default(string), string pingUrl = default(string), string privilegedUser = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool))
        {
        ...
        {
            return this.Equals(input as UpdatePingTarget);
        }

        /// <summary>
        /// Returns true if UpdatePingTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatePingTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatePingTarget input)
        {
            if (input == null)
            {
                return false;
