...
namespace akeyless.Model
{
    ...
    public partial class UpdateRotationSettings :  IEquatable<UpdateRotationSettings>, IValidatableObject
    {
        ...
        public UpdateRotationSettings(bool autoRotate = default(bool), string name = default(string), string password = default(string), long rotationInterval = default(long), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            this.AutoRotate = autoRotate;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for UpdateRotationSettings and cannot be null");
