...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretCreateDockerhub : IEquatable<RotatedSecretCreateDockerhub>, IValidatableObject
    {
        /// <summary>
        ...
        public RotatedSecretCreateDockerhub(string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string name = default(string), string passwordLength = default(string), int rotationHour = default(int), string rotationInterval = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as RotatedSecretCreateDockerhub);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateDockerhub instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateDockerhub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateDockerhub input)
        {
            if (input == null)
            {
                return false;
