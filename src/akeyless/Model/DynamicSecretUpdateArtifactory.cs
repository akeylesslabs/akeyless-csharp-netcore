...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateArtifactory")]
    public partial class DynamicSecretUpdateArtifactory : IEquatable<DynamicSecretUpdateArtifactory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateArtifactory" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateArtifactory() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateArtifactory" /> class.
        /// </summary>
        ...
        public DynamicSecretUpdateArtifactory(string artifactoryAdminName = default(string), string artifactoryAdminPwd = default(string), string artifactoryTokenAudience = default(string), string artifactoryTokenScope = default(string), string baseUrl = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string name = default(string), string newName = default(string), string producerEncryptionKeyName = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m")
        {
            // to ensure "artifactoryTokenAudience" is required (not null)
            if (artifactoryTokenAudience == null)
            {
                throw new ArgumentNullException("artifactoryTokenAudience is a required property for DynamicSecretUpdateArtifactory and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("artifactoryTokenScope is a required property for DynamicSecretUpdateArtifactory and cannot be null");
            }
        ...
        {
            return this.Equals(input as DynamicSecretUpdateArtifactory);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateArtifactory instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateArtifactory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateArtifactory input)
        {
            if (input == null)
            {
                return false;
