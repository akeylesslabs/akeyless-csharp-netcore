...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreateGoogleTrust")]
    public partial class TargetCreateGoogleTrust : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGoogleTrust" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateGoogleTrust() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateGoogleTrust" /> class.
        /// </summary>
        ...
        public TargetCreateGoogleTrust(string acmeChallenge = @"dns", string deleteProtection = default(string), string description = default(string), string dnsTargetCreds = default(string), string dnsZone = default(string), string eabHmacKey = default(string), string eabKeyId = default(string), string email = default(string), string gcpProject = default(string), string googleTrustUrl = @"production", string hostedZone = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string resourceGroup = default(string), string rotateOnUnlock = default(string), string timeout = @"5m", string token = default(string), string uidToken = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for TargetCreateGoogleTrust and cannot be null");
            }
            this.Email = email;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateGoogleTrust and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>Cloudflare DNS zone identifier. Required when DNS credentials target is Cloudflare</value>
        [DataMember(Name = "dns-zone", EmitDefaultValue = false)]
