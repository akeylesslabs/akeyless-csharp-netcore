...
namespace akeyless.Model
{
    ...
    public partial class SshBastionSessionTermination : IEquatable<SshBastionSessionTermination>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SshBastionSessionTermination);
        }

        /// <summary>
        /// Returns true if SshBastionSessionTermination instances are equal
        /// </summary>
        /// <param name="input">Instance of SshBastionSessionTermination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshBastionSessionTermination input)
        {
            if (input == null)
            {
                return false;
