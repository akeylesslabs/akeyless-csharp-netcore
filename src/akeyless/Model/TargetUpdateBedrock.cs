...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateBedrock")]
    public partial class TargetUpdateBedrock : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateBedrock" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateBedrock() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateBedrock" /> class.
        /// </summary>
        ...
        public TargetUpdateBedrock(string apiKey = default(string), string bedrockUrl = @"https://bedrock-runtime.us-east-1.amazonaws.com", string deleteProtection = default(string), string description = @"default_comment", bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newComment = @"default_comment", string newName = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateBedrock and cannot be null");
            }
            this.Name = name;
            this.ApiKey = apiKey;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetUpdateBedrock {\n");
