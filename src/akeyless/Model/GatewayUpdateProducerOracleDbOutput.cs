...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerOracleDbOutput")]
    public partial class GatewayUpdateProducerOracleDbOutput : IEquatable<GatewayUpdateProducerOracleDbOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerOracleDbOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerOracleDbOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerOracleDbOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerOracleDbOutput input)
        {
            if (input == null)
            {
                return false;
