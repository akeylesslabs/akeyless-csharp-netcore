...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateGke")]
    public partial class DynamicSecretCreateGke : IEquatable<DynamicSecretCreateGke>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateGke" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateGke() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateGke" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateGke);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateGke instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateGke to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateGke input)
        {
            if (input == null)
            {
                return false;
