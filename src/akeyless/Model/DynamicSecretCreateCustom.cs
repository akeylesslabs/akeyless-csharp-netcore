...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretCreateCustom")]
    public partial class DynamicSecretCreateCustom : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateCustom" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretCreateCustom() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretCreateCustom" /> class.
        /// </summary>
        ...
        public DynamicSecretCreateCustom(long adminRotationIntervalDays = default(long), bool araEnabled = default(bool), string createSyncUrl = default(string), string deleteProtection = default(string), string description = default(string), bool enableAdminRotation = false, bool enableAgenticRuntimeAuthority = default(bool), bool enableAiQuorum = default(bool), List<string> inputRule = default(List<string>), Dictionary<string, string> itemCustomFields = default(Dictionary<string, string>), bool json = false, string name = default(string), List<string> outputRule = default(List<string>), string payload = default(string), string producerEncryptionKeyName = default(string), string revokeSyncUrl = default(string), string rotateSyncUrl = default(string), bool skipDryRun = default(bool), List<string> tags = default(List<string>), long timeoutSec = 60, string token = default(string), string uidToken = default(string), string userTtl = @"60m")
        {
            // to ensure "createSyncUrl" is required (not null)
            if (createSyncUrl == null)
            {
                throw new ArgumentNullException("createSyncUrl is a required property for DynamicSecretCreateCustom and cannot be null");
            }
            this.CreateSyncUrl = createSyncUrl;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for DynamicSecretCreateCustom and cannot be null");
            }
            this.Name = name;
            // to ensure "revokeSyncUrl" is required (not null)
            if (revokeSyncUrl == null)
            {
                throw new ArgumentNullException("revokeSyncUrl is a required property for DynamicSecretCreateCustom and cannot be null");
            }
