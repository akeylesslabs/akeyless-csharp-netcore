...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateCustom : IEquatable<DynamicSecretCreateCustom>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateCustom);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateCustom instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateCustom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateCustom input)
        {
            if (input == null)
            {
                return false;
