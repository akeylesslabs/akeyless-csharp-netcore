...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteRoleAssociation :  IEquatable<DeleteRoleAssociation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteRoleAssociation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteRoleAssociation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteRoleAssociation" /> class.
        /// </summary>
        ...
        public DeleteRoleAssociation(string assocId = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
            // to ensure "assocId" is required (not null)
            this.AssocId = assocId ?? throw new ArgumentNullException("assocId is a required property for DeleteRoleAssociation and cannot be null");
        ...
        {
            return this.Equals(input as DeleteRoleAssociation);
        }

        /// <summary>
        /// Returns true if DeleteRoleAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteRoleAssociation to be compared</param>
        /// <returns>Boolean</returns>
