...
namespace akeyless.Model
{
    ...
    public partial class UpdateAuthMethod : IEquatable<UpdateAuthMethod>, IValidatableObject
    {
        ...
        public UpdateAuthMethod(long accessExpires = 0, List<string> boundIps = default(List<string>), bool forceSubClaims = default(bool), List<string> gwBoundIps = default(List<string>), long jwtTtl = default(long), string name = default(string), string newName = default(string), string token = default(string), string uidToken = default(string))
        {
