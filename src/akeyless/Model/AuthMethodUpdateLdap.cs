...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodUpdateLdap : IEquatable<AuthMethodUpdateLdap>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodUpdateLdap);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateLdap instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateLdap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateLdap input)
        {
            if (input == null)
            {
                return false;
