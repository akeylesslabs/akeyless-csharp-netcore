...
namespace akeyless.Model
{
    ...
    public partial class TargetItemVersion : IValidatableObject
    {
        ...
        public TargetItemVersion(DateTime accessDate = default(DateTime), string accessDateDisplay = default(string), CertificateVersionInfo certificateVersionInfo = default(CertificateVersionInfo), DateTime creationDate = default(DateTime), string customerFragmentId = default(string), DateTime deletionDate = default(DateTime), string itemVersionState = default(string), bool latestVersion = default(bool), DateTime modificationDate = default(DateTime), string protectionKeyName = default(string), string targetName = default(string), int varVersion = default(int), bool withCustomerFragment = default(bool))
        {
