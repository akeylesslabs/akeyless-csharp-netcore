...
namespace akeyless.Model
{
    ...
    public partial class TargetItemVersion : IEquatable<TargetItemVersion>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TargetItemVersion);
        }

        /// <summary>
        /// Returns true if TargetItemVersion instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetItemVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetItemVersion input)
        {
            if (input == null)
                return false;
