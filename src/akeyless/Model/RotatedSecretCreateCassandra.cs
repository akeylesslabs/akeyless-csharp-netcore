...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rotatedSecretCreateCassandra")]
    public partial class RotatedSecretCreateCassandra : IEquatable<RotatedSecretCreateCassandra>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateCassandra" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RotatedSecretCreateCassandra() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatedSecretCreateCassandra" /> class.
        /// </summary>
        ...
        public RotatedSecretCreateCassandra(string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string maxVersions = default(string), string name = default(string), string passwordLength = default(string), string rotatedPassword = default(string), string rotatedUsername = default(string), int rotationHour = default(int), string rotationInterval = default(string), string rotatorType = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RotatedSecretCreateCassandra and cannot be null");
            }
            this.Name = name;
            // to ensure "rotatorType" is required (not null)
            if (rotatorType == null)
            {
                throw new ArgumentNullException("rotatorType is a required property for RotatedSecretCreateCassandra and cannot be null");
            }
            this.RotatorType = rotatorType;
            // to ensure "targetName" is required (not null)
            if (targetName == null)
            {
                throw new ArgumentNullException("targetName is a required property for RotatedSecretCreateCassandra and cannot be null");
            }
        ...
        {
            return this.Equals(input as RotatedSecretCreateCassandra);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateCassandra instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateCassandra to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateCassandra input)
        {
            if (input == null)
            {
                return false;
