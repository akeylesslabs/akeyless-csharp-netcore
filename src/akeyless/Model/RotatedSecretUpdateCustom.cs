...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateCustom : IEquatable<RotatedSecretUpdateCustom>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateCustom);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateCustom instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateCustom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateCustom input)
        {
            if (input == null)
            {
                return false;
