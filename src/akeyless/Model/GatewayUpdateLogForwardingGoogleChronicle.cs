...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateLogForwardingGoogleChronicle")]
    public partial class GatewayUpdateLogForwardingGoogleChronicle : IEquatable<GatewayUpdateLogForwardingGoogleChronicle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayUpdateLogForwardingGoogleChronicle" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingGoogleChronicle);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingGoogleChronicle instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingGoogleChronicle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingGoogleChronicle input)
        {
            if (input == null)
            {
                return false;
