...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateProducerOracleDb :  IEquatable<GatewayUpdateProducerOracleDb>, IValidatableObject
    {
        ...
        public GatewayUpdateProducerOracleDb(string dbServerCertificates = default(string), string dbServerName = default(string), string name = default(string), string newName = default(string), string oracleHost = "127.0.0.1", string oraclePassword = default(string), string oraclePort = "1521", string oracleScreationStatements = default(string), string oracleServiceName = default(string), string oracleUsername = default(string), string password = default(string), string producerEncryptionKeyName = default(string), List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string), string userTtl = "60m", string username = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for GatewayUpdateProducerOracleDb and cannot be null");
