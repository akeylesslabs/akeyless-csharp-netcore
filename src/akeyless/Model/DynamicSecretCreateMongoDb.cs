...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateMongoDb : IEquatable<DynamicSecretCreateMongoDb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateMongoDb);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateMongoDb instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateMongoDb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateMongoDb input)
        {
            if (input == null)
            {
                return false;
