...
namespace akeyless.Model
{
    ...
    public partial class EsmCreate : IEquatable<EsmCreate>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EsmCreate);
        }

        /// <summary>
        /// Returns true if EsmCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of EsmCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EsmCreate input)
        {
            if (input == null)
            {
                return false;
