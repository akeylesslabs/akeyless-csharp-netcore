...
namespace akeyless.Model
{
    ...
    public partial class CreateWindowsTarget : IValidatableObject
    {
        ...
        public CreateWindowsTarget(string certificate = default(string), string connectionType = @"credentials", string description = default(string), string domain = default(string), string hostname = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string parentTargetName = default(string), string password = @"dummy_value", string port = @"5986", string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), string useTls = @"true", string username = @"dummy_value")
        {
