...
namespace akeyless.Model
{
    ...
    public partial class GKETargetDetails : IEquatable<GKETargetDetails>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GKETargetDetails);
        }

        /// <summary>
        /// Returns true if GKETargetDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of GKETargetDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GKETargetDetails input)
        {
            if (input == null)
            {
                return false;
