...
namespace akeyless.Model
{
    ...
    public partial class UpdateAuthMethodLDAP : IEquatable<UpdateAuthMethodLDAP>, IValidatableObject
    {
        ...
        public UpdateAuthMethodLDAP(long accessExpires = 0, List<string> boundIps = default(List<string>), bool forceSubClaims = default(bool), string name = default(string), string newName = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
