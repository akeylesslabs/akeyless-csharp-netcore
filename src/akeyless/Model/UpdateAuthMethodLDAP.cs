...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateAuthMethodLDAP")]
    public partial class UpdateAuthMethodLDAP : IEquatable<UpdateAuthMethodLDAP>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAuthMethodLDAP" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAuthMethodLDAP() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAuthMethodLDAP" /> class.
        /// </summary>
        ...
        public UpdateAuthMethodLDAP(long accessExpires = 0, List<string> auditLogsClaims = default(List<string>), List<string> boundIps = default(List<string>), string deleteProtection = default(string), string description = default(string), bool forceSubClaims = default(bool), string genKey = default(string), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), string newName = default(string), List<string> productType = default(List<string>), string publicKeyData = default(string), string token = default(string), string uidToken = default(string), string uniqueIdentifier = "users")
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateAuthMethodLDAP and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as UpdateAuthMethodLDAP);
        }

        /// <summary>
        /// Returns true if UpdateAuthMethodLDAP instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAuthMethodLDAP to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAuthMethodLDAP input)
        {
            if (input == null)
            {
                return false;
