...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretCreateMongodb : IEquatable<RotatedSecretCreateMongodb>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretCreateMongodb);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreateMongodb instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreateMongodb to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreateMongodb input)
        {
            if (input == null)
            {
                return false;
