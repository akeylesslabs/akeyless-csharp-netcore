...
namespace akeyless.Model
{
    ...
    public partial class GetPKICertificate : IEquatable<GetPKICertificate>, IValidatableObject
    {
        ...
        public GetPKICertificate(string altNames = default(string), string certIssuerName = default(string), string commonName = default(string), string extendedKeyUsage = default(string), string keyDataBase64 = default(string), string token = default(string), long ttl = default(long), string uidToken = default(string), string uriSans = default(string))
        {
