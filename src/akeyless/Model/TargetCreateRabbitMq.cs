...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetCreateRabbitMq")]
    public partial class TargetCreateRabbitMq : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateRabbitMq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetCreateRabbitMq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetCreateRabbitMq" /> class.
        /// </summary>
        ...
        public TargetCreateRabbitMq(string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string rabbitmqServerPassword = default(string), string rabbitmqServerUri = default(string), string rabbitmqServerUser = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetCreateRabbitMq and cannot be null");
            }
            this.Name = name;
