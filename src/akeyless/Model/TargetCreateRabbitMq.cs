...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateRabbitMq : IEquatable<TargetCreateRabbitMq>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateRabbitMq);
        }

        /// <summary>
        /// Returns true if TargetCreateRabbitMq instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateRabbitMq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateRabbitMq input)
        {
            if (input == null)
            {
                return false;
