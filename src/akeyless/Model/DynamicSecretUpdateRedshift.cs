...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dynamicSecretUpdateRedshift")]
    public partial class DynamicSecretUpdateRedshift : IEquatable<DynamicSecretUpdateRedshift>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateRedshift" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DynamicSecretUpdateRedshift() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicSecretUpdateRedshift" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateRedshift);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateRedshift instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateRedshift to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateRedshift input)
        {
            if (input == null)
            {
                return false;
