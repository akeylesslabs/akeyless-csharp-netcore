...
namespace akeyless.Model
{
    ...
    public partial class GatewayGetLdapAuthConfigOutput : IEquatable<GatewayGetLdapAuthConfigOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayGetLdapAuthConfigOutput);
        }

        /// <summary>
        /// Returns true if GatewayGetLdapAuthConfigOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayGetLdapAuthConfigOutput to be compared</param>
        /// <returns>Boolean</returns>
