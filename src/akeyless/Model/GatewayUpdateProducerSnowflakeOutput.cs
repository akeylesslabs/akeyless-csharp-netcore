...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerSnowflakeOutput")]
    public partial class GatewayUpdateProducerSnowflakeOutput : IEquatable<GatewayUpdateProducerSnowflakeOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerSnowflakeOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerSnowflakeOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerSnowflakeOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerSnowflakeOutput input)
        {
            if (input == null)
            {
                return false;
