...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretCreatePostgresql : IEquatable<RotatedSecretCreatePostgresql>, IValidatableObject
    {
        /// <summary>
        ...
        public RotatedSecretCreatePostgresql(string authenticationCredentials = "use-user-creds", string autoRotate = default(string), string deleteProtection = default(string), string description = default(string), bool json = false, string key = default(string), string name = default(string), string passwordLength = default(string), string rotateAfterDisconnect = "false", string rotatedPassword = default(string), string rotatedUsername = default(string), int rotationHour = default(int), string rotationInterval = default(string), string rotatorType = default(string), string secureAccessBastionIssuer = default(string), string secureAccessDbName = default(string), string secureAccessDbSchema = default(string), string secureAccessEnable = default(string), List<string> secureAccessHost = default(List<string>), bool secureAccessWeb = false, List<string> tags = default(List<string>), string targetName = default(string), string token = default(string), string uidToken = default(string))
        {
        ...
        {
            return this.Equals(input as RotatedSecretCreatePostgresql);
        }

        /// <summary>
        /// Returns true if RotatedSecretCreatePostgresql instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretCreatePostgresql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretCreatePostgresql input)
        {
            if (input == null)
            {
                return false;
