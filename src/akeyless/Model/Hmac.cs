...
namespace akeyless.Model
{
    ...
    public partial class Hmac : IEquatable<Hmac>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Hmac);
        }

        /// <summary>
        /// Returns true if Hmac instances are equal
        /// </summary>
        /// <param name="input">Instance of Hmac to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Hmac input)
        {
            if (input == null)
            {
                return false;
