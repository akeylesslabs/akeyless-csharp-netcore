...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretCreateLdap : IEquatable<DynamicSecretCreateLdap>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretCreateLdap);
        }

        /// <summary>
        /// Returns true if DynamicSecretCreateLdap instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretCreateLdap to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretCreateLdap input)
        {
            if (input == null)
            {
                return false;
