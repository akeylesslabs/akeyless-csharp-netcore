...
namespace akeyless.Model
{
    ...
    public partial class CreateGlobalSignTarget : IEquatable<CreateGlobalSignTarget>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreateGlobalSignTarget);
        }

        /// <summary>
        /// Returns true if CreateGlobalSignTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateGlobalSignTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateGlobalSignTarget input)
        {
            if (input == null)
            {
                return false;
