...
namespace akeyless.Model
{
    ...
    public partial class UpdateRabbitMQTargetDetails : IEquatable<UpdateRabbitMQTargetDetails>, IValidatableObject
    {
        ...
        public UpdateRabbitMQTargetDetails(bool json = false, string keepPrevVersion = default(string), string name = default(string), bool newVersion = default(bool), string protectionKey = default(string), string rabbitmqServerPassword = default(string), string rabbitmqServerUri = default(string), string rabbitmqServerUser = default(string), string token = default(string), string uidToken = default(string))
        {
