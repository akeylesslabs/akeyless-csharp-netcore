...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateAzure : IEquatable<TargetCreateAzure>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateAzure);
        }

        /// <summary>
        /// Returns true if TargetCreateAzure instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateAzure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateAzure input)
        {
            if (input == null)
            {
                return false;
