...
namespace akeyless.Model
{
    ...
    public partial class SignDataWithClassicKey : IValidatableObject
    {
        /// <summary>
        ...
        public SignDataWithClassicKey(string data = default(string), string displayId = default(string), bool hashed = false, string hashingMethod = @"SHA256", string ignoreCache = @"false", bool json = false, string name = default(string), string token = default(string), string uidToken = default(string), int varVersion = default(int))
        {
