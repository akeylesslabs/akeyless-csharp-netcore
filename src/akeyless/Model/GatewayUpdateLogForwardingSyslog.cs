...
namespace akeyless.Model
{
    ...
    public partial class GatewayUpdateLogForwardingSyslog : IEquatable<GatewayUpdateLogForwardingSyslog>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateLogForwardingSyslog);
        }

        /// <summary>
        /// Returns true if GatewayUpdateLogForwardingSyslog instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateLogForwardingSyslog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateLogForwardingSyslog input)
        {
            if (input == null)
            {
                return false;
