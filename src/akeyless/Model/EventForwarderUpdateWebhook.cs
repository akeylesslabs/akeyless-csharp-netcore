...
namespace akeyless.Model
{
    ...
    public partial class EventForwarderUpdateWebhook : IEquatable<EventForwarderUpdateWebhook>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as EventForwarderUpdateWebhook);
        }

        /// <summary>
        /// Returns true if EventForwarderUpdateWebhook instances are equal
        /// </summary>
        /// <param name="input">Instance of EventForwarderUpdateWebhook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventForwarderUpdateWebhook input)
        {
            if (input == null)
            {
                return false;
