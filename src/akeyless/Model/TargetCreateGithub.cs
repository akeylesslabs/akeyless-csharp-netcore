...
namespace akeyless.Model
{
    ...
    public partial class TargetCreateGithub : IEquatable<TargetCreateGithub>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetCreateGithub);
        }

        /// <summary>
        /// Returns true if TargetCreateGithub instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetCreateGithub to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetCreateGithub input)
        {
            if (input == null)
            {
                return false;
