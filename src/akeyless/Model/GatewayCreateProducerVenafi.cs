...
namespace akeyless.Model
{
    ...
    public partial class GatewayCreateProducerVenafi : IEquatable<GatewayCreateProducerVenafi>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayCreateProducerVenafi);
        }

        /// <summary>
        /// Returns true if GatewayCreateProducerVenafi instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayCreateProducerVenafi to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayCreateProducerVenafi input)
        {
            if (input == null)
            {
                return false;
