...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authMethodUpdateK8s")]
    public partial class AuthMethodUpdateK8s : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateK8s" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthMethodUpdateK8s() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthMethodUpdateK8s" /> class.
        /// </summary>
        ...
        public AuthMethodUpdateK8s(long accessExpires = 0, List<string> allowedClientType = default(List<string>), string audience = default(string), List<string> auditLogsClaims = default(List<string>), List<string> boundIps = default(List<string>), List<string> boundNamespaces = default(List<string>), List<string> boundPodNames = default(List<string>), List<string> boundSaNames = default(List<string>), string deleteProtection = default(string), string description = default(string), List<string> expirationEventIn = default(List<string>), bool forceSubClaims = default(bool), string genKey = default(string), List<string> gwBoundIps = default(List<string>), bool json = false, long jwtTtl = 0, string name = default(string), string newName = default(string), List<string> productType = default(List<string>), string publicKey = default(string), string token = default(string), string uidToken = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AuthMethodUpdateK8s and cannot be null");
            }
            this.Name = name;
