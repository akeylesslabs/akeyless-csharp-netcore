...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodUpdateK8s : IEquatable<AuthMethodUpdateK8s>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodUpdateK8s);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateK8s instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateK8s to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateK8s input)
        {
            if (input == null)
            {
                return false;
