...
namespace akeyless.Model
{
    ...
    public partial class RotatedSecretUpdateRedis : IEquatable<RotatedSecretUpdateRedis>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RotatedSecretUpdateRedis);
        }

        /// <summary>
        /// Returns true if RotatedSecretUpdateRedis instances are equal
        /// </summary>
        /// <param name="input">Instance of RotatedSecretUpdateRedis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RotatedSecretUpdateRedis input)
        {
            if (input == null)
            {
                return false;
