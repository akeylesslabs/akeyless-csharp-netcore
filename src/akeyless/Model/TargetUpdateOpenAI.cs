...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateOpenAI : IValidatableObject
    {
        ...
        public TargetUpdateOpenAI(string apiKey = default(string), string apiKeyId = default(string), string codexOauthAccessToken = default(string), string codexOauthAccountId = default(string), string codexOauthMode = default(string), string codexOauthRefreshToken = default(string), string deleteProtection = default(string), string description = @"default_comment", bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string model = default(string), string name = default(string), string newComment = @"default_comment", string newName = default(string), string openaiUrl = @"https://api.openai.com/v1", string organizationId = default(string), string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string))
        {
