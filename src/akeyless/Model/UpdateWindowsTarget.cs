...
namespace akeyless.Model
{
    ...
    public partial class UpdateWindowsTarget : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWindowsTarget" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateWindowsTarget() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWindowsTarget" /> class.
        /// </summary>
        ...
        public UpdateWindowsTarget(string certificate = default(string), string connectionType = @"credentials", string description = default(string), string domain = default(string), string hostname = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string parentTargetName = default(string), string password = @"dummy_value", string port = @"5986", string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = default(bool), string useTls = @"true", string username = @"dummy_value")
        {
