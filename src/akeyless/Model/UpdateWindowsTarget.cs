...
namespace akeyless.Model
{
    ...
    public partial class UpdateWindowsTarget : IEquatable<UpdateWindowsTarget>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UpdateWindowsTarget);
        }

        /// <summary>
        /// Returns true if UpdateWindowsTarget instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateWindowsTarget to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWindowsTarget input)
        {
            if (input == null)
            {
                return false;
