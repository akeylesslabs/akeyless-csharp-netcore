...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateRdp : IEquatable<DynamicSecretUpdateRdp>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateRdp);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateRdp instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateRdp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateRdp input)
        {
            if (input == null)
            {
                return false;
