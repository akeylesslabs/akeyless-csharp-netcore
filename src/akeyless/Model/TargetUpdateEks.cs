...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateEks : IEquatable<TargetUpdateEks>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateEks);
        }

        /// <summary>
        /// Returns true if TargetUpdateEks instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateEks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateEks input)
        {
            if (input == null)
            {
                return false;
