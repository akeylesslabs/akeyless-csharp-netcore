...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AllowedAccessUpdateArgs")]
    public partial class AllowedAccessUpdateArgs : IEquatable<AllowedAccessUpdateArgs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowedAccessUpdateArgs" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AllowedAccessUpdateArgs() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowedAccessUpdateArgs" /> class.
        /// </summary>
        ...
        public AllowedAccessUpdateArgs(string accessId = default(string), string description = default(string), string name = default(string), string newName = default(string), string permissions = default(string), Dictionary<string, string> subClaims = default(Dictionary<string, string>))
        {
            // to ensure "accessId" is required (not null)
            if (accessId == null)
            {
                throw new ArgumentNullException("accessId is a required property for AllowedAccessUpdateArgs and cannot be null");
            }
            this.AccessId = accessId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AllowedAccessUpdateArgs and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as AllowedAccessUpdateArgs);
        }

        /// <summary>
        /// Returns true if AllowedAccessUpdateArgs instances are equal
        /// </summary>
        /// <param name="input">Instance of AllowedAccessUpdateArgs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllowedAccessUpdateArgs input)
        {
            if (input == null)
            {
                return false;
