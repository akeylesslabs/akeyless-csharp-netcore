...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodUpdateOIDC : IEquatable<AuthMethodUpdateOIDC>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodUpdateOIDC);
        }

        /// <summary>
        /// Returns true if AuthMethodUpdateOIDC instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodUpdateOIDC to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodUpdateOIDC input)
        {
            if (input == null)
            {
                return false;
