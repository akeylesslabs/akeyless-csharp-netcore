...
namespace akeyless.Model
{
    ...
    public partial class VerifyEcDsa : IEquatable<VerifyEcDsa>, IValidatableObject
    {
        ...
        public VerifyEcDsa(string displayId = default(string), long itemId = default(long), bool json = false, string keyName = default(string), string message = default(string), string signature = default(string), string token = default(string), string uidToken = default(string))
        {
