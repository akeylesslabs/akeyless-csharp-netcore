...
namespace akeyless.Model
{
    ...
    public partial class VerifyEcDsa : IEquatable<VerifyEcDsa>, IValidatableObject
    {
        /// <summary>
        ...
        public VerifyEcDsa(string displayId = default(string), long itemId = default(long), bool json = false, string keyName = default(string), string message = default(string), bool prehashed = default(bool), string signature = default(string), string token = default(string), string uidToken = default(string), int version = default(int))
        {
        ...
        {
            return this.Equals(input as VerifyEcDsa);
        }

        /// <summary>
        /// Returns true if VerifyEcDsa instances are equal
        /// </summary>
        /// <param name="input">Instance of VerifyEcDsa to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VerifyEcDsa input)
        {
            if (input == null)
            {
                return false;
