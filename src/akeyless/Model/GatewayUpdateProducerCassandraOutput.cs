...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gatewayUpdateProducerCassandraOutput")]
    public partial class GatewayUpdateProducerCassandraOutput : IEquatable<GatewayUpdateProducerCassandraOutput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GatewayUpdateProducerCassandraOutput);
        }

        /// <summary>
        /// Returns true if GatewayUpdateProducerCassandraOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayUpdateProducerCassandraOutput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayUpdateProducerCassandraOutput input)
        {
            if (input == null)
            {
                return false;
