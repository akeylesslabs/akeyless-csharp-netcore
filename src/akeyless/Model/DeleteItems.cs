...
namespace akeyless.Model
{
    ...
    public partial class DeleteItems : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="path">Path to delete the items from.</param>
        /// <param name="token">Authentication token (see &#x60;/auth&#x60; and &#x60;/configure&#x60;).</param>
        /// <param name="uidToken">The universal identity token, Required only for universal_identity authentication.</param>
        public DeleteItems(List<string> item = default(List<string>), bool json = false, string path = default(string), string token = default(string), string uidToken = default(string))
        {
            this.Item = item;
            this.Json = json;
            this.Path = path;
