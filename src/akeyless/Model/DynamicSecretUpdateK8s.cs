...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateK8s : IEquatable<DynamicSecretUpdateK8s>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateK8s);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateK8s instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateK8s to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateK8s input)
        {
            if (input == null)
            {
                return false;
