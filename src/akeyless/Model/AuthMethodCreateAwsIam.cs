...
namespace akeyless.Model
{
    ...
    public partial class AuthMethodCreateAwsIam : IEquatable<AuthMethodCreateAwsIam>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthMethodCreateAwsIam);
        }

        /// <summary>
        /// Returns true if AuthMethodCreateAwsIam instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthMethodCreateAwsIam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthMethodCreateAwsIam input)
        {
            if (input == null)
            {
                return false;
