...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateWindows")]
    public partial class TargetUpdateWindows : IEquatable<TargetUpdateWindows>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateWindows" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateWindows() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateWindows" /> class.
        /// </summary>
        ...
        public TargetUpdateWindows(string certificate = default(string), string description = default(string), string domain = default(string), string hostname = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string password = default(string), string port = "5986", string token = default(string), string uidToken = default(string), string useTls = "true", string username = default(string))
        {
            // to ensure "hostname" is required (not null)
            if (hostname == null)
            {
                throw new ArgumentNullException("hostname is a required property for TargetUpdateWindows and cannot be null");
            }
            this.Hostname = hostname;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateWindows and cannot be null");
            }
            this.Name = name;
            // to ensure "password" is required (not null)
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for TargetUpdateWindows and cannot be null");
            }
            this.Password = password;
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new ArgumentNullException("username is a required property for TargetUpdateWindows and cannot be null");
            }
        ...
        {
            return this.Equals(input as TargetUpdateWindows);
        }

        /// <summary>
        /// Returns true if TargetUpdateWindows instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateWindows to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateWindows input)
        {
            if (input == null)
            {
                return false;
