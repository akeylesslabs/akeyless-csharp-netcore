...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateWindows : IValidatableObject
    {
        /// <summary>
        ...
        public TargetUpdateWindows(string certificate = default(string), string connectionType = @"credentials", string deleteProtection = default(string), string description = default(string), string domain = default(string), string hostname = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string parentTargetName = default(string), string password = @"dummy_value", string port = @"5986", string rotateOnUnlock = default(string), string token = default(string), string uidToken = default(string), string useTls = @"true", string username = @"dummy_value")
        {
