...
namespace akeyless.Model
{
    ...
    public partial class GatewayGetK8SAuthConfigOutput : IEquatable<GatewayGetK8SAuthConfigOutput>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GatewayGetK8SAuthConfigOutput);
        }

        /// <summary>
        /// Returns true if GatewayGetK8SAuthConfigOutput instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayGetK8SAuthConfigOutput to be compared</param>
        /// <returns>Boolean</returns>
