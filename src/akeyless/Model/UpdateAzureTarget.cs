...
namespace akeyless.Model
{
    ...
    public partial class UpdateAzureTarget :  IEquatable<UpdateAzureTarget>, IValidatableObject
    {
        ...
        public UpdateAzureTarget(string clientId = default(string), string clientSecret = default(string), string comment = default(string), string key = default(string), string name = default(string), string newName = default(string), string password = default(string), string tenantId = default(string), string token = default(string), string uidToken = default(string), bool updateVersion = false, string username = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for UpdateAzureTarget and cannot be null");
            // to ensure "newName" is required (not null)
            this.NewName = newName ?? throw new ArgumentNullException("newName is a required property for UpdateAzureTarget and cannot be null");
