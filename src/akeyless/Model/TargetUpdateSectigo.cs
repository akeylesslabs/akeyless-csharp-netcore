...
namespace akeyless.Model
{
    ...
    public partial class TargetUpdateSectigo : IEquatable<TargetUpdateSectigo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TargetUpdateSectigo);
        }

        /// <summary>
        /// Returns true if TargetUpdateSectigo instances are equal
        /// </summary>
        /// <param name="input">Instance of TargetUpdateSectigo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetUpdateSectigo input)
        {
            if (input == null)
            {
                return false;
