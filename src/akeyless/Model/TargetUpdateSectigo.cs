...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateSectigo")]
    public partial class TargetUpdateSectigo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateSectigo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateSectigo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateSectigo" /> class.
        /// </summary>
        ...
        public TargetUpdateSectigo(long certificateProfileId = default(long), string customerUri = default(string), string deleteProtection = default(string), string description = default(string), string externalRequester = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string lockOnRead = default(string), string lockTtl = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), long organizationId = default(long), string password = default(string), string rotateOnUnlock = default(string), string timeout = @"5m", string token = default(string), string uidToken = default(string), string username = default(string))
        {
            this.CertificateProfileId = certificateProfileId;
            // to ensure "customerUri" is required (not null)
            if (customerUri == null)
            {
                throw new ArgumentNullException("customerUri is a required property for TargetUpdateSectigo and cannot be null");
            }
            this.CustomerUri = customerUri;
            // to ensure "externalRequester" is required (not null)
            if (externalRequester == null)
            {
                throw new ArgumentNullException("externalRequester is a required property for TargetUpdateSectigo and cannot be null");
            }
            this.ExternalRequester = externalRequester;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateSectigo and cannot be null");
            }
            this.Name = name;
            ...
            if (password == null)
            {
                throw new ArgumentNullException("password is a required property for TargetUpdateSectigo and cannot be null");
            }
            this.Password = password;
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new ArgumentNullException("username is a required property for TargetUpdateSectigo and cannot be null");
            }
