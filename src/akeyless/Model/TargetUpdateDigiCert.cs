...
namespace akeyless.Model
{
    ...
    /// </summary>
    [DataContract(Name = "targetUpdateDigiCert")]
    public partial class TargetUpdateDigiCert : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateDigiCert" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetUpdateDigiCert() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetUpdateDigiCert" /> class.
        /// </summary>
        ...
        public TargetUpdateDigiCert(string acmeChallenge = @"dns", string description = default(string), string digicertUrl = @"us-production", string dnsTargetCreds = default(string), string eabHmacKey = default(string), string eabKeyId = default(string), string email = default(string), string gcpProject = default(string), string hostedZone = default(string), bool json = false, string keepPrevVersion = default(string), string key = default(string), string maxVersions = default(string), string name = default(string), string newName = default(string), string resourceGroup = default(string), string timeout = @"5m", string token = default(string), string uidToken = default(string))
        {
            ...
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for TargetUpdateDigiCert and cannot be null");
            }
            this.Email = email;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TargetUpdateDigiCert and cannot be null");
            }
            this.Name = name;
