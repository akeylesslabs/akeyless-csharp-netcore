...
namespace akeyless.Model
{
    ...
    public partial class AzureADAccessRules : IEquatable<AzureADAccessRules>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AzureADAccessRules);
        }

        /// <summary>
        /// Returns true if AzureADAccessRules instances are equal
        /// </summary>
        /// <param name="input">Instance of AzureADAccessRules to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AzureADAccessRules input)
        {
            ...
            return 
                (
                    ...
                    (this.AdEndpoint != null &&
                    this.AdEndpoint.Equals(input.AdEndpoint))
                ) && 
                (
                ...
                (
                    this.BoundResourceIds == input.BoundResourceIds ||
                    this.BoundResourceIds != null &&
                    input.BoundResourceIds != null &&
                    this.BoundResourceIds.SequenceEqual(input.BoundResourceIds)
                ) && 
                (
                ...
                (
                    this.BoundResourceProviders == input.BoundResourceProviders ||
                    this.BoundResourceProviders != null &&
                    input.BoundResourceProviders != null &&
                    this.BoundResourceProviders.SequenceEqual(input.BoundResourceProviders)
                ) && 
                (
