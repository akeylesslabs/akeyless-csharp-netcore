...
namespace akeyless.Model
{
    ...
    public partial class DynamicSecretUpdateMySql : IEquatable<DynamicSecretUpdateMySql>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DynamicSecretUpdateMySql);
        }

        /// <summary>
        /// Returns true if DynamicSecretUpdateMySql instances are equal
        /// </summary>
        /// <param name="input">Instance of DynamicSecretUpdateMySql to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DynamicSecretUpdateMySql input)
        {
            if (input == null)
            {
                return false;
