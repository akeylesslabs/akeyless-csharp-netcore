...
namespace akeyless.Model
{
    ...
    /// ListRoles
    /// </summary>
    [DataContract(Name = "listRoles")]
    public partial class ListRoles : IEquatable<ListRoles>, IValidatableObject
    {
        /// <summary>
        ...
        public ListRoles(string paginationToken = default(string), string password = default(string), string token = default(string), string uidToken = default(string), string username = default(string))
        {
        ...
        {
            return this.Equals(input as ListRoles);
        }

        /// <summary>
        /// Returns true if ListRoles instances are equal
        /// </summary>
        /// <param name="input">Instance of ListRoles to be compared</param>
        /// <returns>Boolean</returns>
