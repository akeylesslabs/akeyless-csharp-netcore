...
namespace akeyless.Model
{
    ...
    public partial class GetKubeExecCreds :  IEquatable<GetKubeExecCreds>, IValidatableObject
    {
        ...
        public GetKubeExecCreds(string altNames = default(string), string certIssuerName = default(string), string commonName = default(string), string keyFilePath = default(string), string outfile = default(string), string token = default(string), string uidToken = default(string), string uriSans = default(string))
        {
            // to ensure "certIssuerName" is required (not null)
            this.CertIssuerName = certIssuerName ?? throw new ArgumentNullException("certIssuerName is a required property for GetKubeExecCreds and cannot be null");
            // to ensure "keyFilePath" is required (not null)
            this.KeyFilePath = keyFilePath ?? throw new ArgumentNullException("keyFilePath is a required property for GetKubeExecCreds and cannot be null");
