...
{
    /// <summary>
    ///  Class for testing TargetCreateK8s
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class TargetCreateK8sTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for TargetCreateK8s
        //private TargetCreateK8s instance;

        public TargetCreateK8sTests()
        {
            // TODO uncomment below to create an instance of TargetCreateK8s
            //instance = new TargetCreateK8s();
        }
        ...
        /// <summary>
        /// Test an instance of TargetCreateK8s
        /// </summary>
        [Fact]
        public void TargetCreateK8sInstanceTest()
        {
            // TODO uncomment below to test "IsType" TargetCreateK8s
            //Assert.IsType<TargetCreateK8s>(instance);
        }
